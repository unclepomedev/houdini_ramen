...
impl VopQconjugate {
    ...
    pub fn set_quaternion_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
    ...
    pub fn set_input_name_quaternion<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
        ...
        self.inputs.insert(
            houdini_ramen_core::types::InputPin::Name("quaternion".to_string()),
            (out.node_id, out.pin),
        );
        self
    }
...
pub trait VopQconjugateOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Conjugate"
    fn out_conjugate(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
            pin: houdini_ramen_core::types::OutputPin::Name("conjugate".to_string()),
        }
    }
}
...
impl VopQdistance {
    ...
    pub fn set_quaternion_a_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
    ...
    pub fn set_input_name_quaterniona<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
        self.inputs
            .remove(&houdini_ramen_core::types::InputPin::Index(0));
        self.inputs.insert(
            houdini_ramen_core::types::InputPin::Name("quaternionA".to_string()),
            (out.node_id, out.pin),
        );
        self
    }
    pub fn set_quaternion_b_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
    ...
    pub fn set_input_name_quaternionb<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
        ...
        self.inputs.insert(
            houdini_ramen_core::types::InputPin::Name("quaternionB".to_string()),
            (out.node_id, out.pin),
        );
        self
    }
...
pub trait VopQdistanceOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Distance"
...
pub trait VopQinvertOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Inverse"
...
pub trait VopQmultiplyOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Product"
    fn out_product(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
pub trait VopQrotateOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Result"
...
pub trait VopQuaternionOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Quaternion"
...
impl VopQuattoeuler {
    ...
    pub fn set_input_name_quat<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
        self.inputs
            .remove(&houdini_ramen_core::types::InputPin::Index(0));
        self.inputs.insert(
            houdini_ramen_core::types::InputPin::Name("quat".to_string()),
            (out.node_id, out.pin),
        );
        self
    }
...
pub trait VopQuattoeulerOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output Rotation (Radians)"
...
impl VopQuattomatx {
    ...
    pub fn set_input_quaternion_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
...
pub trait VopQuattomatxOutputs: houdini_ramen_core::types::HoudiniNode {
...
pub trait VopQuattovecOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output Angle/Axis"
