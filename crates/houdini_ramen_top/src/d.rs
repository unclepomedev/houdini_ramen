...
impl houdini_ramen_core::types::HoudiniNode for TopDeadlinescheduler {
...
impl houdini_ramen_core::types::HoudiniNode for TopDopnet {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
impl houdini_ramen_core::types::HoudiniNode for TopDownloadfile {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
