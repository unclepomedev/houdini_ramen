...
impl houdini_ramen_core::types::HoudiniNode for TopTextoutput {
...
pub trait TopTextoutputOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "output"
...
impl houdini_ramen_core::types::HoudiniNode for TopTexttocsv {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait TopTexttocsvOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "output"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl houdini_ramen_core::types::HoudiniNode for TopTopfetch {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait TopTopfetchOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl houdini_ramen_core::types::HoudiniNode for TopTopfetchinput {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait TopTopfetchinputOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "output"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl TopTopfetchinputOutputs for TopTopfetchinput {}
impl TopTopfetchinputOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<TopTopfetchinput> {}
...
impl houdini_ramen_core::types::HoudiniNode for TopTopnet {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> TopTopnetInnerExt for houdini_ramen_core::graph::InnerGraph<'a, TopTopnet> {
    fn localscheduler(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl houdini_ramen_core::types::HoudiniNode for TopTractorscheduler {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
