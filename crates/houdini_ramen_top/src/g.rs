...
pub trait TopGenericgeneratorOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "output"
...
impl TopGenericgeneratorOutputs for TopGenericgenerator {}
impl TopGenericgeneratorOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<TopGenericgenerator>
{
}
...
pub trait TopGeometryimportOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "output"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl TopGeometryimportOutputs for TopGeometryimport {}
