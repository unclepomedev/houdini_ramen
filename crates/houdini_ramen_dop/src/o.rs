...
impl houdini_ramen_core::types::HoudiniNode for DopObjnet {
...
impl houdini_ramen_core::types::HoudiniNode for DopObjpos {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DopObjposOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
...
impl houdini_ramen_core::types::HoudiniNode for DopOnlyonce {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DopOnlyonceOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl DopOnlyonceOutputs for DopOnlyonce {}
impl DopOnlyonceOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DopOnlyonce> {}
...
impl houdini_ramen_core::types::HoudiniNode for DopOutput {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DopOutputOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
