...
impl houdini_ramen_core::types::HoudiniNode for VopnetShadow {
...
impl houdini_ramen_core::types::HoudiniNode for VopnetSop {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for VopnetSubnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for VopnetSurface {
    fn get_id(&self) -> usize {
        self.id
    }
