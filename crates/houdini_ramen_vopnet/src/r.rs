...
impl houdini_ramen_core::types::HoudiniNode for VopnetRslDisplace {
...
impl houdini_ramen_core::types::HoudiniNode for VopnetRslImager {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for VopnetRslLight {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for VopnetRslSurface {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for VopnetRslVolume {
    fn get_id(&self) -> usize {
        self.id
    }
