...
impl houdini_ramen_core::types::HoudiniNode for VopnetChop {
...
impl houdini_ramen_core::types::HoudiniNode for VopnetCop2filter {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for VopnetCop2gen {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for VopnetCvex {
    fn get_id(&self) -> usize {
        self.id
    }
