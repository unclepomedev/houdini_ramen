...
impl houdini_ramen_core::types::HoudiniNode for SopObjectMerge {
...
pub trait SopObjectMergeOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
...
impl SopObjectMergeOutputs for SopObjectMerge {}
impl SopObjectMergeOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopObjectMerge> {}
...
impl houdini_ramen_core::types::HoudiniNode for SopObjnet {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
impl SopOceanevaluate {
    ...
    pub fn set_ocean_spectrum_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
    ...
    pub fn with_cuspramp(mut self, val: Vec<houdini_ramen_core::types::RampPoint>) -> Self {
        self.params.insert(
            "cuspramp".to_string(),
...
impl houdini_ramen_core::types::HoudiniNode for SopOceanevaluate {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOceanevaluateOutputs: houdini_ramen_core::types::HoudiniNode {
...
impl SopOceanevaluateOutputs for SopOceanevaluate {}
impl SopOceanevaluateOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopOceanevaluate> {}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait SopOceanevaluateInnerExt {
    fn n_2d_grid_points(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn n_2d_grid_polysoup(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn heightfield(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn input_geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_amplitude(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_first_amplitude(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn max_displace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn restcusp_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn restderivs_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn restdisplace_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn restvel_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn vol_input(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn add_pscale1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn align_3d_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn align_downsampled2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn assign_layers(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn bake_maps(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blast1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blast_above_mindepth(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blast_above_mindepth1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blast_layer_0(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blast_outside(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn bound_pointmask(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn build_displaced_height2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn build_sdf(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn build_vel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn calc_u_v_w(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn calc_x_y_z(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn calc_x_y_z_displace_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn calc_x_y_z_vel_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn calc_cusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn calc_derivatives_xz(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn compute_pressure(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn copy1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn copy2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn copy3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn copy_attributes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn copy_attributes2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn create_3d_volume1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn create_layer_attrib(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn del_inside_group(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn derivatives_xz_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn displace3d_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn displace_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn displace_grid(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn displace_lowres_grid(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn displace_points_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn displace_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn displaced_height_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn downsamped_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn downsample(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn exp_falloff_disp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn exp_falloff_vel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn find_max_displace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    ...
    fn foreach_begin12(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_begin13(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_begin14(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_begin16(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    ...
    fn foreach_begin7(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_begin8(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    ...
    fn foreach_end10(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end12(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end13(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end15(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end5(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end6(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end7(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end8(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_end9(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_input(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_input1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_input2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_input3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_input4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn foreach_input5(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn generate_points(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn generate_points1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn group_inside(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn group_inside1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn heightfield1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hide_mask_primitives1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hide_mask_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index_attributes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn input_box(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn input_box_vel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn intersect_grid1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_amplitude_1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_pointmasks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_restcusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_restderivs(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_restdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_restdisplace_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_restvel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_restvel_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn keep_spectrum(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lowres_ptgrid(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    ...
    fn merge_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn merged_displace_and_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn merged_displace_v_and_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn merged_v_and_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn merged_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn name_calculation_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn name_downsampled_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn name_output_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn name_restcusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn name_restderivs(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn name_restdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn name_restdisplace_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn name_restvel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn name_restvel_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    ...
    fn pointjitter1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pointjitter2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pressure_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn preview_grid(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn promote_maxdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn promote_maxpscale(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rename_inside_group(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn reset_layer_0(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ropnet1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn sample_attributes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn sample_restvelocity_and_displace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn sample_restvelocity_and_displace1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surface_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_add_velocity2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_add_velocity3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_create_uvs(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_cusp2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_cusp3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_deform_geometry2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_displace_2d_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_do_preview(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_doheighfield(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_dopressure(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_dosurface(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_dovel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_downsample(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_estimate_at_frame(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_exponential1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_has_geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_has_pointmasks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_has_points(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_height_method(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_output_group(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_output_mask(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_output_restcusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_output_restderivs(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_output_restdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_output_restvel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_per_wavenumber(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_per_wavenumber1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_ptfromvol(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_sample(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_single_layer(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_solo_layer(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_vel_2d_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_vizcusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_vizcusp1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn timeshift_to_frame(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn uvproject2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn uvproject_single(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn vel3d_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn vel_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn vel_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn viz_cusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn viz_cusp1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn volume_from_displace_attrib(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn volume_maxdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn volumefromattrib1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn volumemix1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> SopOceanevaluateInnerExt for houdini_ramen_core::graph::InnerGraph<'a, SopOceanevaluate> {
    fn n_2d_grid_points(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("2d_grid_points")
    }
    fn n_2d_grid_polysoup(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("2d_grid_polysoup")
    }
    fn heightfield(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("HEIGHTFIELD")
    }
    fn input_geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("INPUT_GEO")
    }
    fn keep_amplitude(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("KEEP_amplitude")
    }
    fn keep_first_amplitude(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("KEEP_first_amplitude")
    }
    fn masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("MASKS")
    }
    fn max_displace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("MAX_DISPLACE")
    }
    fn restcusp_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RESTCUSP_2D")
    }
    fn restderivs_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RESTDERIVS_2D")
    }
    fn restdisplace_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RESTDISPLACE_2D")
    }
    fn restvel_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RESTVEL_2D")
    }
    fn volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("VOLUMES")
    }
    fn vol_input(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("VOL_INPUT")
    }
    fn add_pscale1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("add_pscale1")
    }
    fn align_3d_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("align_3d_volume")
    }
    fn align_downsampled2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("align_downsampled2")
    }
    fn assign_layers(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("assign_layers")
    }
    fn bake_maps(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("bake_maps")
    }
    fn blast1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("blast1")
    }
    fn blast_above_mindepth(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("blast_above_mindepth")
    }
    fn blast_above_mindepth1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("blast_above_mindepth1")
    }
    fn blast_layer_0(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("blast_layer_0")
    }
    fn blast_outside(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("blast_outside")
    }
    fn bound_pointmask(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("bound_pointmask")
    }
    fn build_displaced_height2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("build_displaced_height2")
    }
    fn build_sdf(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("build_sdf")
    }
    fn build_vel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("build_vel")
    }
    fn calc_u_v_w(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("calc_U_V_W")
    }
    fn calc_x_y_z(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("calc_X_Y_Z")
    }
    fn calc_x_y_z_displace_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("calc_X_Y_Z_displace_3d")
    }
    fn calc_x_y_z_vel_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("calc_X_Y_Z_vel_3d")
    }
    fn calc_cusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("calc_cusp")
    }
    fn calc_derivatives_xz(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("calc_derivatives_XZ")
    }
    fn compute_pressure(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("compute_pressure")
    }
    fn copy1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
    ...
    fn copy3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("copy3")
    }
    fn copy_attributes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("copy_attributes")
    }
    fn copy_attributes2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("copy_attributes2")
    }
    fn create_3d_volume1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("create_3d_volume1")
    }
    fn create_layer_attrib(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("create_layer_attrib")
    }
    fn del_inside_group(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("del_inside_group")
    }
    fn derivatives_xz_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("derivatives_XZ_fft")
    }
    fn displace3d_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("displace3d_fft")
    }
    fn displace_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("displace_fft")
    }
    fn displace_grid(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("displace_grid")
    }
    fn displace_lowres_grid(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("displace_lowres_grid")
    }
    fn displace_points_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("displace_points_2d")
    }
    fn displace_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("displace_volume")
    }
    fn displaced_height_2d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("displaced_height_2d")
    }
    fn downsamped_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("downsamped_volume")
    }
    fn downsample(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("downsample")
    }
    fn exp_falloff_disp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("exp_falloff_disp")
    }
    fn exp_falloff_vel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("exp_falloff_vel")
    }
    fn find_max_displace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("find_max_displace")
    }
    fn foreach_begin1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
    ...
    fn foreach_begin12(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_begin12")
    }
    fn foreach_begin13(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_begin13")
    }
    fn foreach_begin14(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_begin14")
    }
    fn foreach_begin16(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_begin16")
    }
    fn foreach_begin3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
    ...
    fn foreach_begin7(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_begin7")
    }
    fn foreach_begin8(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_begin8")
    }
    fn foreach_begin9(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
    ...
    fn foreach_end10(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end10")
    }
    fn foreach_end12(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end12")
    }
    fn foreach_end13(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end13")
    }
    fn foreach_end15(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end15")
    }
    fn foreach_end3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end3")
    }
    fn foreach_end4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end4")
    }
    fn foreach_end5(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end5")
    }
    fn foreach_end6(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end6")
    }
    fn foreach_end7(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end7")
    }
    fn foreach_end8(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end8")
    }
    fn foreach_end9(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_end9")
    }
    fn foreach_input(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_input")
    }
    fn foreach_input1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_input1")
    }
    fn foreach_input2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_input2")
    }
    fn foreach_input3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_input3")
    }
    fn foreach_input4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_input4")
    }
    fn foreach_input5(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("foreach_input5")
    }
    fn generate_points(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("generate_points")
    }
    fn generate_points1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("generate_points1")
    }
    fn group_inside(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("group_inside")
    }
    fn group_inside1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("group_inside1")
    }
    fn heightfield1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("heightfield1")
    }
    fn hide_mask_primitives1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("hide_mask_primitives1")
    }
    fn hide_mask_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("hide_mask_volumes")
    }
    fn index_attributes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index_attributes")
    }
    fn input_box(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("input_box")
    }
    fn input_box_vel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("input_box_vel")
    }
    fn intersect_grid1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("intersect_grid1")
    }
    fn keep_amplitude_1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_amplitude")
    }
    fn keep_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_masks")
    }
    fn keep_pointmasks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_pointmasks")
    }
    fn keep_restcusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_restcusp")
    }
    fn keep_restderivs(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_restderivs")
    }
    fn keep_restdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_restdisplace")
    }
    fn keep_restdisplace_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_restdisplace_3d")
    }
    fn keep_restvel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_restvel")
    }
    fn keep_restvel_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_restvel_3d")
    }
    fn keep_spectrum(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("keep_spectrum")
    }
    fn lowres_ptgrid(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("lowres_ptgrid")
    }
    fn merge1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
    ...
    fn merge_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("merge_masks")
    }
    fn merged_displace_and_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("merged_displace_and_masks")
    }
    fn merged_displace_v_and_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("merged_displace_v_and_masks")
    }
    fn merged_v_and_masks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("merged_v_and_masks")
    }
    fn merged_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("merged_volumes")
    }
    fn name_calculation_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("name_calculation_volumes_")
    }
    fn name_downsampled_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("name_downsampled_volumes")
    }
    fn name_output_volumes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("name_output_volumes")
    }
    fn name_restcusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("name_restcusp")
    }
    fn name_restderivs(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("name_restderivs")
    }
    fn name_restdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("name_restdisplace")
    }
    fn name_restdisplace_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("name_restdisplace_3d")
    }
    fn name_restvel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("name_restvel")
    }
    fn name_restvel_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("name_restvel_3d")
    }
    fn null1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
    ...
    fn pointjitter1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pointjitter1")
    }
    fn pointjitter2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pointjitter2")
    }
    fn pressure_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pressure_volume")
    }
    fn preview_grid(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("preview_grid")
    }
    fn promote_maxdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("promote_maxdisplace")
    }
    fn promote_maxpscale(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("promote_maxpscale")
    }
    fn rename_inside_group(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("rename_inside_group")
    }
    fn reset_layer_0(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("reset_layer_0")
    }
    fn ropnet1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ropnet1")
    }
    fn sample_attributes(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("sample_attributes")
    }
    fn sample_restvelocity_and_displace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("sample_restvelocity_and_displace")
    }
    fn sample_restvelocity_and_displace1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("sample_restvelocity_and_displace1")
    }
    fn surface_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surface_volume")
    }
    fn switch_add_velocity2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_add_velocity2")
    }
    fn switch_add_velocity3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_add_velocity3")
    }
    fn switch_create_uvs(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_create_uvs")
    }
    fn switch_cusp2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_cusp2")
    }
    fn switch_cusp3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_cusp3")
    }
    fn switch_deform_geometry2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_deform_geometry2")
    }
    fn switch_displace_2d_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_displace_2d_3d")
    }
    fn switch_do_preview(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_do_preview")
    }
    fn switch_doheighfield(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_doheighfield")
    }
    fn switch_dopressure(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_dopressure")
    }
    fn switch_dosurface(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_dosurface")
    }
    fn switch_dovel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_dovel")
    }
    fn switch_downsample(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_downsample")
    }
    fn switch_estimate_at_frame(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_estimate_at_frame")
    }
    fn switch_exponential1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_exponential1")
    }
    fn switch_has_geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_has_geo")
    }
    fn switch_has_pointmasks(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_has_pointmasks")
    }
    fn switch_has_points(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_has_points")
    }
    fn switch_height_method(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_height_method")
    }
    fn switch_output_group(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_output_group")
    }
    fn switch_output_mask(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_output_mask")
    }
    fn switch_output_restcusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_output_restcusp")
    }
    fn switch_output_restderivs(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_output_restderivs")
    }
    fn switch_output_restdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_output_restdisplace")
    }
    fn switch_output_restvel(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_output_restvel")
    }
    fn switch_per_wavenumber(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_per_wavenumber")
    }
    fn switch_per_wavenumber1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_per_wavenumber1")
    }
    fn switch_ptfromvol(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_ptfromvol")
    }
    fn switch_sample(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_sample")
    }
    fn switch_single_layer(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_single_layer")
    }
    fn switch_solo_layer(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_solo_layer")
    }
    fn switch_vel_2d_3d(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_vel_2d_3d")
    }
    fn switch_vizcusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_vizcusp")
    }
    fn switch_vizcusp1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("switch_vizcusp1")
    }
    fn timeshift_to_frame(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("timeshift_to_frame")
    }
    fn uvproject2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("uvproject2")
    }
    fn uvproject_single(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("uvproject_single")
    }
    fn vel3d_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("vel3d_fft")
    }
    fn vel_fft(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("vel_fft")
    }
    fn vel_volume(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("vel_volume")
    }
    fn viz_cusp(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("viz_cusp")
    }
    fn viz_cusp1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("viz_cusp1")
    }
    fn volume_from_displace_attrib(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("volume_from_displace_attrib")
    }
    fn volume_maxdisplace(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("volume_maxdisplace")
    }
    fn volumefromattrib1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("volumefromattrib1")
    }
    fn volumemix1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("volumemix1")
    }
}
pub trait SopOceanevaluateWiringExt {
    ...
    fn set_ocean_spectrum_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
...
impl<'a, 'g, C> SopOceanevaluateWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOceanevaluate>
{
    fn set_geometry_to_deform_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl houdini_ramen_core::types::HoudiniNode for SopOceanfoam {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOceanfoamOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Foam Particles"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
            pin: houdini_ramen_core::types::OutputPin::Name("output1".to_string()),
...
impl SopOceanfoamOutputs for SopOceanfoam {}
impl SopOceanfoamOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopOceanfoam> {}

pub trait SopOceanfoamWiringExt {
    fn set_ocean_spectrum_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
...
impl<'a, 'g, C> SopOceanfoamWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOceanfoam>
{
    fn set_ocean_spectrum_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl houdini_ramen_core::types::HoudiniNode for SopOceansource {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOceansourceOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Initial"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl SopOceansourceOutputs for SopOceansource {}
impl SopOceansourceOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopOceansource> {}

pub trait SopOceansourceWiringExt {
    fn set_ocean_spectrum_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
...
impl<'a, 'g, C> SopOceansourceWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOceansource>
{
    fn set_ocean_spectrum_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl SopOceanspectrum {
    ...
    pub fn set_wave_instancing_points_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
    ...
    pub fn set_mask_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
    ...
    pub fn with_amplituderamp(mut self, val: Vec<houdini_ramen_core::types::RampPoint>) -> Self {
        self.params.insert(
...
impl houdini_ramen_core::types::HoudiniNode for SopOceanspectrum {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOceanspectrumOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Spectrum Layer"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
            pin: houdini_ramen_core::types::OutputPin::Name("output1".to_string()),
...
impl SopOceanspectrumOutputs for SopOceanspectrum {}
impl SopOceanspectrumOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopOceanspectrum> {}

pub trait SopOceanspectrumWiringExt {
    fn set_wave_instancing_points_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
    ...
    fn set_mask_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self;
    fn set_input_name_input2<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
...
impl<'a, 'g, C> SopOceanspectrumWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOceanspectrum>
{
    fn set_wave_instancing_points_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl houdini_ramen_core::types::HoudiniNode for SopOceanwaves {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOceanwavesOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Spectrum Layer"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl SopOceanwavesOutputs for SopOceanwaves {}
impl SopOceanwavesOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopOceanwaves> {}

pub trait SopOceanwavesWiringExt {
    fn set_wave_instancing_points_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
...
impl<'a, 'g, C> SopOceanwavesWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOceanwaves>
{
    fn set_wave_instancing_points_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl SopOnnx {
    ...
    pub fn with_input_shape_inst(mut self, index1: usize, val: Vec<i32>) -> Self {
        self.params.insert(
            ...
            houdini_ramen_core::types::ParamValue::IntArray(val),
        );
        self
    }
...
impl houdini_ramen_core::types::HoudiniNode for SopOnnx {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOnnxOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl SopOnnxOutputs for SopOnnx {}
impl SopOnnxOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopOnnx> {}

pub trait SopOnnxWiringExt {
...
impl<'a, 'g, C> SopOnnxWiringExt for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOnnx> {
    fn set_input_1_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self {
        self.set_input_at(0, output)
    }
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
...
impl houdini_ramen_core::types::HoudiniNode for SopOpencl {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOpenclOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl SopOpenclOutputs for SopOpencl {}
impl SopOpenclOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopOpencl> {}

pub trait SopOpenclWiringExt {
    fn set_input_1_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self;
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl<'a, 'g, C> SopOpenclWiringExt for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOpencl> {
    fn set_input_1_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self {
        self.set_input_at(0, output)
    }
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
...
impl SopOrientalongcurve {
    ...
    pub fn set_banking_curves_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
...
impl houdini_ramen_core::types::HoudiniNode for SopOrientalongcurve {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOrientalongcurveOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl SopOrientalongcurveOutputs for SopOrientalongcurve {}
impl SopOrientalongcurveOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<SopOrientalongcurve>
{
}

pub trait SopOrientalongcurveWiringExt {
    fn set_curves_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self;
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
    fn set_banking_curves_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
    fn set_input_name_input2<O: Into<houdini_ramen_core::types::NodeOutput>>(
...
impl<'a, 'g, C> SopOrientalongcurveWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOrientalongcurve>
{
    fn set_curves_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self {
        self.set_input_at(0, output)
    }
...
impl SopOtisconfiguremuscleandtissue {
    ...
    pub fn set_tissue_geometry_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
...
impl houdini_ramen_core::types::HoudiniNode for SopOtisconfiguremuscleandtissue {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOtisconfiguremuscleandtissueOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Otis Geometry"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
            pin: houdini_ramen_core::types::OutputPin::Name("output1".to_string()),
...
impl SopOtisconfiguremuscleandtissueOutputs for SopOtisconfiguremuscleandtissue {}
impl SopOtisconfiguremuscleandtissueOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<SopOtisconfiguremuscleandtissue>
{
}

pub trait SopOtisconfiguremuscleandtissueWiringExt {
    fn set_muscle_geometry_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
    ...
    fn set_tissue_geometry_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
    fn set_input_name_input2<O: Into<houdini_ramen_core::types::NodeOutput>>(
    ...
    fn set_bone_geometry_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
    fn set_input_name_input3<O: Into<houdini_ramen_core::types::NodeOutput>>(
...
impl<'a, 'g, C> SopOtisconfiguremuscleandtissueWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOtisconfiguremuscleandtissue>
{
    fn set_muscle_geometry_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl SopOtissolver {
    ...
    pub fn set_vellum_geometry_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
...
impl houdini_ramen_core::types::HoudiniNode for SopOtissolver {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOtissolverOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Vellum Geometry"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
            pin: houdini_ramen_core::types::OutputPin::Name("output1".to_string()),
...
impl SopOtissolverOutputs for SopOtissolver {}
impl SopOtissolverOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopOtissolver> {}

pub trait SopOtissolverWiringExt {
    fn set_vellum_geometry_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
    ...
    fn set_constraint_geometry_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
    fn set_input_name_input2<O: Into<houdini_ramen_core::types::NodeOutput>>(
...
impl<'a, 'g, C> SopOtissolverWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOtissolver>
{
    fn set_vellum_geometry_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl houdini_ramen_core::types::HoudiniNode for SopOutput {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait SopOutputOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl SopOutputOutputs for SopOutput {}
impl SopOutputOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<SopOutput> {}

pub trait SopOutputWiringExt {
    fn set_input_1_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self;
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl<'a, 'g, C> SopOutputWiringExt for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, SopOutput> {
    fn set_input_1_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self {
        self.set_input_at(0, output)
    }
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
