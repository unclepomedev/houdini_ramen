...
pub trait ChopMidioutWiringExt {
...
impl<'a, 'g, C> ChopMidioutWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, ChopMidiout>
{
    fn set_input_1_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self {
...
pub trait ChopMultiplyWiringExt {
    fn set_input_1_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self;
    fn set_input_name_input1<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ...
    fn set_sub_network_input_12_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
...
impl<'a, 'g, C> ChopMultiplyWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, ChopMultiply>
{
    fn set_input_1_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self {
        self.set_input_at(0, output)
    }
