...
pub trait ChopWarpWiringExt {
    fn set_pre_warp_channels_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
    ...
    fn set_warp_curve_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self;
...
impl<'a, 'g, C> ChopWarpWiringExt for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, ChopWarp> {
    fn set_pre_warp_channels_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
    ) -> Self {
