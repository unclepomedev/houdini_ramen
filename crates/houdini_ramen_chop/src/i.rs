...
impl houdini_ramen_core::types::HoudiniNode for ChopIdentity {
...
impl houdini_ramen_core::types::HoudiniNode for ChopIksolver {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ChopImage {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ChopInterp {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ChopInversekin {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ChopInvert {
    fn get_id(&self) -> usize {
        self.id
    }
