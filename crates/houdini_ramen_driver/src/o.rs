...
pub trait DriverOpenglOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
...
impl DriverOpenglOutputs for DriverOpengl {}
impl DriverOpenglOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DriverOpengl> {}
