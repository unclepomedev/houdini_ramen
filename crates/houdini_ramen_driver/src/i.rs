...
impl houdini_ramen_core::types::HoudiniNode for DriverIfd {
...
pub trait DriverIfdOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
...
impl DriverIfdOutputs for DriverIfd {}
impl DriverIfdOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DriverIfd> {}
...
impl houdini_ramen_core::types::HoudiniNode for DriverIfdarchive {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DriverIfdarchiveOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl DriverIfdarchiveOutputs for DriverIfdarchive {}
impl DriverIfdarchiveOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DriverIfdarchive> {}
...
impl houdini_ramen_core::types::HoudiniNode for DriverImage {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DriverImageOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl DriverImageOutputs for DriverImage {}
impl DriverImageOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DriverImage> {}
...
impl houdini_ramen_core::types::HoudiniNode for DriverImage3d {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DriverImage3dOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl DriverImage3dOutputs for DriverImage3d {}
impl DriverImage3dOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DriverImage3d> {}
