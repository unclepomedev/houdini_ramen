...
impl DriverWedge {
    ...
    pub fn set_rop_to_wedge_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
...
impl houdini_ramen_core::types::HoudiniNode for DriverWedge {
...
pub trait DriverWedgeOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
...
impl DriverWedgeOutputs for DriverWedge {}
impl DriverWedgeOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DriverWedge> {}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait DriverWedgeInnerExt {
    fn shell1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> DriverWedgeInnerExt for houdini_ramen_core::graph::InnerGraph<'a, DriverWedge> {
    fn shell1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl houdini_ramen_core::types::HoudiniNode for DriverWren {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DriverWrenOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl DriverWrenOutputs for DriverWren {}
impl DriverWrenOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DriverWren> {}
