...
impl houdini_ramen_core::types::HoudiniNode for DriverMatnet {
...
impl houdini_ramen_core::types::HoudiniNode for DriverMdd {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DriverMddOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
...
impl DriverMddOutputs for DriverMdd {}
impl DriverMddOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DriverMdd> {}
...
impl houdini_ramen_core::types::HoudiniNode for DriverMerge {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DriverMergeOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl DriverMergeOutputs for DriverMerge {}
impl DriverMergeOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<DriverMerge> {}
...
impl houdini_ramen_core::types::HoudiniNode for DriverMlExampleraw {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait DriverMlExamplerawOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl DriverMlExamplerawOutputs for DriverMlExampleraw {}
impl DriverMlExamplerawOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<DriverMlExampleraw>
{
}
