...
impl houdini_ramen_core::types::HoudiniNode for ObjectLight {
...
pub trait ObjectLightOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
...
impl ObjectLightOutputs for ObjectLight {}
impl ObjectLightOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectLight> {}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait ObjectLightInnerExt {
    fn areashape_switch(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn areasize1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn areasize2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn circle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn cone_light(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn duplicate1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn duplicate2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn final_light(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn grid1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn line1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn line2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn line3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    ...
    fn point_cone_switch(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
...
#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectLightInnerExt for houdini_ramen_core::graph::InnerGraph<'a, ObjectLight> {
    fn areashape_switch(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl houdini_ramen_core::types::HoudiniNode for ObjectLopimport {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectLopimportOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl houdini_ramen_core::types::HoudiniNode for ObjectLopimportcam {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectLopimportcamOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectLopimportcamOutputs for ObjectLopimportcam {}
impl ObjectLopimportcamOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectLopimportcam>
{
}
...
#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectLopimportcamInnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectLopimportcam>
{
    fn camorigin(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl houdini_ramen_core::types::HoudiniNode for ObjectLopnet {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
