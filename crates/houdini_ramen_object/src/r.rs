...
impl houdini_ramen_core::types::HoudiniNode for ObjectRagdollrunexample {
...
pub trait ObjectRagdollrunexampleOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
...
impl ObjectRagdollrunexampleOutputs for ObjectRagdollrunexample {}
impl ObjectRagdollrunexampleOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectRagdollrunexample>
{
}
...
pub trait ObjectRagdollrunexampleInnerExt {
    ...
    fn envlight1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ground(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hlight1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn mocapbiped2_run(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn mocapbiped2_setup(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectRagdollrunexampleInnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectRagdollrunexample>
{
    fn cam1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl houdini_ramen_core::types::HoudiniNode for ObjectRefimage {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectRefimageOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectRefimageOutputs for ObjectRefimage {}
impl ObjectRefimageOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectRefimage> {}
...
#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectRefimageInnerExt for houdini_ramen_core::graph::InnerGraph<'a, ObjectRefimage> {
    fn file1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("copnet1/file1")
    }
}
pub trait ObjectRefimageWiringExt {
...
impl<'a, 'g, C> ObjectRefimageWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, ObjectRefimage>
{
    fn set_parent_input<O: Into<houdini_ramen_core::types::NodeOutput>>(self, output: O) -> Self {
...
impl houdini_ramen_core::types::HoudiniNode for ObjectRiggedmuscle {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectRiggedmuscleOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectRiggedmuscleOutputs for ObjectRiggedmuscle {}
impl ObjectRiggedmuscleOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectRiggedmuscle>
{
}
...
#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectRiggedmuscleInnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectRiggedmuscle>
{
    fn tightnessdriver(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
pub trait ObjectRiggedmuscleWiringExt {
...
impl<'a, 'g, C> ObjectRiggedmuscleWiringExt
    for houdini_ramen_core::graph::NodeWiring<'a, 'g, C, ObjectRiggedmuscle>
{
    fn set_origin_anchor_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        self,
        output: O,
...
impl houdini_ramen_core::types::HoudiniNode for ObjectRivet {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectRivetOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectRivetOutputs for ObjectRivet {}
impl ObjectRivetOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectRivet> {}
...
#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectRivetInnerExt for houdini_ramen_core::graph::InnerGraph<'a, ObjectRivet> {
    fn control1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl houdini_ramen_core::types::HoudiniNode for ObjectRopnet {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
