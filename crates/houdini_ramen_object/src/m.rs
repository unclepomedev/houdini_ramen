...
impl houdini_ramen_core::types::HoudiniNode for ObjectMatnet {
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMcacclaim {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMcacclaimOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
...
impl ObjectMcacclaimOutputs for ObjectMcacclaim {}
impl ObjectMcacclaimOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMcacclaim> {}
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMicrophone {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMicrophoneOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMicrophoneOutputs for ObjectMicrophone {}
impl ObjectMicrophoneOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMicrophone> {}
...
pub trait ObjectMicrophoneInnerExt {
    ...
    fn carve2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn grid1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
...
#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMicrophoneInnerExt for houdini_ramen_core::graph::InnerGraph<'a, ObjectMicrophone> {
    fn add1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl ObjectMocapRigBipedArm {
    ...
    pub fn with_collarbone_bone_length(mut self, val: f32) -> Self {
        self.params.insert(
            "collarbone_bone_length".to_string(),
            houdini_ramen_core::types::ParamValue::Float(val),
        );
        self
    }
    ...
    pub fn with_upperarm_bone_length(mut self, val: f32) -> Self {
        self.params.insert(
            "upperarm_bone_length".to_string(),
            houdini_ramen_core::types::ParamValue::Float(val),
        );
        self
    }
    ...
    pub fn with_ptr_ctrl_arm_twist_t(mut self, val: [f32; 3]) -> Self {
        self.params.insert(
            "ptr_ctrl_arm_twist_t".to_string(),
            houdini_ramen_core::types::ParamValue::Float3(val),
        );
        self
    }
    ...
    pub fn with_arm_twist_targetpath(mut self, val: &str) -> Self {
        self.params.insert(
            "arm_twist_targetpath".to_string(),
            houdini_ramen_core::types::ParamValue::String(
                val.replace("\r\n", "\n").replace('\r', "\n"),
            ),
        );
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMocapRigBipedArm {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMocapRigBipedArmOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMocapRigBipedArmOutputs for ObjectMocapRigBipedArm {}
impl ObjectMocapRigBipedArmOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMocapRigBipedArm>
{
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait ObjectMocapRigBipedArmInnerExt {
    fn chops(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn collarbone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_arm_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_arm_twist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_shoulder(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_wrist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn forearm_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_arm_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_arm_twist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_shoulder(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_wrist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rotate_null(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn upperarm_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMocapRigBipedArmInnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectMocapRigBipedArm>
{
    fn chops(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("chops")
    }
    fn collarbone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("collarbone")
    }
    fn ctrl_arm_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_arm_root")
    }
    fn ctrl_arm_twist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_arm_twist")
    }
    fn ctrl_shoulder(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_shoulder")
    }
    fn ctrl_wrist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_wrist")
    }
    fn forearm_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("forearm_bone")
    }
    fn ptr_ctrl_arm_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_arm_root")
    }
    fn ptr_ctrl_arm_twist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_arm_twist")
    }
    fn ptr_ctrl_shoulder(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_shoulder")
    }
    fn ptr_ctrl_wrist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_wrist")
    }
    fn rotate_null(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("rotate_null")
    }
    fn upperarm_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("upperarm_bone")
    }
    fn wrist_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_bone")
    }
}
...
impl ObjectMocapRigBipedHeadAndNeck {
    ...
    pub fn with_ptr_ctrl_neck_root_t(mut self, val: [f32; 3]) -> Self {
        self.params.insert(
            "ptr_ctrl_neck_root_t".to_string(),
            houdini_ramen_core::types::ParamValue::Float3(val),
        );
        self
    }
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMocapRigBipedHeadAndNeck {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMocapRigBipedHeadAndNeckOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMocapRigBipedHeadAndNeckOutputs for ObjectMocapRigBipedHeadAndNeck {}
impl ObjectMocapRigBipedHeadAndNeckOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMocapRigBipedHeadAndNeck>
{
}
...
pub trait ObjectMocapRigBipedHeadAndNeckInnerExt {
    ...
    fn ctrl_head_end(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_neck2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_neck_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn head_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn head_offset(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn neck_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_head(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_head_end(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_neck2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_neck_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn root_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMocapRigBipedHeadAndNeckInnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectMocapRigBipedHeadAndNeck>
{
    fn chops(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("chops")
    }
    ...
    fn ctrl_head_end(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_head_end")
    }
    fn ctrl_neck2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_neck2")
    }
    fn ctrl_neck_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_neck_root")
    }
    fn head_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("head_bone")
    }
    fn head_offset(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("head_offset")
    }
    fn neck_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("neck_bone")
    }
    fn ptr_ctrl_head(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_head")
    }
    fn ptr_ctrl_head_end(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_head_end")
    }
    fn ptr_ctrl_neck2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_neck2")
    }
    fn ptr_ctrl_neck_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_neck_root")
    }
    fn root_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("root_bone")
    }
}
...
impl ObjectMocapRigBipedLeg {
    ...
    pub fn with_ptr_ctrl_leg_twist_t(mut self, val: [f32; 3]) -> Self {
        self.params.insert(
            "ptr_ctrl_leg_twist_t".to_string(),
            houdini_ramen_core::types::ParamValue::Float3(val),
        );
        self
    }
    ...
    pub fn with_leg_twist_targetpath(mut self, val: &str) -> Self {
        self.params.insert(
            "leg_twist_targetpath".to_string(),
            houdini_ramen_core::types::ParamValue::String(
                val.replace("\r\n", "\n").replace('\r', "\n"),
            ),
        );
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMocapRigBipedLeg {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMocapRigBipedLegOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMocapRigBipedLegOutputs for ObjectMocapRigBipedLeg {}
impl ObjectMocapRigBipedLegOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMocapRigBipedLeg>
{
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait ObjectMocapRigBipedLegInnerExt {
    fn ankle_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ankle_reference(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn chops(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_ankle(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_ball(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_hip(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_leg_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_leg_twist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_toe(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pelvis_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_ankle(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_ball(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_hip(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_leg_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_leg_twist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_toe(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn shin_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thigh_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn toe_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMocapRigBipedLegInnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectMocapRigBipedLeg>
{
    fn ankle_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ankle_bone")
    }
    fn ankle_reference(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ankle_reference")
    }
    fn chops(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("chops")
    }
    fn ctrl_ankle(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_ankle")
    }
    fn ctrl_ball(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_ball")
    }
    fn ctrl_hip(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_hip")
    }
    fn ctrl_leg_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_leg_root")
    }
    fn ctrl_leg_twist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_leg_twist")
    }
    fn ctrl_toe(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_toe")
    }
    fn pelvis_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pelvis_bone")
    }
    fn ptr_ctrl_ankle(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_ankle")
    }
    fn ptr_ctrl_ball(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_ball")
    }
    fn ptr_ctrl_hip(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_hip")
    }
    fn ptr_ctrl_leg_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_leg_root")
    }
    fn ptr_ctrl_leg_twist(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_leg_twist")
    }
    fn ptr_ctrl_toe(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_toe")
    }
    fn shin_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("shin_bone")
    }
    fn thigh_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thigh_bone")
    }
    fn toe_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("toe_bone")
    }
}
...
impl ObjectMocapRigBipedSpine3pc {
    ...
    pub fn with_lower_back1_bone_length(mut self, val: f32) -> Self {
        self.params.insert(
            "lower_back1_bone_length".to_string(),
            houdini_ramen_core::types::ParamValue::Float(val),
        );
        self
    }
    ...
    pub fn with_lower_back2_bone_length(mut self, val: f32) -> Self {
        self.params.insert(
            "lower_back2_bone_length".to_string(),
            houdini_ramen_core::types::ParamValue::Float(val),
        );
        self
    }
    ...
    pub fn with_ptr_ctrl_spine_root_t(mut self, val: [f32; 3]) -> Self {
        self.params.insert(
            "ptr_ctrl_spine_root_t".to_string(),
            houdini_ramen_core::types::ParamValue::Float3(val),
        );
        self
    }
    ...
    pub fn with_ptr_ctrl_lower_back2_t(mut self, val: [f32; 3]) -> Self {
        self.params.insert(
            "ptr_ctrl_lower_back2_t".to_string(),
            houdini_ramen_core::types::ParamValue::Float3(val),
        );
        self
    }
    ...
    pub fn with_lower_back1_targetpath(mut self, val: &str) -> Self {
        self.params.insert(
            "lower_back1_targetpath".to_string(),
            houdini_ramen_core::types::ParamValue::String(
                val.replace("\r\n", "\n").replace('\r', "\n"),
            ),
        );
    ...
    pub fn with_lower_back2_targetpath(mut self, val: &str) -> Self {
        self.params.insert(
            "lower_back2_targetpath".to_string(),
            houdini_ramen_core::types::ParamValue::String(
                val.replace("\r\n", "\n").replace('\r', "\n"),
            ),
        );
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMocapRigBipedSpine3pc {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMocapRigBipedSpine3pcOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMocapRigBipedSpine3pcOutputs for ObjectMocapRigBipedSpine3pc {}
impl ObjectMocapRigBipedSpine3pcOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMocapRigBipedSpine3pc>
{
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait ObjectMocapRigBipedSpine3pcInnerExt {
    fn chest_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn chops(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_chest(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_lower_back1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_lower_back2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_spine_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lower_back1_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lower_back2_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_chest(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_lower_back2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_spine_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn root_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMocapRigBipedSpine3pcInnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectMocapRigBipedSpine3pc>
{
    fn chest_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
    ...
    fn ctrl_chest(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_chest")
    }
    fn ctrl_lower_back1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_lower_back1")
    }
    fn ctrl_lower_back2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_lower_back2")
    }
    fn ctrl_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_neck")
    }
    fn ctrl_spine_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_spine_root")
    }
    fn lower_back1_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("lower_back1_bone")
    }
    fn lower_back2_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("lower_back2_bone")
    }
    fn ptr_ctrl_chest(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_chest")
    }
    fn ptr_ctrl_lower_back2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_lower_back2")
    }
    fn ptr_ctrl_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_neck")
    }
    fn ptr_ctrl_spine_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_spine_root")
    }
    fn root_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("root_bone")
    }
...
impl ObjectMocapRigBipedSpine5pc {
    ...
    pub fn with_lower_back3_bone_length(mut self, val: f32) -> Self {
        self.params.insert(
            "lower_back3_bone_length".to_string(),
            houdini_ramen_core::types::ParamValue::Float(val),
        );
        self
    }
    ...
    pub fn with_ptr_ctrl_lower_back3_t(mut self, val: [f32; 3]) -> Self {
        self.params.insert(
            "ptr_ctrl_lower_back3_t".to_string(),
            houdini_ramen_core::types::ParamValue::Float3(val),
        );
        self
    }
    ...
    pub fn with_lower_back3_targetpath(mut self, val: &str) -> Self {
        self.params.insert(
            "lower_back3_targetpath".to_string(),
            houdini_ramen_core::types::ParamValue::String(
                val.replace("\r\n", "\n").replace('\r', "\n"),
            ),
        );
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMocapRigBipedSpine5pc {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMocapRigBipedSpine5pcOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMocapRigBipedSpine5pcOutputs for ObjectMocapRigBipedSpine5pc {}
impl ObjectMocapRigBipedSpine5pcOutputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMocapRigBipedSpine5pc>
{
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait ObjectMocapRigBipedSpine5pcInnerExt {
    fn chest1_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn chest2_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn chops(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_chest1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_chest2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_lower_back1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_lower_back2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_lower_back3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ctrl_spine_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lower_back1_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lower_back2_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lower_back3_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_chest1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_chest2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_lower_back2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_lower_back3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ptr_ctrl_spine_root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn root_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}
...
impl<'a> ObjectMocapRigBipedSpine5pcInnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectMocapRigBipedSpine5pc>
{
    fn chest1_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("chest1_bone")
    }
    fn chest2_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("chest2_bone")
    }
    fn chops(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("chops")
    }
    fn ctrl_chest1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_chest1")
    }
    fn ctrl_chest2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_chest2")
    }
    fn ctrl_lower_back1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_lower_back1")
    }
    ...
    fn ctrl_lower_back3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_lower_back3")
    }
    fn ctrl_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ctrl_neck")
    }
    ...
    fn lower_back3_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("lower_back3_bone")
    }
    fn ptr_ctrl_chest1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_chest1")
    }
    fn ptr_ctrl_chest2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_chest2")
    }
    fn ptr_ctrl_lower_back2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_lower_back2")
    }
    fn ptr_ctrl_lower_back3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_lower_back3")
    }
    fn ptr_ctrl_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ptr_ctrl_neck")
    }
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMocapbiped1 {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMocapbiped1Outputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMocapbiped1Outputs for ObjectMocapbiped1 {}
impl ObjectMocapbiped1Outputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMocapbiped1>
{
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait ObjectMocapbiped1InnerExt {
    fn chop(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn head_to_headend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hips(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hips_to_lhipjoint(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hips_to_lowerback(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hips_to_rhipjoint(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lhipjoint_to_leftupleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lthumb_to_lthumbend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftarm_to_leftforearm(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftfingerbase_to_lefthandindex1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftfoot_to_lefttoebase(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftforearm_to_lefthand(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lefthandindex1_to_lefthandindex1end(&mut self)
    -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lefthand_to_lthumb(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lefthand_to_leftfingerbase(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftleg_to_leftfoot(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftshoulder_to_leftarm(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lefttoebase_to_lefttoebaseend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftupleg_to_leftleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lowerback_to_spine(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn master(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn materials(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn neck1_to_head(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn neck_to_neck1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rhipjoint_to_rightupleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rthumb_to_rthumbend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rightarm_to_rightforearm(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rightfingerbase_to_righthandindex1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rightfoot_to_righttoebase(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rightforearm_to_righthand(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn righthandindex1_to_righthandindex1end(
        &mut self,
    ) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn righthand_to_rthumb(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn righthand_to_rightfingerbase(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rightleg_to_rightfoot(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rightshoulder_to_rightarm(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn righttoebase_to_righttoebaseend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rightupleg_to_rightleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn spine1_to_leftshoulder(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn spine1_to_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn spine1_to_rightshoulder(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn spine_to_spine1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rig_offset(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rig_scale(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMocapbiped1InnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectMocapbiped1>
{
    fn chop(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("CHOP")
    }
    fn head_to_headend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Head_To_HeadEnd")
    }
    fn hips(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Hips")
    }
    fn hips_to_lhipjoint(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Hips_To_LHipJoint")
    }
    fn hips_to_lowerback(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Hips_To_LowerBack")
    }
    fn hips_to_rhipjoint(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Hips_To_RHipJoint")
    }
    fn lhipjoint_to_leftupleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LHipJoint_To_LeftUpLeg")
    }
    fn lthumb_to_lthumbend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LThumb_To_LThumbEnd")
    }
    fn leftarm_to_leftforearm(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftArm_To_LeftForeArm")
    }
    fn leftfingerbase_to_lefthandindex1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftFingerBase_To_LeftHandIndex1")
    }
    fn leftfoot_to_lefttoebase(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftFoot_To_LeftToeBase")
    }
    fn leftforearm_to_lefthand(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftForeArm_To_LeftHand")
    }
    fn lefthandindex1_to_lefthandindex1end(
        &mut self,
    ) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftHandIndex1_To_LeftHandIndex1End")
    }
    fn lefthand_to_lthumb(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftHand_To_LThumb")
    }
    fn lefthand_to_leftfingerbase(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftHand_To_LeftFingerBase")
    }
    fn leftleg_to_leftfoot(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftLeg_To_LeftFoot")
    }
    fn leftshoulder_to_leftarm(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftShoulder_To_LeftArm")
    }
    fn lefttoebase_to_lefttoebaseend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftToeBase_To_LeftToeBaseEnd")
    }
    fn leftupleg_to_leftleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LeftUpLeg_To_LeftLeg")
    }
    fn lowerback_to_spine(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LowerBack_To_Spine")
    }
    fn master(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("MASTER")
    }
    fn materials(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("MATERIALS")
    }
    fn neck1_to_head(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Neck1_To_Head")
    }
    fn neck_to_neck1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Neck_To_Neck1")
    }
    fn rhipjoint_to_rightupleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RHipJoint_To_RightUpLeg")
    }
    fn root(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ROOT")
    }
    fn rthumb_to_rthumbend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RThumb_To_RThumbEnd")
    }
    fn rightarm_to_rightforearm(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightArm_To_RightForeArm")
    }
    fn rightfingerbase_to_righthandindex1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightFingerBase_To_RightHandIndex1")
    }
    fn rightfoot_to_righttoebase(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightFoot_To_RightToeBase")
    }
    fn rightforearm_to_righthand(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightForeArm_To_RightHand")
    }
    fn righthandindex1_to_righthandindex1end(
        &mut self,
    ) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightHandIndex1_To_RightHandIndex1End")
    }
    fn righthand_to_rthumb(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightHand_To_RThumb")
    }
    fn righthand_to_rightfingerbase(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightHand_To_RightFingerBase")
    }
    fn rightleg_to_rightfoot(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightLeg_To_RightFoot")
    }
    fn rightshoulder_to_rightarm(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightShoulder_To_RightArm")
    }
    fn righttoebase_to_righttoebaseend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightToeBase_To_RightToeBaseEnd")
    }
    fn rightupleg_to_rightleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("RightUpLeg_To_RightLeg")
    }
    fn spine1_to_leftshoulder(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Spine1_To_LeftShoulder")
    }
    fn spine1_to_neck(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Spine1_To_Neck")
    }
    fn spine1_to_rightshoulder(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Spine1_To_RightShoulder")
    }
    fn spine_to_spine1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("Spine_To_Spine1")
    }
    fn geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("geo")
    }
    fn rig_offset(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("rig_offset")
    }
    fn rig_scale(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMocapbiped2 {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMocapbiped2Outputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMocapbiped2Outputs for ObjectMocapbiped2 {}
impl ObjectMocapbiped2Outputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMocapbiped2>
{
}
...
pub trait ObjectMocapbiped2InnerExt {
    ...
    fn master(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn materials(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ank_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ank_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ank_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ank_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ball_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ball_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn bicep_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn bicep_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn bicep_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn bicep_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn clav_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn clav_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn clav_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn clav_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn elbow_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn elbow_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn elbow_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn elbow_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hip_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hip_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hip_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hip_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn index2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn indexbase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn indexbase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn indexbase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn indexbase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn jaw_0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn knee_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn knee_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn knee_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn knee_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middle2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middlebase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middlebase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middlebase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn middlebase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pelvis_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pelvis_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pelvis_bnd_bone1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pelvis_bnd_bone2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinky2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinkybase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinkybase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinkybase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn pinkybase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rescale(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ring2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ringbase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ringbase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ringbase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ringbase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn sho_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn sho_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn sho_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn sho_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfnecktip_0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfnecktip_0_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfneck_0_jnt0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfneck_0_jnt0_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfneck_0_jnt1_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfneck_0_jnt1_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfneck_0_jnt2_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfneck_0_jnt2_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfneck_0_jnt3_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn surfneck_0_jnt3_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thigh_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thigh_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thigh_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thigh_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumb2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumbbase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumbbase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumbbase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn thumbbase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspinetip_c_0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspinetip_c_0_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspinetip_c_0_bnd_bone1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspinetip_c_0_bnd_bone2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_0_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_1_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_1_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_2_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_2_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_3_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_3_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_4_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn twisterspine_c_0_vrb_4_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ulna_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ulna_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ulna_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn ulna_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_l_bnd_bone1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_l_bnd_bone2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_l_bnd_bone3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_l_bnd_bone4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_r_bnd_bone1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_r_bnd_bone2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_r_bnd_bone3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn wrist_0_r_bnd_bone4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMocapbiped2InnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectMocapbiped2>
{
    fn chop(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("CHOP")
    }
    ...
    fn ank_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ank_0_L_Bnd")
    }
    fn ank_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ank_0_L_Bnd_bone")
    }
    fn ank_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ank_0_R_Bnd")
    }
    fn ank_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ank_0_R_Bnd_bone")
    }
    fn ball_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ball_0_L_Bnd")
    }
    fn ball_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ball_0_R_Bnd")
    }
    fn bicep_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("bicep_0_L_Bnd")
    }
    fn bicep_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("bicep_0_L_Bnd_bone")
    }
    fn bicep_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("bicep_0_R_Bnd")
    }
    fn bicep_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("bicep_0_R_Bnd_bone")
    }
    fn clav_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("clav_0_L_Bnd")
    }
    fn clav_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("clav_0_L_Bnd_bone")
    }
    fn clav_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("clav_0_R_Bnd")
    }
    fn clav_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("clav_0_R_Bnd_bone")
    }
    fn elbow_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("elbow_0_L_Bnd")
    }
    fn elbow_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("elbow_0_L_Bnd_bone")
    }
    fn elbow_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("elbow_0_R_Bnd")
    }
    fn elbow_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("elbow_0_R_Bnd_bone")
    }
    fn geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("geo")
    }
    fn hip_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("hip_0_L_Bnd")
    }
    fn hip_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("hip_0_L_Bnd_bone")
    }
    fn hip_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("hip_0_R_Bnd")
    }
    fn hip_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("hip_0_R_Bnd_bone")
    }
    fn index0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index0_0_L_Bnd")
    }
    fn index0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index0_0_L_Bnd_bone")
    }
    fn index0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index0_0_R_Bnd")
    }
    fn index0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index0_0_R_Bnd_bone")
    }
    fn index1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index1_0_L_Bnd")
    }
    fn index1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index1_0_L_Bnd_bone")
    }
    fn index1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index1_0_R_Bnd")
    }
    fn index1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index1_0_R_Bnd_bone")
    }
    fn index2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index2_0_L_Bnd")
    }
    fn index2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("index2_0_R_Bnd")
    }
    fn indexbase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("indexBase_0_L_Bnd")
    }
    fn indexbase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("indexBase_0_L_Bnd_bone")
    }
    fn indexbase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("indexBase_0_R_Bnd")
    }
    fn indexbase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("indexBase_0_R_Bnd_bone")
    }
    fn jaw_0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("jaw_0_Bnd")
    }
    fn knee_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("knee_0_L_Bnd")
    }
    fn knee_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("knee_0_L_Bnd_bone")
    }
    fn knee_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("knee_0_R_Bnd")
    }
    fn knee_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("knee_0_R_Bnd_bone")
    }
    fn middle0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle0_0_L_Bnd")
    }
    fn middle0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle0_0_L_Bnd_bone")
    }
    fn middle0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle0_0_R_Bnd")
    }
    fn middle0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle0_0_R_Bnd_bone")
    }
    fn middle1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle1_0_L_Bnd")
    }
    fn middle1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle1_0_L_Bnd_bone")
    }
    fn middle1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle1_0_R_Bnd")
    }
    fn middle1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle1_0_R_Bnd_bone")
    }
    fn middle2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle2_0_L_Bnd")
    }
    fn middle2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middle2_0_R_Bnd")
    }
    fn middlebase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middleBase_0_L_Bnd")
    }
    fn middlebase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middleBase_0_L_Bnd_bone")
    }
    fn middlebase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middleBase_0_R_Bnd")
    }
    fn middlebase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("middleBase_0_R_Bnd_bone")
    }
    fn pelvis_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pelvis_Bnd")
    }
    fn pelvis_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pelvis_Bnd_bone")
    }
    fn pelvis_bnd_bone1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pelvis_Bnd_bone1")
    }
    fn pelvis_bnd_bone2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pelvis_Bnd_bone2")
    }
    fn pinky0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky0_0_L_Bnd")
    }
    fn pinky0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky0_0_L_Bnd_bone")
    }
    fn pinky0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky0_0_R_Bnd")
    }
    fn pinky0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky0_0_R_Bnd_bone")
    }
    fn pinky1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky1_0_L_Bnd")
    }
    fn pinky1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky1_0_L_Bnd_bone")
    }
    fn pinky1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky1_0_R_Bnd")
    }
    fn pinky1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky1_0_R_Bnd_bone")
    }
    fn pinky2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky2_0_L_Bnd")
    }
    fn pinky2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinky2_0_R_Bnd")
    }
    fn pinkybase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinkyBase_0_L_Bnd")
    }
    fn pinkybase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinkyBase_0_L_Bnd_bone")
    }
    fn pinkybase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinkyBase_0_R_Bnd")
    }
    fn pinkybase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("pinkyBase_0_R_Bnd_bone")
    }
    fn rescale(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("rescale")
    }
    fn ring0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring0_0_L_Bnd")
    }
    fn ring0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring0_0_L_Bnd_bone")
    }
    fn ring0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring0_0_R_Bnd")
    }
    fn ring0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring0_0_R_Bnd_bone")
    }
    fn ring1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring1_0_L_Bnd")
    }
    fn ring1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring1_0_L_Bnd_bone")
    }
    fn ring1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring1_0_R_Bnd")
    }
    fn ring1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring1_0_R_Bnd_bone")
    }
    fn ring2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring2_0_L_Bnd")
    }
    fn ring2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ring2_0_R_Bnd")
    }
    fn ringbase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ringBase_0_L_Bnd")
    }
    fn ringbase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ringBase_0_L_Bnd_bone")
    }
    fn ringbase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ringBase_0_R_Bnd")
    }
    fn ringbase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ringBase_0_R_Bnd_bone")
    }
    fn sho_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("sho_0_L_Bnd")
    }
    fn sho_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("sho_0_L_Bnd_bone")
    }
    fn sho_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("sho_0_R_Bnd")
    }
    fn sho_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("sho_0_R_Bnd_bone")
    }
    fn surfnecktip_0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneckTip_0_Bnd")
    }
    fn surfnecktip_0_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneckTip_0_Bnd_bone")
    }
    fn surfneck_0_jnt0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneck_0_jnt0_Bnd")
    }
    fn surfneck_0_jnt0_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneck_0_jnt0_Bnd_bone")
    }
    fn surfneck_0_jnt1_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneck_0_jnt1_Bnd")
    }
    fn surfneck_0_jnt1_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneck_0_jnt1_Bnd_bone")
    }
    fn surfneck_0_jnt2_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneck_0_jnt2_Bnd")
    }
    fn surfneck_0_jnt2_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneck_0_jnt2_Bnd_bone")
    }
    fn surfneck_0_jnt3_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneck_0_jnt3_Bnd")
    }
    fn surfneck_0_jnt3_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("surfneck_0_jnt3_Bnd_bone")
    }
    fn thigh_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thigh_0_L_Bnd")
    }
    fn thigh_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thigh_0_L_Bnd_bone")
    }
    fn thigh_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thigh_0_R_Bnd")
    }
    fn thigh_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thigh_0_R_Bnd_bone")
    }
    fn thumb0_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb0_0_L_Bnd")
    }
    fn thumb0_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb0_0_L_Bnd_bone")
    }
    fn thumb0_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb0_0_R_Bnd")
    }
    fn thumb0_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb0_0_R_Bnd_bone")
    }
    fn thumb1_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb1_0_L_Bnd")
    }
    fn thumb1_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb1_0_L_Bnd_bone")
    }
    fn thumb1_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb1_0_R_Bnd")
    }
    fn thumb1_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb1_0_R_Bnd_bone")
    }
    fn thumb2_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb2_0_L_Bnd")
    }
    fn thumb2_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumb2_0_R_Bnd")
    }
    fn thumbbase_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumbBase_0_L_Bnd")
    }
    fn thumbbase_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumbBase_0_L_Bnd_bone")
    }
    fn thumbbase_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumbBase_0_R_Bnd")
    }
    fn thumbbase_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("thumbBase_0_R_Bnd_bone")
    }
    fn twisterspinetip_c_0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspineTip_C_0_Bnd")
    }
    fn twisterspinetip_c_0_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspineTip_C_0_Bnd_bone")
    }
    fn twisterspinetip_c_0_bnd_bone1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspineTip_C_0_Bnd_bone1")
    }
    fn twisterspinetip_c_0_bnd_bone2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspineTip_C_0_Bnd_bone2")
    }
    fn twisterspine_c_0_vrb_0_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_0_Bnd")
    }
    fn twisterspine_c_0_vrb_0_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_0_Bnd_bone")
    }
    fn twisterspine_c_0_vrb_1_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_1_Bnd")
    }
    fn twisterspine_c_0_vrb_1_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_1_Bnd_bone")
    }
    fn twisterspine_c_0_vrb_2_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_2_Bnd")
    }
    fn twisterspine_c_0_vrb_2_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_2_Bnd_bone")
    }
    fn twisterspine_c_0_vrb_3_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_3_Bnd")
    }
    fn twisterspine_c_0_vrb_3_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_3_Bnd_bone")
    }
    fn twisterspine_c_0_vrb_4_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_4_Bnd")
    }
    fn twisterspine_c_0_vrb_4_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("twisterspine_C_0_vrb_4_Bnd_bone")
    }
    fn ulna_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ulna_0_L_Bnd")
    }
    fn ulna_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ulna_0_L_Bnd_bone")
    }
    fn ulna_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ulna_0_R_Bnd")
    }
    fn ulna_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("ulna_0_R_Bnd_bone")
    }
    fn wrist_0_l_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_L_Bnd")
    }
    fn wrist_0_l_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_L_Bnd_bone")
    }
    fn wrist_0_l_bnd_bone1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_L_Bnd_bone1")
    }
    fn wrist_0_l_bnd_bone2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_L_Bnd_bone2")
    }
    fn wrist_0_l_bnd_bone3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_L_Bnd_bone3")
    }
    fn wrist_0_l_bnd_bone4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_L_Bnd_bone4")
    }
    fn wrist_0_r_bnd(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_R_Bnd")
    }
    fn wrist_0_r_bnd_bone(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_R_Bnd_bone")
    }
    fn wrist_0_r_bnd_bone1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_R_Bnd_bone1")
    }
    fn wrist_0_r_bnd_bone2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_R_Bnd_bone2")
    }
    fn wrist_0_r_bnd_bone3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("wrist_0_R_Bnd_bone3")
    }
    fn wrist_0_r_bnd_bone4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMocapbiped3 {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMocapbiped3Outputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMocapbiped3Outputs for ObjectMocapbiped3 {}
impl ObjectMocapbiped3Outputs
    for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMocapbiped3>
{
}
...
pub trait ObjectMocapbiped3InnerExt {
    ...
    fn head_to_headend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn hips(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn incline_proxy(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn lhipjoint_to_leftupleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftarm_to_leftforearm(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftfingerbase_to_lefthandindex1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn leftfoot_to_lefttoebase(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    ...
    fn righttoebase_to_righttoebaseend(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn rightupleg_to_rightleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn step_proxy(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn spine_to_spine1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn geo_skin(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMocapbiped3InnerExt
    for houdini_ramen_core::graph::InnerGraph<'a, ObjectMocapbiped3>
{
    fn chop(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("CHOP")
    }
    ...
    fn incline_proxy(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("INCLINE_PROXY")
    }
    fn lhipjoint_to_leftupleg(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("LHipJoint_To_LeftUpLeg")
    }
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMuscle {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMuscleOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMuscleOutputs for ObjectMuscle {}
impl ObjectMuscleOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMuscle> {}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait ObjectMuscleInnerExt {
    fn muscle(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMuscleInnerExt for houdini_ramen_core::graph::InnerGraph<'a, ObjectMuscle> {
    fn muscle(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl ObjectMusclepin {
    ...
    pub fn set_origin_anchor_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
    ...
    pub fn with_displayconstraintradius(mut self, val: bool) -> Self {
        self.params.insert(
            "displayconstraintradius".to_string(),
            houdini_ramen_core::types::ParamValue::Toggle(val),
        );
        self
    }
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMusclepin {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMusclepinOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMusclepinOutputs for ObjectMusclepin {}
impl ObjectMusclepinOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMusclepin> {}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait ObjectMusclepinInnerExt {
    fn capture_handle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn constraint_region(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn default_geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn handle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn head_radius(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn head_radius_capture(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn head_radius_handle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn internal_core(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMusclepinInnerExt for houdini_ramen_core::graph::InnerGraph<'a, ObjectMusclepin> {
    fn capture_handle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("capture_handle1")
    }
    fn constraint_region(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("constraint_region")
    }
    fn default_geo(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("default_geo")
    }
    fn handle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
    ...
    fn head_radius_capture(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("head_radius_capture")
    }
    fn head_radius_handle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
        self.existing_node("head_radius_handle1")
    }
    fn internal_core(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
...
impl ObjectMusclerig {
    ...
    pub fn set_end_anchor_input<O: Into<houdini_ramen_core::types::NodeOutput>>(
        mut self,
        output: O,
    ) -> Self {
        let out = output.into();
    ...
    pub fn with_profile(mut self, val: Vec<houdini_ramen_core::types::RampPoint>) -> Self {
        self.params.insert(
            "profile".to_string(),
    ...
    pub fn with_targetstiffnessvramp(
        mut self,
...
impl houdini_ramen_core::types::HoudiniNode for ObjectMusclerig {
    fn get_id(&self) -> usize {
        self.id
    }
    fn get_name(&self) -> &str {
...
pub trait ObjectMusclerigOutputs: houdini_ramen_core::types::HoudiniNode {
    /// Output pin: "Output 1"
    fn out_output1(&self) -> houdini_ramen_core::types::NodeOutput {
        houdini_ramen_core::types::NodeOutput {
            node_id: self.get_id(),
...
impl ObjectMusclerigOutputs for ObjectMusclerig {}
impl ObjectMusclerigOutputs for houdini_ramen_core::graph::TypedExistingNodeRef<ObjectMusclerig> {}

#[allow(clippy::wrong_self_convention, non_snake_case)]
pub trait ObjectMusclerigInnerExt {
    fn tightnessdriver(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blend_handle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blend_handle2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blend_jiggle(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blend_jiggle_handle2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blend_jiggle_handle4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blend_middle(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blend_tight1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blend_tight2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn blend_tight3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn capture_handle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn capture_handle2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn capture_handle3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn capture_handle4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn capture_handle5(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn cv1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn cv2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn cv3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn cv4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn cv5(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn handle1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn handle2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn handle3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn handle4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn handle5(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn head_radius(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn internal_core(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn jiggle_chop(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn jiggled_handle2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn jiggled_handle4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn jiggled_null(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn stroke_container(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_to_capture_pose(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_to_capture_pose1(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_to_capture_pose2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_to_capture_pose3(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn switch_to_capture_pose4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn tailradius(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn unjiggled_handle2(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn unjiggled_handle4(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
    fn unjiggled_null(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef;
}

#[allow(clippy::wrong_self_convention, non_snake_case)]
impl<'a> ObjectMusclerigInnerExt for houdini_ramen_core::graph::InnerGraph<'a, ObjectMusclerig> {
    fn tightnessdriver(&mut self) -> houdini_ramen_core::graph::ExistingNodeRef {
