...
impl houdini_ramen_core::types::HoudiniNode for ShopDiffuseEval {
...
impl houdini_ramen_core::types::HoudiniNode for ShopDiffuseSample {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopDopnet {
    fn get_id(&self) -> usize {
        self.id
    }
