...
impl houdini_ramen_core::types::HoudiniNode for ShopScalarvolumenoise {
...
impl houdini_ramen_core::types::HoudiniNode for ShopSelect {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopSinglesssEval {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopSinglesssSample {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopSopnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopSuboutput {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopSwitch {
    fn get_id(&self) -> usize {
        self.id
    }
