...
impl houdini_ramen_core::types::HoudiniNode for ShopHairEval {
...
impl houdini_ramen_core::types::HoudiniNode for ShopHairSample {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopHairshader {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopHenyeygreensteinEval {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopHenyeygreensteinSample {
    fn get_id(&self) -> usize {
        self.id
    }
