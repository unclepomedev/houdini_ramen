...
impl houdini_ramen_core::types::HoudiniNode for ShopMantrasurface {
...
impl houdini_ramen_core::types::HoudiniNode for ShopMaterial {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopMatnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopMergecoshader {
    fn get_id(&self) -> usize {
        self.id
    }
