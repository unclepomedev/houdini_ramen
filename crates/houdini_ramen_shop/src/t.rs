...
impl houdini_ramen_core::types::HoudiniNode for ShopToonoutlineshader {
...
impl houdini_ramen_core::types::HoudiniNode for ShopToonshading {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopTopnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopTranslucencyEval {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for ShopTranslucencySample {
    fn get_id(&self) -> usize {
        self.id
    }
