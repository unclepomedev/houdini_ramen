...
impl LopInstancer {
    ...
    pub fn set_input_possible_prototype_source<N: houdini_ramen_core::types::HoudiniNode>(
        mut self,
        target: &N,
    ) -> Self {
    ...
    pub fn set_input_possible_prototype_source_from<N: houdini_ramen_core::types::HoudiniNode>(
        mut self,
        target: &N,
        output_index: usize,
    ) -> Self {
