...
impl houdini_ramen_core::types::HoudiniNode for CopVdbactivatefrompoints {
...
impl houdini_ramen_core::types::HoudiniNode for CopVdbfromlayer {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVdbleafpoints {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVdbposmap {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVdbreshape {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVdbvisualize {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVdbvisualizeslice {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVdbvisualizetree {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVdbvisualizevelocity {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVectorxform {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVectorxform2d {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl CopVignette {
    ...
    // --- Ramp parameters ---
    pub fn with_shaperamp(mut self, val: Vec<houdini_ramen_core::types::RampPoint>) -> Self {
        self.params.insert(
            "shaperamp".to_string(),
            houdini_ramen_core::types::ParamValue::Ramp(val),
        );
...
impl houdini_ramen_core::types::HoudiniNode for CopVignette {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopVopnet {
    fn get_id(&self) -> usize {
        self.id
    }
