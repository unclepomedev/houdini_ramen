...
impl CopDefocus {
    ...
    // --- Ramp parameters ---
    pub fn with_focusramp(mut self, val: Vec<houdini_ramen_core::types::RampPoint>) -> Self {
        self.params.insert(
            "focusramp".to_string(),
...
impl houdini_ramen_core::types::HoudiniNode for CopDefocus {
...
impl houdini_ramen_core::types::HoudiniNode for CopDenoiseai {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopDenoisetvd {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopDerivative {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopDilateerode {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopDistort {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopDopnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopDot {
    fn get_id(&self) -> usize {
        self.id
    }
