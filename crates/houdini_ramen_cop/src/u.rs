...
impl houdini_ramen_core::types::HoudiniNode for CopUvmap {
...
impl houdini_ramen_core::types::HoudiniNode for CopUvmapbyid {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopUvtopolar {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopUvtorgb {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopUvtorgba {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopUvxform {
    fn get_id(&self) -> usize {
        self.id
    }
