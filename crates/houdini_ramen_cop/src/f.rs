...
impl houdini_ramen_core::types::HoudiniNode for CopFeather {
...
impl houdini_ramen_core::types::HoudiniNode for CopFetch {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFile {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFill {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl CopFillconnected {
    ...
    // --- Ramp parameters ---
    pub fn with_fallofframp(mut self, val: Vec<houdini_ramen_core::types::RampPoint>) -> Self {
        self.params.insert(
...
impl houdini_ramen_core::types::HoudiniNode for CopFillconnected {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFlip {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFlowBlockBegin {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFlowBlockEnd {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFlowProjectnondivergentmultigrid {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFont {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFractalnoise {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFractalnoise3d {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopFunction {
    fn get_id(&self) -> usize {
        self.id
    }
