...
impl CopHeatdistort {
    ...
    pub fn with_globalelementsizetype(mut self, val: CopHeatdistortGlobalelementsizetype) -> Self {
        self.params.insert(
            "globalelementsizetype".to_string(),
    ...
    pub fn with_detailelementsizetype(mut self, val: CopHeatdistortDetailelementsizetype) -> Self {
        self.params.insert(
            "detailelementsizetype".to_string(),
            houdini_ramen_core::types::ParamValue::Menu(val as i32),
        );
        self
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopHeatdistort {
...
impl houdini_ramen_core::types::HoudiniNode for CopHeatdistortbylayer {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopHeightfieldVisualize {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopHeighttoambientocclusion {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopHeighttonormal {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl CopHeighttoshadow {
    ...
    pub fn with_directional_altitude(mut self, val: f32) -> Self {
        self.params.insert(
            "directional_altitude".to_string(),
            houdini_ramen_core::types::ParamValue::Float(val),
        );
        self
    }
    ...
    pub fn with_directional_direction(mut self, val: [f32; 3]) -> Self {
        self.params.insert(
            "directional_direction".to_string(),
            houdini_ramen_core::types::ParamValue::Float3(val),
        );
        self
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopHeighttoshadow {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopHextile {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopHistogram {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopHsv {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopHyperbolictile {
    fn get_id(&self) -> usize {
        self.id
    }
