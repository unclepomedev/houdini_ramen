...
impl houdini_ramen_core::types::HoudiniNode for CopGamma {
...
impl houdini_ramen_core::types::HoudiniNode for CopGeotolayer {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopGlow {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopGrungeAurora {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopGrungeBirchbark {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopGrungeLayerednoise {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopGrungePinebark {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopGrungeRust {
    fn get_id(&self) -> usize {
        self.id
    }
