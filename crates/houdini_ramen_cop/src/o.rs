...
impl houdini_ramen_core::types::HoudiniNode for CopObjnet {
...
impl houdini_ramen_core::types::HoudiniNode for CopOciotransform {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopOnnx {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopOpencl {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl houdini_ramen_core::types::HoudiniNode for CopOutput {
    fn get_id(&self) -> usize {
        self.id
    }
