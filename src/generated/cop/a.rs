...
impl CopAutostereogram {
    ...
    pub fn with_recenter(mut self, val: bool) -> Self {
        self.params.insert("recenter".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_recenter_expr(mut self, expr: &str) -> Self {
        self.params.insert("recenter".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
