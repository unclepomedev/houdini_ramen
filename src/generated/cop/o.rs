...
impl CopOciotransform {
    ...
    pub fn with_sourcespace(mut self, val: &str) -> Self {
        self.params.insert("sourcespace".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_sourcespace_expr(mut self, expr: &str) -> Self {
        self.params.insert("sourcespace".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_todisplay(mut self, val: &str) -> Self {
        self.params.insert("todisplay".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_todisplay_expr(mut self, expr: &str) -> Self {
        self.params.insert("todisplay".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_toview(mut self, val: &str) -> Self {
        self.params.insert("toview".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_toview_expr(mut self, expr: &str) -> Self {
        self.params.insert("toview".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl CopOnnx {
    ...
    pub fn trigger_output_deduceshape(mut self) -> Self {
        self.params.insert("output_deduceshape".to_string(), crate::core::types::ParamValue::Button);
        self
    }

    // --- Float parameters ---
    pub fn with_input_brightscale_inst(mut self, index1: usize, val: f32) -> Self {
        self.params.insert(format!("input_brightscale{}", index1), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_input_brightscale_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("input_brightscale{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_output_brightscale_inst(mut self, index1: usize, val: f32) -> Self {
        self.params.insert(format!("output_brightscale{}", index1), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_output_brightscale_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("output_brightscale{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_model_input_channelsize_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("model_input_channelsize{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_model_input_channelsize_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_input_channelsize{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_model_output_channelsize_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("model_output_channelsize{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_model_output_channelsize_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_output_channelsize{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_node_output_channelsize_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("node_output_channelsize{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_node_output_channelsize_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_output_channelsize{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int2 parameters ---
    pub fn with_resample_size_inst(mut self, index1: usize, val: [i32; 2]) -> Self {
        self.params.insert(format!("resample_size{}", index1), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_resample_size_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("resample_size{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- IntArray parameters ---
    pub fn with_model_input_shape_inst(mut self, index1: usize, val: Vec<i32>) -> Self {
        self.params.insert(format!("model_input_shape{}", index1), crate::core::types::ParamValue::IntArray(val));
        self
    }
    pub fn with_model_input_shape_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_input_shape{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_model_output_shape_inst(mut self, index1: usize, val: Vec<i32>) -> Self {
        self.params.insert(format!("model_output_shape{}", index1), crate::core::types::ParamValue::IntArray(val));
        self
    }
    pub fn with_model_output_shape_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_output_shape{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_node_output_shape_inst(mut self, index1: usize, val: Vec<i32>) -> Self {
        self.params.insert(format!("node_output_shape{}", index1), crate::core::types::ParamValue::IntArray(val));
        self
    }
    pub fn with_node_output_shape_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_output_shape{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_model_input_volorder_inst(mut self, index1: usize, val: CopOnnxModelInputVolorder) -> Self {
        self.params.insert(format!("model_input_volorder{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_model_input_volorder_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_input_volorder{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_model_output_volorder_inst(mut self, index1: usize, val: CopOnnxModelOutputVolorder) -> Self {
        self.params.insert(format!("model_output_volorder{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_model_output_volorder_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_output_volorder{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_node_input_volorder_inst(mut self, index1: usize, val: CopOnnxNodeInputVolorder) -> Self {
        self.params.insert(format!("node_input_volorder{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_node_input_volorder_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_input_volorder{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_resample_filter_inst(mut self, index1: usize, val: CopOnnxResampleFilter) -> Self {
        self.params.insert(format!("resample_filter{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_resample_filter_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("resample_filter{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_node_output_volorder_inst(mut self, index1: usize, val: CopOnnxNodeOutputVolorder) -> Self {
        self.params.insert(format!("node_output_volorder{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_node_output_volorder_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_output_volorder{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_model_input_name_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("model_input_name{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_model_input_name_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_input_name{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_model_input_data_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("model_input_data{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_model_input_data_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_input_data{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_model_output_name_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("model_output_name{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_model_output_name_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_output_name{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_node_input_name_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("node_input_name{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_node_input_name_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_input_name{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_input_scalemenu_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("input_scalemenu{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_input_scalemenu_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("input_scalemenu{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_node_output_name_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("node_output_name{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_node_output_name_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_output_name{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_node_output_data_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("node_output_data{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_node_output_data_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_output_data{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_output_scalemenu_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("output_scalemenu{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_output_scalemenu_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("output_scalemenu{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_model_input_channelfirst_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("model_input_channelfirst{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_model_input_channelfirst_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_input_channelfirst{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_model_input_customchannel_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("model_input_customchannel{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_model_input_customchannel_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_input_customchannel{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_model_output_channelfirst_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("model_output_channelfirst{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_model_output_channelfirst_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_output_channelfirst{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_model_output_customchannel_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("model_output_customchannel{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_model_output_customchannel_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("model_output_customchannel{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_input_flip_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("input_flip{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_input_flip_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("input_flip{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_node_input_channelfirst_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("node_input_channelfirst{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_node_input_channelfirst_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_input_channelfirst{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_resample_enable_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("resample_enable{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_resample_enable_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("resample_enable{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_input_brightenable_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("input_brightenable{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_input_brightenable_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("input_brightenable{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_node_output_autodeduce_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("node_output_autodeduce{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_node_output_autodeduce_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_output_autodeduce{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_output_flip_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("output_flip{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_output_flip_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("output_flip{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_node_output_channelfirst_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("node_output_channelfirst{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_node_output_channelfirst_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_output_channelfirst{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_node_output_customchannel_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("node_output_customchannel{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_node_output_customchannel_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("node_output_customchannel{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_output_brightenable_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("output_brightenable{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_output_brightenable_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("output_brightenable{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl CopOpencl {
    ...
    pub fn trigger_displaycode(mut self) -> Self {
        self.params.insert("displaycode".to_string(), crate::core::types::ParamValue::Button);
        self
    }

    // --- Float parameters ---
    pub fn with_options_timescale(mut self, val: f32) -> Self {
        self.params.insert("options_timescale".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_options_timescale_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_timescale".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_options_iterations(mut self, val: i32) -> Self {
        self.params.insert("options_iterations".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_options_iterations_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_iterations".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_options_tile(mut self, val: [i32; 2]) -> Self {
        self.params.insert("options_tile".to_string(), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_options_tile_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_tile".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int3 parameters ---
    pub fn with_options_vdbtile(mut self, val: [i32; 3]) -> Self {
        self.params.insert("options_vdbtile".to_string(), crate::core::types::ParamValue::Int3(val));
        self
    }
    pub fn with_options_vdbtile_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_vdbtile".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_options_runover(mut self, val: CopOpenclOptionsRunover) -> Self {
        self.params.insert("options_runover".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_options_runover_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_runover".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_options_timemethod(mut self, val: CopOpenclOptionsTimemethod) -> Self {
        self.params.insert("options_timemethod".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_options_timemethod_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_timemethod".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_options_precision(mut self, val: CopOpenclOptionsPrecision) -> Self {
        self.params.insert("options_precision".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_options_precision_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_precision".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_output_metadata_inst(mut self, index1: usize, val: CopOpenclOutputMetadata) -> Self {
        self.params.insert(format!("output{}_metadata", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_output_metadata_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("output{}_metadata", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_output_precision_inst(mut self, index1: usize, val: CopOpenclOutputPrecision) -> Self {
        self.params.insert(format!("output{}_precision", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_output_precision_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("output{}_precision", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_output_typeinfo_inst(mut self, index1: usize, val: CopOpenclOutputTypeinfo) -> Self {
        self.params.insert(format!("output{}_typeinfo", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_output_typeinfo_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("output{}_typeinfo", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_bindings_ramptype_inst(mut self, index1: usize, val: CopOpenclBindingsRamptype) -> Self {
    ...
    pub fn with_bindings_layertype_inst(mut self, index1: usize, val: CopOpenclBindingsLayertype) -> Self {
        self.params.insert(format!("bindings{}_layertype", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_bindings_layertype_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("bindings{}_layertype", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bindings_layerborder_inst(mut self, index1: usize, val: CopOpenclBindingsLayerborder) -> Self {
        self.params.insert(format!("bindings{}_layerborder", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_bindings_layerborder_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("bindings{}_layerborder", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bindings_vdbtype_inst(mut self, index1: usize, val: CopOpenclBindingsVdbtype) -> Self {
    ...
    pub fn with_bindings_attribclass_inst(mut self, index1: usize, val: CopOpenclBindingsAttribclass) -> Self {
    ...
    pub fn with_bindings_attribtype_inst(mut self, index1: usize, val: CopOpenclBindingsAttribtype) -> Self {
    ...
    pub fn with_bindings_precision_inst(mut self, index1: usize, val: CopOpenclBindingsPrecision) -> Self {
    ...
    pub fn with_bindings_timescale_inst(mut self, index1: usize, val: CopOpenclBindingsTimescale) -> Self {
    ...
    pub fn with_output_metaname_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("output{}_metaname", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_output_metaname_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("output{}_metaname", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_bindings_portname_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("bindings{}_portname", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_bindings_portname_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("bindings{}_portname", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_options_usevdbtile(mut self, val: bool) -> Self {
        self.params.insert("options_usevdbtile".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_options_usevdbtile_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_usevdbtile".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_options_iteration(mut self, val: bool) -> Self {
        self.params.insert("options_iteration".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_options_iteration_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_iteration".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_options_time(mut self, val: bool) -> Self {
        self.params.insert("options_time".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_options_time_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_time".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_options_timeinccontext(mut self, val: bool) -> Self {
        self.params.insert("options_timeinccontext".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_options_timeinccontext_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_timeinccontext".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_options_timeinc(mut self, val: bool) -> Self {
        self.params.insert("options_timeinc".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_options_timeinc_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_timeinc".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_options_importprequel(mut self, val: bool) -> Self {
        self.params.insert("options_importprequel".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_options_importprequel_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_importprequel".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_options_timing(mut self, val: bool) -> Self {
        self.params.insert("options_timing".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_options_timing_expr(mut self, expr: &str) -> Self {
        self.params.insert("options_timing".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
