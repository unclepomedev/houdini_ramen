...
impl CopLatticedeform {
    ...
    pub fn with_lodv(mut self, val: f32) -> Self {
        self.params.insert("lodv".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_lodv_expr(mut self, expr: &str) -> Self {
        self.params.insert("lodv".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float2 parameters ---
    pub fn with_point_inst(mut self, index1: usize, index2: usize, val: [f32; 2]) -> Self {
        self.params.insert(format!("point{}_{}", index1, index2), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_point_inst_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("point{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_cellspercolumn(mut self, val: i32) -> Self {
        self.params.insert("cellspercolumn".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_cellspercolumn_expr(mut self, expr: &str) -> Self {
        self.params.insert("cellspercolumn".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl CopLayer {
    ...
    pub fn with_typeinfo(mut self, val: CopLayerTypeinfo) -> Self {
        self.params.insert("typeinfo".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_typeinfo_expr(mut self, expr: &str) -> Self {
        self.params.insert("typeinfo".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_setpixelaspectratio(mut self, val: bool) -> Self {
        self.params.insert("setpixelaspectratio".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_setpixelaspectratio_expr(mut self, expr: &str) -> Self {
        self.params.insert("setpixelaspectratio".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_setpixelpad(mut self, val: bool) -> Self {
        self.params.insert("setpixelpad".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_setpixelpad_expr(mut self, expr: &str) -> Self {
        self.params.insert("setpixelpad".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_usefixedpoint(mut self, val: bool) -> Self {
        self.params.insert("usefixedpoint".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usefixedpoint_expr(mut self, expr: &str) -> Self {
        self.params.insert("usefixedpoint".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_settypeinfo(mut self, val: bool) -> Self {
        self.params.insert("settypeinfo".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_settypeinfo_expr(mut self, expr: &str) -> Self {
        self.params.insert("settypeinfo".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl CopLayerattribcreate {
    ...
    pub fn with_valf_inst(mut self, index1: usize, val: f32) -> Self {
        self.params.insert(format!("valf{}", index1), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_valf_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("valf{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_vali_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("vali{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_vali_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("vali{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vals_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("vals{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vals_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("vals{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl CopLayerattribdelete {
    ...
    pub fn with_delete(mut self, val: &str) -> Self {
        self.params.insert("delete".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_keep(mut self, val: &str) -> Self {
        self.params.insert("keep".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
...
impl CopLayerfromcurves {
    ...
    pub fn with_twistrate(mut self, val: f32) -> Self {
        self.params.insert("twistrate".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_twistrate_expr(mut self, expr: &str) -> Self {
        self.params.insert("twistrate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_profileramp(mut self, val: Vec<crate::core::types::RampPoint>) -> Self {
        self.params.insert("profileramp".to_string(), crate::core::types::ParamValue::Ramp(val));
        self
    }
    pub fn with_profileramp_expr(mut self, expr: &str) -> Self {
        self.params.insert("profileramp".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_coloralonglength(mut self, val: Vec<crate::core::types::RampPoint>) -> Self {
        self.params.insert("coloralonglength".to_string(), crate::core::types::ParamValue::Ramp(val));
        self
    }
    pub fn with_coloralonglength_expr(mut self, expr: &str) -> Self {
        self.params.insert("coloralonglength".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_coloracrosswidth(mut self, val: Vec<crate::core::types::RampPoint>) -> Self {
        self.params.insert("coloracrosswidth".to_string(), crate::core::types::ParamValue::Ramp(val));
        self
    }
    pub fn with_coloracrosswidth_expr(mut self, expr: &str) -> Self {
        self.params.insert("coloracrosswidth".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl CopLayertogeo {
    ...
    pub fn with_optional(mut self, val: bool) -> Self {
        self.params.insert("optional".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_optional_expr(mut self, expr: &str) -> Self {
        self.params.insert("optional".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl CopLayertopoints {
    ...
    pub fn with_attrib_class_inst(mut self, index1: usize, val: CopLayertopointsAttribClass) -> Self {
    ...
    pub fn with_ignoreminusone(mut self, val: bool) -> Self {
        self.params.insert("ignoreminusone".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_ignoreminusone_expr(mut self, expr: &str) -> Self {
        self.params.insert("ignoreminusone".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl CopLensdistort {
    ...
    pub fn with_k1(mut self, val: f32) -> Self {
        self.params.insert("k1".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_k1_expr(mut self, expr: &str) -> Self {
        self.params.insert("k1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_k2(mut self, val: f32) -> Self {
        self.params.insert("k2".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_k2_expr(mut self, expr: &str) -> Self {
        self.params.insert("k2".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_k3(mut self, val: f32) -> Self {
        self.params.insert("k3".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_k3_expr(mut self, expr: &str) -> Self {
        self.params.insert("k3".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_k4(mut self, val: f32) -> Self {
        self.params.insert("k4".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_k4_expr(mut self, expr: &str) -> Self {
        self.params.insert("k4".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_k5(mut self, val: f32) -> Self {
        self.params.insert("k5".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_k5_expr(mut self, expr: &str) -> Self {
        self.params.insert("k5".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_k6(mut self, val: f32) -> Self {
        self.params.insert("k6".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_k6_expr(mut self, expr: &str) -> Self {
        self.params.insert("k6".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_p1(mut self, val: f32) -> Self {
        self.params.insert("p1".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    ...
    pub fn with_p2(mut self, val: f32) -> Self {
        self.params.insert("p2".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
...
impl CopLight {
    ...
    pub fn with_lightcolor_val(mut self, val: [f32; 3]) -> Self {
        self.params.insert("lightcolor_val".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_lightcolor_val_expr(mut self, expr: &str) -> Self {
        self.params.insert("lightcolor_val".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl CopLivevideo {
    ...
    pub fn with_config(mut self, val: &str) -> Self {
        self.params.insert("config".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_config_expr(mut self, expr: &str) -> Self {
        self.params.insert("config".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_enabled(mut self, val: bool) -> Self {
        self.params.insert("enabled".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enabled_expr(mut self, expr: &str) -> Self {
        self.params.insert("enabled".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
