...
impl CopQuantize {
    ...
    pub fn with_roundoffset(mut self, val: f32) -> Self {
        self.params.insert("roundoffset".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_roundoffset_expr(mut self, expr: &str) -> Self {
        self.params.insert("roundoffset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_clampbelow(mut self, val: bool) -> Self {
        self.params.insert("clampbelow".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_clampbelow_expr(mut self, expr: &str) -> Self {
        self.params.insert("clampbelow".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_clampabove(mut self, val: bool) -> Self {
        self.params.insert("clampabove".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_clampabove_expr(mut self, expr: &str) -> Self {
        self.params.insert("clampabove".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
