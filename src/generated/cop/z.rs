...
impl CopZcomp {
    ...
    pub fn with_fgoffset(mut self, val: f32) -> Self {
        self.params.insert("fgoffset".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_fgoffset_expr(mut self, expr: &str) -> Self {
        self.params.insert("fgoffset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
