...
impl CopWipe {
    ...
    pub fn with_direction(mut self, val: f32) -> Self {
        self.params.insert("direction".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    ...
    pub fn with_lwidth(mut self, val: f32) -> Self {
        self.params.insert("lwidth".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_lwidth_expr(mut self, expr: &str) -> Self {
        self.params.insert("lwidth".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_lcolor(mut self, val: [f32; 4]) -> Self {
        self.params.insert("lcolor".to_string(), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_lcolor_expr(mut self, expr: &str) -> Self {
        self.params.insert("lcolor".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl CopWorleynoise {
    ...
    pub fn with_lattice(mut self, val: CopWorleynoiseLattice) -> Self {
        self.params.insert("lattice".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_lattice_expr(mut self, expr: &str) -> Self {
        self.params.insert("lattice".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl CopWorleynoise3d {
    ...
    pub fn with_jitterscale(mut self, val: [f32; 3]) -> Self {
        self.params.insert("jitterscale".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_jitterscale_expr(mut self, expr: &str) -> Self {
        self.params.insert("jitterscale".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
...
impl CopWrangle {
    ...
    pub fn with_geoinput_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("geoinput{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_geoinput_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("geoinput{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vexsnippet(mut self, val: &str) -> Self {
        self.params.insert("vexsnippet".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vexsnippet_expr(mut self, expr: &str) -> Self {
        self.params.insert("vexsnippet".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vex_exportlist(mut self, val: &str) -> Self {
        self.params.insert("vex_exportlist".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vex_exportlist_expr(mut self, expr: &str) -> Self {
        self.params.insert("vex_exportlist".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
