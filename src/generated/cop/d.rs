...
impl CopDefocus {
    ...
    pub fn with_bokehradius(mut self, val: f32) -> Self {
        self.params.insert("bokehradius".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_bokehradius_expr(mut self, expr: &str) -> Self {
        self.params.insert("bokehradius".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_resample(mut self, val: f32) -> Self {
        self.params.insert("resample".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    ...
    pub fn with_brightradius(mut self, val: f32) -> Self {
        self.params.insert("brightradius".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_brightradius_expr(mut self, expr: &str) -> Self {
        self.params.insert("brightradius".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_satthreshold(mut self, val: f32) -> Self {
        self.params.insert("satthreshold".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_satthreshold_expr(mut self, expr: &str) -> Self {
        self.params.insert("satthreshold".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_saturationradius(mut self, val: f32) -> Self {
        self.params.insert("saturationradius".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_saturationradius_expr(mut self, expr: &str) -> Self {
        self.params.insert("saturationradius".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_remapmindepth(mut self, val: f32) -> Self {
        self.params.insert("remapmindepth".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_remapmindepth_expr(mut self, expr: &str) -> Self {
        self.params.insert("remapmindepth".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_remapmaxdepth(mut self, val: f32) -> Self {
        self.params.insert("remapmaxdepth".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_remapmaxdepth_expr(mut self, expr: &str) -> Self {
        self.params.insert("remapmaxdepth".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_focusramp(mut self, val: Vec<crate::core::types::RampPoint>) -> Self {
        self.params.insert("focusramp".to_string(), crate::core::types::ParamValue::Ramp(val));
        self
    }
    pub fn with_focusramp_expr(mut self, expr: &str) -> Self {
        self.params.insert("focusramp".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_docolorcorrect(mut self, val: bool) -> Self {
        self.params.insert("docolorcorrect".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_docolorcorrect_expr(mut self, expr: &str) -> Self {
        self.params.insert("docolorcorrect".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_dodepthblend(mut self, val: bool) -> Self {
        self.params.insert("dodepthblend".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_dodepthblend_expr(mut self, expr: &str) -> Self {
        self.params.insert("dodepthblend".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl CopDenoiseai {
    ...
    pub fn with_auxareclean(mut self, val: bool) -> Self {
        self.params.insert("auxareclean".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_auxareclean_expr(mut self, expr: &str) -> Self {
        self.params.insert("auxareclean".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_prefilteraux(mut self, val: bool) -> Self {
        self.params.insert("prefilteraux".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_prefilteraux_expr(mut self, expr: &str) -> Self {
        self.params.insert("prefilteraux".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_onlycpu(mut self, val: bool) -> Self {
        self.params.insert("onlycpu".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_onlycpu_expr(mut self, expr: &str) -> Self {
        self.params.insert("onlycpu".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl CopDerivative {
    ...
    pub fn with_differencemode(mut self, val: CopDerivativeDifferencemode) -> Self {
        self.params.insert("differencemode".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_differencemode_expr(mut self, expr: &str) -> Self {
        self.params.insert("differencemode".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl CopDilateerode {
    ...
    pub fn with_fill(mut self, val: bool) -> Self {
        self.params.insert("fill".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
...
impl CopDistort {
    ...
    pub fn with_streak(mut self, val: CopDistortStreak) -> Self {
        self.params.insert("streak".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_streak_expr(mut self, expr: &str) -> Self {
        self.params.insert("streak".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
