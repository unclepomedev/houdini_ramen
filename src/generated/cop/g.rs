...
impl CopGlow {
    ...
    pub fn with_gaintint(mut self, val: [f32; 3]) -> Self {
        self.params.insert("gaintint".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_gaintint_expr(mut self, expr: &str) -> Self {
        self.params.insert("gaintint".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_outputonlyglow(mut self, val: bool) -> Self {
        self.params.insert("outputonlyglow".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_outputonlyglow_expr(mut self, expr: &str) -> Self {
        self.params.insert("outputonlyglow".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl CopGrungeAurora {
    ...
    pub fn with_diststrength(mut self, val: f32) -> Self {
        self.params.insert("diststrength".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_diststrength_expr(mut self, expr: &str) -> Self {
        self.params.insert("diststrength".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_distsize(mut self, val: f32) -> Self {
        self.params.insert("distsize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_distsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("distsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl CopGrungeBirchbark {
    ...
    pub fn with_basecoverage(mut self, val: f32) -> Self {
        self.params.insert("basecoverage".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_basecoverage_expr(mut self, expr: &str) -> Self {
        self.params.insert("basecoverage".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_basesharpness(mut self, val: f32) -> Self {
        self.params.insert("basesharpness".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_basesharpness_expr(mut self, expr: &str) -> Self {
        self.params.insert("basesharpness".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_lenticels(mut self, val: f32) -> Self {
        self.params.insert("lenticels".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_lenticels_expr(mut self, expr: &str) -> Self {
        self.params.insert("lenticels".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_lenticelsize(mut self, val: f32) -> Self {
        self.params.insert("lenticelsize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_lenticelsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("lenticelsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cracks(mut self, val: f32) -> Self {
        self.params.insert("cracks".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cracks_expr(mut self, expr: &str) -> Self {
        self.params.insert("cracks".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cracksize(mut self, val: f32) -> Self {
        self.params.insert("cracksize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cracksize_expr(mut self, expr: &str) -> Self {
        self.params.insert("cracksize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_post_bias(mut self, val: f32) -> Self {
        self.params.insert("post_bias".to_string(), crate::core::types::ParamValue::Float(val));
...
impl CopGrungeLayerednoise {
    ...
    pub fn with_basenoise_amp(mut self, val: f32) -> Self {
        self.params.insert("basenoise_amp".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_basenoise_amp_expr(mut self, expr: &str) -> Self {
        self.params.insert("basenoise_amp".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_basenoise_elementsize(mut self, val: f32) -> Self {
        self.params.insert("basenoise_elementsize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_basenoise_elementsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("basenoise_elementsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_basecells_amp(mut self, val: f32) -> Self {
        self.params.insert("basecells_amp".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_basecells_amp_expr(mut self, expr: &str) -> Self {
        self.params.insert("basecells_amp".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_basecells_elementsize(mut self, val: f32) -> Self {
        self.params.insert("basecells_elementsize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_basecells_elementsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("basecells_elementsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_secnoise_amp(mut self, val: f32) -> Self {
        self.params.insert("secnoise_amp".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_secnoise_amp_expr(mut self, expr: &str) -> Self {
        self.params.insert("secnoise_amp".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_secnoise_center(mut self, val: f32) -> Self {
        self.params.insert("secnoise_center".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_secnoise_center_expr(mut self, expr: &str) -> Self {
        self.params.insert("secnoise_center".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_secnoise_elementsize(mut self, val: f32) -> Self {
        self.params.insert("secnoise_elementsize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_secnoise_elementsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("secnoise_elementsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_seccells_amp(mut self, val: f32) -> Self {
        self.params.insert("seccells_amp".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_seccells_amp_expr(mut self, expr: &str) -> Self {
        self.params.insert("seccells_amp".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_seccells_center(mut self, val: f32) -> Self {
        self.params.insert("seccells_center".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_seccells_center_expr(mut self, expr: &str) -> Self {
        self.params.insert("seccells_center".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_seccells_elementsize(mut self, val: f32) -> Self {
        self.params.insert("seccells_elementsize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_seccells_elementsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("seccells_elementsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_post_bias(mut self, val: f32) -> Self {
        self.params.insert("post_bias".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_basecells_enable(mut self, val: bool) -> Self {
        self.params.insert("basecells_enable".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_basecells_enable_expr(mut self, expr: &str) -> Self {
        self.params.insert("basecells_enable".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_basecells_complement(mut self, val: bool) -> Self {
        self.params.insert("basecells_complement".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_basecells_complement_expr(mut self, expr: &str) -> Self {
        self.params.insert("basecells_complement".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_secnoise_enable(mut self, val: bool) -> Self {
        self.params.insert("secnoise_enable".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_secnoise_enable_expr(mut self, expr: &str) -> Self {
        self.params.insert("secnoise_enable".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_secnoise_complement(mut self, val: bool) -> Self {
        self.params.insert("secnoise_complement".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_secnoise_complement_expr(mut self, expr: &str) -> Self {
        self.params.insert("secnoise_complement".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_seccells_enable(mut self, val: bool) -> Self {
        self.params.insert("seccells_enable".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_seccells_enable_expr(mut self, expr: &str) -> Self {
        self.params.insert("seccells_enable".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_seccells_complement(mut self, val: bool) -> Self {
        self.params.insert("seccells_complement".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_seccells_complement_expr(mut self, expr: &str) -> Self {
        self.params.insert("seccells_complement".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_post_dofold(mut self, val: bool) -> Self {
        self.params.insert("post_dofold".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl CopGrungePinebark {
    ...
    pub fn with_barkintensity(mut self, val: f32) -> Self {
        self.params.insert("barkintensity".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_barkintensity_expr(mut self, expr: &str) -> Self {
        self.params.insert("barkintensity".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_barksize(mut self, val: f32) -> Self {
        self.params.insert("barksize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_barksize_expr(mut self, expr: &str) -> Self {
        self.params.insert("barksize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_barkroughness(mut self, val: f32) -> Self {
        self.params.insert("barkroughness".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_barkroughness_expr(mut self, expr: &str) -> Self {
        self.params.insert("barkroughness".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_post_bias(mut self, val: f32) -> Self {
        self.params.insert("post_bias".to_string(), crate::core::types::ParamValue::Float(val));
...
impl CopGrungeRust {
    ...
    pub fn with_rust(mut self, val: f32) -> Self {
        self.params.insert("rust".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_rust_expr(mut self, expr: &str) -> Self {
        self.params.insert("rust".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rustsize(mut self, val: f32) -> Self {
        self.params.insert("rustsize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_rustsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("rustsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_post_bias(mut self, val: f32) -> Self {
        self.params.insert("post_bias".to_string(), crate::core::types::ParamValue::Float(val));
