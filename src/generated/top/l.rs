...
impl TopLocalscheduler {
    ...
    pub fn with_local_minfreemem(mut self, val: f32) -> Self {
        self.params.insert("local_minfreemem".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_local_minfreemem_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_minfreemem".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_minfreemempct(mut self, val: f32) -> Self {
        self.params.insert("local_minfreemempct".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_local_minfreemempct_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_minfreemempct".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_maxtime(mut self, val: f32) -> Self {
        self.params.insert("local_maxtime".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_local_maxtime_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_maxtime".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_maxmemory(mut self, val: f32) -> Self {
        self.params.insert("local_maxmemory".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_local_maxmemory_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_maxmemory".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_maxprocs(mut self, val: i32) -> Self {
        self.params.insert("maxprocs".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_maxprocs_expr(mut self, expr: &str) -> Self {
        self.params.insert("maxprocs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_socketcallbacks(mut self, val: i32) -> Self {
        self.params.insert("socketcallbacks".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_socketcallbacks_expr(mut self, expr: &str) -> Self {
        self.params.insert("socketcallbacks".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_local_cpus_to_use(mut self, val: i32) -> Self {
        self.params.insert("local_CPUs_to_use".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_local_cpus_to_use_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_CPUs_to_use".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_eccustomcode(mut self, val: i32) -> Self {
        self.params.insert("local_eccustomcode".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_local_eccustomcode_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_eccustomcode".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_maximumretries(mut self, val: i32) -> Self {
        self.params.insert("local_maximumretries".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_local_maximumretries_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_maximumretries".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_houdinimaxthreads(mut self, val: i32) -> Self {
        self.params.insert("local_houdinimaxthreads".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_local_houdinimaxthreads_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_houdinimaxthreads".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_maxprocsmenu(mut self, val: TopLocalschedulerMaxprocsmenu) -> Self {
        self.params.insert("maxprocsmenu".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_maxprocsmenu_expr(mut self, expr: &str) -> Self {
        self.params.insert("maxprocsmenu".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_pdg_workitemdatasource(mut self, val: TopLocalschedulerPdgWorkitemdatasource) -> Self {
    ...
    pub fn with_local_useminfreemem(mut self, val: TopLocalschedulerLocalUseminfreemem) -> Self {
        self.params.insert("local_useminfreemem".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_local_useminfreemem_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_useminfreemem".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_handletimeout(mut self, val: TopLocalschedulerLocalHandletimeout) -> Self {
        self.params.insert("local_handletimeout".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_local_handletimeout_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_handletimeout".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_handlememory(mut self, val: TopLocalschedulerLocalHandlememory) -> Self {
        self.params.insert("local_handlememory".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_local_handlememory_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_handlememory".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_echandleby(mut self, val: TopLocalschedulerLocalEchandleby) -> Self {
        self.params.insert("local_echandleby".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_local_echandleby_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_echandleby".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_logfilename(mut self, val: &str) -> Self {
        self.params.insert("logfilename".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_logfilename_expr(mut self, expr: &str) -> Self {
        self.params.insert("logfilename".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_local_failcountattr(mut self, val: &str) -> Self {
        self.params.insert("local_failcountattr".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_local_failcountattr_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_failcountattr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_envunset(mut self, val: &str) -> Self {
        self.params.insert("local_envunset".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_local_envunset_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_envunset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_env_file(mut self, val: &str) -> Self {
        self.params.insert("local_env_file".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_local_env_file_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_env_file".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_envname_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("local_envname{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_local_envname_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("local_envname{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_envvalue_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("local_envvalue{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_local_envvalue_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("local_envvalue{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_uselogfilename(mut self, val: bool) -> Self {
        self.params.insert("uselogfilename".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_uselogfilename_expr(mut self, expr: &str) -> Self {
        self.params.insert("uselogfilename".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_local_single(mut self, val: bool) -> Self {
        self.params.insert("local_single".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_local_single_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_single".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_is_cpu_number_set(mut self, val: bool) -> Self {
        self.params.insert("local_is_CPU_number_set".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_local_is_cpu_number_set_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_is_CPU_number_set".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_enabletimeout(mut self, val: bool) -> Self {
        self.params.insert("local_enabletimeout".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_local_enabletimeout_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_enabletimeout".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_enablemaxmemory(mut self, val: bool) -> Self {
        self.params.insert("local_enablemaxmemory".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_local_enablemaxmemory_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_enablemaxmemory".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_echandleall(mut self, val: bool) -> Self {
        self.params.insert("local_echandleall".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_local_echandleall_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_echandleall".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_addfailcountattr(mut self, val: bool) -> Self {
        self.params.insert("local_addfailcountattr".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_local_addfailcountattr_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_addfailcountattr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_usehoudinimaxthreads(mut self, val: bool) -> Self {
        self.params.insert("local_usehoudinimaxthreads".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_local_usehoudinimaxthreads_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_usehoudinimaxthreads".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_requireswindow(mut self, val: bool) -> Self {
        self.params.insert("local_requireswindow".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_local_requireswindow_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_requireswindow".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_local_skippackages(mut self, val: bool) -> Self {
        self.params.insert("local_skippackages".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_local_skippackages_expr(mut self, expr: &str) -> Self {
        self.params.insert("local_skippackages".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
