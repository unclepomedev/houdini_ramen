...
impl TopPartitionbyattribute {
    ...
    pub fn with_floatvalue_inst(mut self, index1: usize, val: f32) -> Self {
        self.params.insert(format!("floatvalue{}", index1), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_floatvalue_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("floatvalue{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float4 parameters ---
    pub fn with_floatvector_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("floatvector{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_floatvector_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("floatvector{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_intvalue_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("intvalue{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_intvalue_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("intvalue{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int4 parameters ---
    pub fn with_intvector_inst(mut self, index1: usize, val: [i32; 4]) -> Self {
        self.params.insert(format!("intvector{}", index1), crate::core::types::ParamValue::Int4(val));
        self
    }
    pub fn with_intvector_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("intvector{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbyattributePdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergeoperation_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("pdg_partitionmergeoperation{}", index1), crate::core::types::ParamValue::Menu(val));
        self
    }
    pub fn with_pdg_partitionmergeoperation_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("pdg_partitionmergeoperation{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbyattributePdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbyattributePdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionframe(mut self, val: TopPartitionbyattributePdgPartitionframe) -> Self {
        self.params.insert("pdg_partitionframe".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionframe_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionframe".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsort(mut self, val: TopPartitionbyattributePdgPartitionsort) -> Self {
        self.params.insert("pdg_partitionsort".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsort_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionsort".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbyattributePdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_stringvalue_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("stringvalue{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_stringvalue_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("stringvalue{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergepattern_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("pdg_partitionmergepattern{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pdg_partitionmergepattern_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("pdg_partitionmergepattern{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitiontarget(mut self, val: &str) -> Self {
        self.params.insert("pdg_partitiontarget".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pdg_partitiontarget_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitiontarget".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitattrib(mut self, val: &str) -> Self {
        self.params.insert("pdg_partitionsplitattrib".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionsplitattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitdefault(mut self, val: &str) -> Self {
        self.params.insert("pdg_partitionsplitdefault".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitdefault_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionsplitdefault".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsortattrib(mut self, val: &str) -> Self {
        self.params.insert("pdg_partitionsortattrib".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pdg_partitionsortattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionsortattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionidattrib(mut self, val: &str) -> Self {
        self.params.insert("pdg_partitionidattrib".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pdg_partitionidattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionidattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_independent(mut self, val: bool) -> Self {
        self.params.insert("independent".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_independent_expr(mut self, expr: &str) -> Self {
        self.params.insert("independent".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_createunmatched(mut self, val: bool) -> Self {
        self.params.insert("createunmatched".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_createunmatched_expr(mut self, expr: &str) -> Self {
        self.params.insert("createunmatched".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_enableindex_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("enableindex{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enableindex_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("enableindex{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmerge(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionmerge".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_partitionmerge_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionmerge".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergepreserve_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("pdg_partitionmergepreserve{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_partitionmergepreserve_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("pdg_partitionmergepreserve{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionignorefailures(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionignorefailures".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_partitionignorefailures_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionignorefailures".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplit(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionsplit".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_partitionsplit_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionsplit".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitpartial(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionsplitpartial".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_partitionsplitpartial_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionsplitpartial".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionstoreids(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionstoreids".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_partitionstoreids_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionstoreids".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl TopPartitionbybounds {
    ...
    pub fn set_input_bounding_input<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Bounding Input" and specifies the output index of the target node.
    pub fn set_input_bounding_input_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }

    /// Connects to input 1: "Source Input"
    pub fn set_input_source_input<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Source Input" and specifies the output index of the target node.
    pub fn set_input_source_input_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_bounds_time(mut self, val: f32) -> Self {
        self.params.insert("bounds_time".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_bounds_time_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_time".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_time(mut self, val: f32) -> Self {
        self.params.insert("src_time".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_src_time_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_time".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_boundstype(mut self, val: TopPartitionbyboundsBoundstype) -> Self {
        self.params.insert("boundstype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_boundstype_expr(mut self, expr: &str) -> Self {
        self.params.insert("boundstype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_boundsintersect(mut self, val: TopPartitionbyboundsBoundsintersect) -> Self {
        self.params.insert("boundsintersect".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_boundsintersect_expr(mut self, expr: &str) -> Self {
        self.params.insert("boundsintersect".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_boundselement(mut self, val: TopPartitionbyboundsBoundselement) -> Self {
        self.params.insert("boundselement".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_boundselement_expr(mut self, expr: &str) -> Self {
        self.params.insert("boundselement".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bounds_geometrysource(mut self, val: TopPartitionbyboundsBoundsGeometrysource) -> Self {
        self.params.insert("bounds_geometrysource".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_bounds_geometrysource_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_geometrysource".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_geometrysource(mut self, val: TopPartitionbyboundsSrcGeometrysource) -> Self {
        self.params.insert("src_geometrysource".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_src_geometrysource_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_geometrysource".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_preprocess(mut self, val: TopPartitionbyboundsSrcPreprocess) -> Self {
        self.params.insert("src_preprocess".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_src_preprocess_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_preprocess".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- String parameters ---
    pub fn with_bounds_soppath(mut self, val: &str) -> Self {
        self.params.insert("bounds_soppath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_bounds_soppath_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_soppath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bounds_filetag(mut self, val: &str) -> Self {
        self.params.insert("bounds_filetag".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_bounds_filetag_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_filetag".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bounds_filepath(mut self, val: &str) -> Self {
        self.params.insert("bounds_filepath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_bounds_filepath_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_filepath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bounds_upstreamattribute(mut self, val: &str) -> Self {
        self.params.insert("bounds_upstreamattribute".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_bounds_upstreamattribute_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_upstreamattribute".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_soppath(mut self, val: &str) -> Self {
        self.params.insert("src_soppath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_src_soppath_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_soppath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_filetag(mut self, val: &str) -> Self {
        self.params.insert("src_filetag".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_src_filetag_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_filetag".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_filepath(mut self, val: &str) -> Self {
        self.params.insert("src_filepath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_src_filepath_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_filepath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_upstreamattribute(mut self, val: &str) -> Self {
        self.params.insert("src_upstreamattribute".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_src_upstreamattribute_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_upstreamattribute".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_bounds_inputname(mut self, val: &str) -> Self {
        self.params.insert("bounds_inputname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_bounds_inputname_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_inputname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_inputname(mut self, val: &str) -> Self {
        self.params.insert("src_inputname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_src_inputname_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_inputname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_partitionsecondary(mut self, val: bool) -> Self {
        self.params.insert("partitionsecondary".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_partitionsecondary_expr(mut self, expr: &str) -> Self {
        self.params.insert("partitionsecondary".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_invertbounds(mut self, val: bool) -> Self {
        self.params.insert("invertbounds".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_invertbounds_expr(mut self, expr: &str) -> Self {
        self.params.insert("invertbounds".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_bounds_usetime(mut self, val: bool) -> Self {
        self.params.insert("bounds_usetime".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_bounds_usetime_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_usetime".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bounds_evaluateattributes(mut self, val: bool) -> Self {
        self.params.insert("bounds_evaluateattributes".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_bounds_evaluateattributes_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_evaluateattributes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bounds_asyncload(mut self, val: bool) -> Self {
        self.params.insert("bounds_asyncload".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_bounds_asyncload_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_asyncload".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bounds_mergeinput(mut self, val: bool) -> Self {
        self.params.insert("bounds_mergeinput".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_bounds_mergeinput_expr(mut self, expr: &str) -> Self {
        self.params.insert("bounds_mergeinput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_usetime(mut self, val: bool) -> Self {
        self.params.insert("src_usetime".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_src_usetime_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_usetime".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_evaluateattributes(mut self, val: bool) -> Self {
        self.params.insert("src_evaluateattributes".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_src_evaluateattributes_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_evaluateattributes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_asyncload(mut self, val: bool) -> Self {
        self.params.insert("src_asyncload".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_src_asyncload_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_asyncload".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_src_mergeinput(mut self, val: bool) -> Self {
        self.params.insert("src_mergeinput".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_src_mergeinput_expr(mut self, expr: &str) -> Self {
        self.params.insert("src_mergeinput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_overridedefault(mut self, val: bool) -> Self {
        self.params.insert("overridedefault".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_overridedefault_expr(mut self, expr: &str) -> Self {
        self.params.insert("overridedefault".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl TopPartitionbycombination {
    ...
    pub fn with_keeppercentage(mut self, val: f32) -> Self {
        self.params.insert("keeppercentage".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_keeppercentage_expr(mut self, expr: &str) -> Self {
        self.params.insert("keeppercentage".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_sortkey(mut self, val: i32) -> Self {
        self.params.insert("sortkey".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_sortkey_expr(mut self, expr: &str) -> Self {
        self.params.insert("sortkey".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_combinationsize(mut self, val: i32) -> Self {
        self.params.insert("combinationsize".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_combinationsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("combinationsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_keepseed(mut self, val: i32) -> Self {
        self.params.insert("keepseed".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_keepseed_expr(mut self, expr: &str) -> Self {
        self.params.insert("keepseed".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbycombinationPdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionwhen(mut self, val: TopPartitionbycombinationPdgPartitionwhen) -> Self {
        self.params.insert("pdg_partitionwhen".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionwhen_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbycombinationPdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbycombinationPdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionframe(mut self, val: TopPartitionbycombinationPdgPartitionframe) -> Self {
        self.params.insert("pdg_partitionframe".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionframe_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsort(mut self, val: TopPartitionbycombinationPdgPartitionsort) -> Self {
        self.params.insert("pdg_partitionsort".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsort_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbycombinationPdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_usesortkey(mut self, val: bool) -> Self {
        self.params.insert("usesortkey".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usesortkey_expr(mut self, expr: &str) -> Self {
        self.params.insert("usesortkey".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_usekeeppercentage(mut self, val: bool) -> Self {
        self.params.insert("usekeeppercentage".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usekeeppercentage_expr(mut self, expr: &str) -> Self {
        self.params.insert("usekeeppercentage".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmerge(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionmerge".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl TopPartitionbycomparison {
    ...
    pub fn set_input_primaryinput<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "primaryinput" and specifies the output index of the target node.
    pub fn set_input_primaryinput_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn set_input_comparison_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    // --- Menu parameters ---
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbycomparisonPdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbycomparisonPdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbycomparisonPdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionframe(mut self, val: TopPartitionbycomparisonPdgPartitionframe) -> Self {
        self.params.insert("pdg_partitionframe".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionframe_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbycomparisonPdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_comparepairname(mut self, val: &str) -> Self {
        self.params.insert("comparepairname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_comparepairname_expr(mut self, expr: &str) -> Self {
        self.params.insert("comparepairname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_resultname(mut self, val: &str) -> Self {
        self.params.insert("resultname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_resultname_expr(mut self, expr: &str) -> Self {
        self.params.insert("resultname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergepattern_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("pdg_partitionmergepattern{}", index1), crate::core::types::ParamValue::String(val.to_string()));
...
impl TopPartitionbyexpression {
    ...
    pub fn with_prefilter(mut self, val: i32) -> Self {
        self.params.insert("prefilter".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    ...
    pub fn with_partition(mut self, val: i32) -> Self {
        self.params.insert("partition".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_partition_expr(mut self, expr: &str) -> Self {
        self.params.insert("partition".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbyexpressionPdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbyexpressionPdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbyexpressionPdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionframe(mut self, val: TopPartitionbyexpressionPdgPartitionframe) -> Self {
        self.params.insert("pdg_partitionframe".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionframe_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbyexpressionPdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_useprefilter(mut self, val: bool) -> Self {
        self.params.insert("useprefilter".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useprefilter_expr(mut self, expr: &str) -> Self {
        self.params.insert("useprefilter".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmerge(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionmerge".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl TopPartitionbyframe {
    ...
    pub fn with_filterrange(mut self, val: [f32; 2]) -> Self {
        self.params.insert("filterrange".to_string(), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_filterrange_expr(mut self, expr: &str) -> Self {
        self.params.insert("filterrange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_createpartitionsfor(mut self, val: TopPartitionbyframeCreatepartitionsfor) -> Self {
        self.params.insert("createpartitionsfor".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_createpartitionsfor_expr(mut self, expr: &str) -> Self {
        self.params.insert("createpartitionsfor".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_framerounding(mut self, val: TopPartitionbyframeFramerounding) -> Self {
        self.params.insert("framerounding".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_framerounding_expr(mut self, expr: &str) -> Self {
        self.params.insert("framerounding".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_ignoremissing(mut self, val: TopPartitionbyframeIgnoremissing) -> Self {
        self.params.insert("ignoremissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_ignoremissing_expr(mut self, expr: &str) -> Self {
        self.params.insert("ignoremissing".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rangemissing(mut self, val: TopPartitionbyframeRangemissing) -> Self {
        self.params.insert("rangemissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_rangemissing_expr(mut self, expr: &str) -> Self {
        self.params.insert("rangemissing".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_filtertype(mut self, val: TopPartitionbyframeFiltertype) -> Self {
        self.params.insert("filtertype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_filtertype_expr(mut self, expr: &str) -> Self {
        self.params.insert("filtertype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbyframePdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_missingattribute(mut self, val: TopPartitionbyframeMissingattribute) -> Self {
        self.params.insert("missingattribute".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_missingattribute_expr(mut self, expr: &str) -> Self {
        self.params.insert("missingattribute".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbyframePdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbyframePdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbyframePdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_updaterange(mut self, val: &str) -> Self {
        self.params.insert("updaterange".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_filterpattern(mut self, val: &str) -> Self {
        self.params.insert("filterpattern".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_filterpattern_expr(mut self, expr: &str) -> Self {
        self.params.insert("filterpattern".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitattrib(mut self, val: &str) -> Self {
        self.params.insert("pdg_partitionsplitattrib".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_wedgeattribute(mut self, val: &str) -> Self {
        self.params.insert("wedgeattribute".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_wedgeattribute_expr(mut self, expr: &str) -> Self {
        self.params.insert("wedgeattribute".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitdefault(mut self, val: &str) -> Self {
        self.params.insert("pdg_partitionsplitdefault".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_useupdaterange(mut self, val: bool) -> Self {
        self.params.insert("useupdaterange".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useupdaterange_expr(mut self, expr: &str) -> Self {
        self.params.insert("useupdaterange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_indexfromframe(mut self, val: bool) -> Self {
        self.params.insert("indexfromframe".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_indexfromframe_expr(mut self, expr: &str) -> Self {
        self.params.insert("indexfromframe".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_isolate(mut self, val: bool) -> Self {
        self.params.insert("isolate".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_isolate_expr(mut self, expr: &str) -> Self {
        self.params.insert("isolate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_filterinclusive(mut self, val: bool) -> Self {
        self.params.insert("filterinclusive".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_filterinclusive_expr(mut self, expr: &str) -> Self {
        self.params.insert("filterinclusive".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplit(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionsplit".to_string(), crate::core::types::ParamValue::Toggle(val));
    ...
    pub fn with_usewedgeattribute(mut self, val: bool) -> Self {
        self.params.insert("usewedgeattribute".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usewedgeattribute_expr(mut self, expr: &str) -> Self {
        self.params.insert("usewedgeattribute".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionsplitpartial(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionsplitpartial".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl TopPartitionbyindex {
    ...
    pub fn with_primaryrule(mut self, val: TopPartitionbyindexPrimaryrule) -> Self {
        self.params.insert("primaryrule".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_primaryrule_expr(mut self, expr: &str) -> Self {
        self.params.insert("primaryrule".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_secondaryrule(mut self, val: TopPartitionbyindexSecondaryrule) -> Self {
        self.params.insert("secondaryrule".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_secondaryrule_expr(mut self, expr: &str) -> Self {
        self.params.insert("secondaryrule".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbyindexPdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbyindexPdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbyindexPdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbyindexPdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
...
impl TopPartitionbyiteration {
    ...
    pub fn with_includenumber(mut self, val: i32) -> Self {
        self.params.insert("includenumber".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_includenumber_expr(mut self, expr: &str) -> Self {
        self.params.insert("includenumber".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_externalitems(mut self, val: TopPartitionbyiterationExternalitems) -> Self {
        self.params.insert("externalitems".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_externalitems_expr(mut self, expr: &str) -> Self {
        self.params.insert("externalitems".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_previousiterations(mut self, val: TopPartitionbyiterationPreviousiterations) -> Self {
        self.params.insert("previousiterations".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_previousiterations_expr(mut self, expr: &str) -> Self {
        self.params.insert("previousiterations".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbyiterationPdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbyiterationPdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbyiterationPdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionframe(mut self, val: TopPartitionbyiterationPdgPartitionframe) -> Self {
        self.params.insert("pdg_partitionframe".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionframe_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbyiterationPdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
...
impl TopPartitionbynode {
    ...
    pub fn with_partitiontype(mut self, val: TopPartitionbynodePartitiontype) -> Self {
        self.params.insert("partitiontype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_partitiontype_expr(mut self, expr: &str) -> Self {
        self.params.insert("partitiontype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_sortnodes(mut self, val: TopPartitionbynodeSortnodes) -> Self {
        self.params.insert("sortnodes".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_sortnodes_expr(mut self, expr: &str) -> Self {
        self.params.insert("sortnodes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbynodePdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbynodePdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbynodePdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbynodePdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_partialpartitions(mut self, val: bool) -> Self {
        self.params.insert("partialpartitions".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_partialpartitions_expr(mut self, expr: &str) -> Self {
        self.params.insert("partialpartitions".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmerge(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionmerge".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl TopPartitionbyrange {
    ...
    pub fn with_rangecount(mut self, val: i32) -> Self {
        self.params.insert("rangecount".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_rangecount_expr(mut self, expr: &str) -> Self {
        self.params.insert("rangecount".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rangesize(mut self, val: i32) -> Self {
        self.params.insert("rangesize".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_rangesize_expr(mut self, expr: &str) -> Self {
        self.params.insert("rangesize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_upstreamrange(mut self, val: i32) -> Self {
        self.params.insert("upstreamrange".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_upstreamrange_expr(mut self, expr: &str) -> Self {
        self.params.insert("upstreamrange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_partitionrange(mut self, val: i32) -> Self {
        self.params.insert("partitionrange".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_partitionrange_expr(mut self, expr: &str) -> Self {
        self.params.insert("partitionrange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_leftoffset(mut self, val: i32) -> Self {
        self.params.insert("leftoffset".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_leftoffset_expr(mut self, expr: &str) -> Self {
        self.params.insert("leftoffset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rightoffset(mut self, val: i32) -> Self {
        self.params.insert("rightoffset".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_rightoffset_expr(mut self, expr: &str) -> Self {
        self.params.insert("rightoffset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_orderby(mut self, val: TopPartitionbyrangeOrderby) -> Self {
        self.params.insert("orderby".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_orderby_expr(mut self, expr: &str) -> Self {
        self.params.insert("orderby".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbyrangePdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbyrangePdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbyrangePdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbyrangePdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_customattribute(mut self, val: &str) -> Self {
        self.params.insert("customattribute".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_customattribute_expr(mut self, expr: &str) -> Self {
        self.params.insert("customattribute".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergepattern_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("pdg_partitionmergepattern{}", index1), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_resetindex(mut self, val: bool) -> Self {
        self.params.insert("resetindex".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_resetindex_expr(mut self, expr: &str) -> Self {
        self.params.insert("resetindex".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_consolidate(mut self, val: bool) -> Self {
        self.params.insert("consolidate".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_consolidate_expr(mut self, expr: &str) -> Self {
        self.params.insert("consolidate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmerge(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionmerge".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl TopPartitionbytile {
    ...
    pub fn with_ptradius(mut self, val: f32) -> Self {
        self.params.insert("ptradius".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_ptradius_expr(mut self, expr: &str) -> Self {
        self.params.insert("ptradius".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float3 parameters ---
    pub fn with_tileorigin(mut self, val: [f32; 3]) -> Self {
        self.params.insert("tileorigin".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_tileorigin_expr(mut self, expr: &str) -> Self {
        self.params.insert("tileorigin".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_totalsize(mut self, val: [f32; 3]) -> Self {
        self.params.insert("totalsize".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_totalsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("totalsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_tileindexorder(mut self, val: TopPartitionbytileTileindexorder) -> Self {
        self.params.insert("tileindexorder".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_tileindexorder_expr(mut self, expr: &str) -> Self {
        self.params.insert("tileindexorder".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_srcattrtype(mut self, val: TopPartitionbytileSrcattrtype) -> Self {
        self.params.insert("srcattrtype".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_srcattrtype_expr(mut self, expr: &str) -> Self {
        self.params.insert("srcattrtype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int3 parameters ---
    pub fn with_tilecount(mut self, val: [i32; 3]) -> Self {
        self.params.insert("tilecount".to_string(), crate::core::types::ParamValue::Int3(val));
        self
    }
    ...
    // --- Menu parameters ---
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPartitionbytilePdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPartitionbytilePdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPartitionbytilePdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPartitionbytilePdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_ptsattrname(mut self, val: &str) -> Self {
        self.params.insert("ptsattrname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_ptsattrname_expr(mut self, expr: &str) -> Self {
        self.params.insert("ptsattrname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_minattrname(mut self, val: &str) -> Self {
        self.params.insert("minattrname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_minattrname_expr(mut self, expr: &str) -> Self {
        self.params.insert("minattrname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_maxattrname(mut self, val: &str) -> Self {
        self.params.insert("maxattrname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_maxattrname_expr(mut self, expr: &str) -> Self {
        self.params.insert("maxattrname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmergepattern_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("pdg_partitionmergepattern{}", index1), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_connectedpts(mut self, val: bool) -> Self {
        self.params.insert("connectedpts".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_connectedpts_expr(mut self, expr: &str) -> Self {
        self.params.insert("connectedpts".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionmerge(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionmerge".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl TopPerforce {
    ...
    pub fn with_perforceop(mut self, val: TopPerforcePerforceop) -> Self {
        self.params.insert("perforceop".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_perforceop_expr(mut self, expr: &str) -> Self {
        self.params.insert("perforceop".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_opduring(mut self, val: TopPerforceOpduring) -> Self {
        self.params.insert("opduring".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_opduring_expr(mut self, expr: &str) -> Self {
        self.params.insert("opduring".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_sourcefiles(mut self, val: TopPerforceSourcefiles) -> Self {
        self.params.insert("sourcefiles".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_sourcefiles_expr(mut self, expr: &str) -> Self {
        self.params.insert("sourcefiles".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_filepattern(mut self, val: &str) -> Self {
        self.params.insert("filepattern".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_filepattern_expr(mut self, expr: &str) -> Self {
        self.params.insert("filepattern".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_changelistchoice(mut self, val: &str) -> Self {
        self.params.insert("changelistchoice".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_changelistchoice_expr(mut self, expr: &str) -> Self {
        self.params.insert("changelistchoice".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_changelistnum(mut self, val: &str) -> Self {
        self.params.insert("changelistnum".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_changelistnum_expr(mut self, expr: &str) -> Self {
        self.params.insert("changelistnum".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_changelistdescription(mut self, val: &str) -> Self {
        self.params.insert("changelistdescription".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_changelistdescription_expr(mut self, expr: &str) -> Self {
        self.params.insert("changelistdescription".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_p4configfile(mut self, val: &str) -> Self {
        self.params.insert("p4configfile".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_p4configfile_expr(mut self, expr: &str) -> Self {
        self.params.insert("p4configfile".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_perforcebin(mut self, val: &str) -> Self {
        self.params.insert("perforcebin".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_perforcebin_expr(mut self, expr: &str) -> Self {
        self.params.insert("perforcebin".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_emptychangelist(mut self, val: bool) -> Self {
        self.params.insert("emptychangelist".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_emptychangelist_expr(mut self, expr: &str) -> Self {
        self.params.insert("emptychangelist".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_updateall(mut self, val: bool) -> Self {
        self.params.insert("updateall".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_updateall_expr(mut self, expr: &str) -> Self {
        self.params.insert("updateall".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_forcesync(mut self, val: bool) -> Self {
        self.params.insert("forcesync".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_forcesync_expr(mut self, expr: &str) -> Self {
        self.params.insert("forcesync".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_overridebin(mut self, val: bool) -> Self {
        self.params.insert("overridebin".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_overridebin_expr(mut self, expr: &str) -> Self {
        self.params.insert("overridebin".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl TopPreflight {
    ...
    pub fn trigger_preflightscene(mut self) -> Self {
        self.params.insert("preflightscene".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    ...
    pub fn with_transferduring(mut self, val: TopPreflightTransferduring) -> Self {
        self.params.insert("transferduring".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_transferduring_expr(mut self, expr: &str) -> Self {
        self.params.insert("transferduring".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_filesource_inst(mut self, index1: usize, val: TopPreflightFilesource) -> Self {
        self.params.insert(format!("filesource{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_filesource_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("filesource{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_destination_inst(mut self, index1: usize, val: TopPreflightDestination) -> Self {
        self.params.insert(format!("destination{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_destination_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("destination{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_rootdirectory(mut self, val: &str) -> Self {
        self.params.insert("rootdirectory".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_rootdirectory_expr(mut self, expr: &str) -> Self {
        self.params.insert("rootdirectory".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_filetag_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("filetag{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_filetag_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("filetag{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_path_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("path{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_path_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("path{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_fileattrib_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("fileattrib{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_fileattrib_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("fileattrib{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_enabled_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("enabled{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enabled_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("enabled{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_preserveroot_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("preserveroot{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_preserveroot_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("preserveroot{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_useoutputattrib(mut self, val: bool) -> Self {
        self.params.insert("useoutputattrib".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useoutputattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("useoutputattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_outputfiles(mut self, val: bool) -> Self {
        self.params.insert("outputfiles".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_outputfiles_expr(mut self, expr: &str) -> Self {
        self.params.insert("outputfiles".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl TopPythonmapper {
    ...
    pub fn trigger_savenodescript(mut self) -> Self {
        self.params.insert("savenodescript".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_savenodehda(mut self) -> Self {
        self.params.insert("savenodehda".to_string(), crate::core::types::ParamValue::Button);
        self
    }

    // --- String parameters ---
    pub fn with_mapstatic(mut self, val: &str) -> Self {
        self.params.insert("mapstatic".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_mapstatic_expr(mut self, expr: &str) -> Self {
        self.params.insert("mapstatic".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mapdynamic(mut self, val: &str) -> Self {
        self.params.insert("mapdynamic".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_mapdynamic_expr(mut self, expr: &str) -> Self {
        self.params.insert("mapdynamic".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl TopPythonpartitioner {
    ...
    // --- Menu parameters ---
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopPythonpartitionerPdgPartitionmergeoutputs) -> Self {
        self.params.insert("pdg_partitionmergeoutputs".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionmergeoutputs_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopPythonpartitionerPdgPartitiontargettype) -> Self {
        self.params.insert("pdg_partitiontargettype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitiontargettype_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopPythonpartitionerPdgPartitionsplitmissing) -> Self {
        self.params.insert("pdg_partitionsplitmissing".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsplitmissing_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopPythonpartitionerPdgPartitionsortdirection) -> Self {
        self.params.insert("pdg_partitionsortdirection".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_partitionsortdirection_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_partition(mut self, val: &str) -> Self {
        self.params.insert("partition".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_partition_expr(mut self, expr: &str) -> Self {
        self.params.insert("partition".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
    ...
    pub fn with_pdg_partitionsortrequired(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionsortrequired".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_partitionsortrequired_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_partitionsortrequired".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_partitionstoreids(mut self, val: bool) -> Self {
        self.params.insert("pdg_partitionstoreids".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl TopPythonprocessor {
    ...
    pub fn with_statefilter(mut self, val: TopPythonprocessorStatefilter) -> Self {
        self.params.insert("statefilter".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_statefilter_expr(mut self, expr: &str) -> Self {
        self.params.insert("statefilter".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_addjobparms(mut self, val: i32) -> Self {
        self.params.insert("addjobparms".to_string(), crate::core::types::ParamValue::Menu(val));
    ...
    pub fn with_generate(mut self, val: &str) -> Self {
        self.params.insert("generate".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_generate_expr(mut self, expr: &str) -> Self {
        self.params.insert("generate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_regeneratestatic(mut self, val: &str) -> Self {
        self.params.insert("regeneratestatic".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_regeneratestatic_expr(mut self, expr: &str) -> Self {
        self.params.insert("regeneratestatic".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_addinternaldependencies(mut self, val: &str) -> Self {
        self.params.insert("addinternaldependencies".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_addinternaldependencies_expr(mut self, expr: &str) -> Self {
        self.params.insert("addinternaldependencies".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cooktask(mut self, val: &str) -> Self {
        self.params.insert("cooktask".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_cooktask_expr(mut self, expr: &str) -> Self {
        self.params.insert("cooktask".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_useregeneratestatic(mut self, val: bool) -> Self {
        self.params.insert("useregeneratestatic".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useregeneratestatic_expr(mut self, expr: &str) -> Self {
        self.params.insert("useregeneratestatic".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_alwaysregenerate(mut self, val: bool) -> Self {
        self.params.insert("alwaysregenerate".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_alwaysregenerate_expr(mut self, expr: &str) -> Self {
        self.params.insert("alwaysregenerate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_dirtyonregenerate(mut self, val: bool) -> Self {
        self.params.insert("dirtyonregenerate".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_dirtyonregenerate_expr(mut self, expr: &str) -> Self {
        self.params.insert("dirtyonregenerate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_dirtyonincomplete(mut self, val: bool) -> Self {
        self.params.insert("dirtyonincomplete".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_dirtyonincomplete_expr(mut self, expr: &str) -> Self {
        self.params.insert("dirtyonincomplete".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_requiresgeneratedinputs(mut self, val: bool) -> Self {
        self.params.insert("requiresgeneratedinputs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_requiresgeneratedinputs_expr(mut self, expr: &str) -> Self {
        self.params.insert("requiresgeneratedinputs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_requirescookedinputs(mut self, val: bool) -> Self {
        self.params.insert("requirescookedinputs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_requirescookedinputs_expr(mut self, expr: &str) -> Self {
        self.params.insert("requirescookedinputs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_requiresscenefile(mut self, val: bool) -> Self {
        self.params.insert("requiresscenefile".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_requiresscenefile_expr(mut self, expr: &str) -> Self {
        self.params.insert("requiresscenefile".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_requiresinputdata(mut self, val: bool) -> Self {
        self.params.insert("requiresinputdata".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_requiresinputdata_expr(mut self, expr: &str) -> Self {
        self.params.insert("requiresinputdata".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_usesdynamicbatching(mut self, val: bool) -> Self {
        self.params.insert("usesdynamicbatching".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usesdynamicbatching_expr(mut self, expr: &str) -> Self {
        self.params.insert("usesdynamicbatching".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_usestatefilter(mut self, val: bool) -> Self {
        self.params.insert("usestatefilter".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usestatefilter_expr(mut self, expr: &str) -> Self {
        self.params.insert("usestatefilter".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_clearfailures(mut self, val: bool) -> Self {
        self.params.insert("clearfailures".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_clearfailures_expr(mut self, expr: &str) -> Self {
        self.params.insert("clearfailures".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_useschedulewhen(mut self, val: bool) -> Self {
        self.params.insert("pdg_useschedulewhen".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl TopPythonscheduler {
    ...
    pub fn with_pdg_maxtasks(mut self, val: i32) -> Self {
        self.params.insert("pdg_maxtasks".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_pdg_maxtasks_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_maxtasks".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_pdg_workitemdatasource(mut self, val: TopPythonschedulerPdgWorkitemdatasource) -> Self {
        self.params.insert("pdg_workitemdatasource".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_workitemdatasource_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_workitemdatasource".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_deletetempdir(mut self, val: TopPythonschedulerPdgDeletetempdir) -> Self {
        self.params.insert("pdg_deletetempdir".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_deletetempdir_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_deletetempdir".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_transfertype(mut self, val: TopPythonschedulerPdgTransfertype) -> Self {
        self.params.insert("pdg_transfertype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pdg_transfertype_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_transfertype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- String parameters ---
    pub fn with_pdg_workingdir(mut self, val: &str) -> Self {
        self.params.insert("pdg_workingdir".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pdg_workingdir_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_workingdir".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_transferroot(mut self, val: &str) -> Self {
        self.params.insert("pdg_transferroot".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pdg_transferroot_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_transferroot".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_onschedule(mut self, val: &str) -> Self {
        self.params.insert("onschedule".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_onschedule_expr(mut self, expr: &str) -> Self {
        self.params.insert("onschedule".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_onschedulestatic(mut self, val: &str) -> Self {
        self.params.insert("onschedulestatic".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_onschedulestatic_expr(mut self, expr: &str) -> Self {
        self.params.insert("onschedulestatic".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_submitasjob(mut self, val: &str) -> Self {
        self.params.insert("submitasjob".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_submitasjob_expr(mut self, expr: &str) -> Self {
        self.params.insert("submitasjob".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_onstart(mut self, val: &str) -> Self {
        self.params.insert("onstart".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_onstart_expr(mut self, expr: &str) -> Self {
        self.params.insert("onstart".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_onstop(mut self, val: &str) -> Self {
        self.params.insert("onstop".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_onstop_expr(mut self, expr: &str) -> Self {
        self.params.insert("onstop".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_onstartcook(mut self, val: &str) -> Self {
        self.params.insert("onstartcook".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_onstartcook_expr(mut self, expr: &str) -> Self {
        self.params.insert("onstartcook".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_onstopcook(mut self, val: &str) -> Self {
        self.params.insert("onstopcook".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_onstopcook_expr(mut self, expr: &str) -> Self {
        self.params.insert("onstopcook".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_ontick(mut self, val: &str) -> Self {
        self.params.insert("ontick".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_ontick_expr(mut self, expr: &str) -> Self {
        self.params.insert("ontick".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_endsharedserver(mut self, val: &str) -> Self {
        self.params.insert("endsharedserver".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_endsharedserver_expr(mut self, expr: &str) -> Self {
        self.params.insert("endsharedserver".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_transferfile(mut self, val: &str) -> Self {
        self.params.insert("transferfile".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_transferfile_expr(mut self, expr: &str) -> Self {
        self.params.insert("transferfile".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_getloguri(mut self, val: &str) -> Self {
        self.params.insert("getloguri".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_getloguri_expr(mut self, expr: &str) -> Self {
        self.params.insert("getloguri".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_getstatusuri(mut self, val: &str) -> Self {
        self.params.insert("getstatusuri".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_getstatusuri_expr(mut self, expr: &str) -> Self {
        self.params.insert("getstatusuri".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_pdg_usemaxtasks(mut self, val: bool) -> Self {
        self.params.insert("pdg_usemaxtasks".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_usemaxtasks_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_usemaxtasks".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_compressworkitemdata(mut self, val: bool) -> Self {
        self.params.insert("pdg_compressworkitemdata".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_compressworkitemdata_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_compressworkitemdata".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_validateoutputs(mut self, val: bool) -> Self {
        self.params.insert("pdg_validateoutputs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_validateoutputs_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_validateoutputs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_checkexpectedoutputs(mut self, val: bool) -> Self {
        self.params.insert("pdg_checkexpectedoutputs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_checkexpectedoutputs_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_checkexpectedoutputs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_waitforfailures(mut self, val: bool) -> Self {
        self.params.insert("pdg_waitforfailures".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pdg_waitforfailures_expr(mut self, expr: &str) -> Self {
        self.params.insert("pdg_waitforfailures".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl TopPythonscript {
    ...
    pub fn with_batchframes(mut self, val: i32) -> Self {
        self.params.insert("batchframes".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_batchframes_expr(mut self, expr: &str) -> Self {
        self.params.insert("batchframes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_inprocess(mut self, val: TopPythonscriptInprocess) -> Self {
        self.params.insert("inprocess".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_inprocess_expr(mut self, expr: &str) -> Self {
        self.params.insert("inprocess".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_workitemgeneration(mut self, val: i32) -> Self {
        self.params.insert("pdg_workitemgeneration".to_string(), crate::core::types::ParamValue::Menu(val));
    ...
    pub fn with_pythonbin(mut self, val: TopPythonscriptPythonbin) -> Self {
        self.params.insert("pythonbin".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pythonbin_expr(mut self, expr: &str) -> Self {
        self.params.insert("pythonbin".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pathsource_inst(mut self, index1: usize, val: TopPythonscriptPathsource) -> Self {
        self.params.insert(format!("pathsource{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pathsource_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("pathsource{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_batchtype(mut self, val: TopPythonscriptBatchtype) -> Self {
        self.params.insert("batchtype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_batchtype_expr(mut self, expr: &str) -> Self {
        self.params.insert("batchtype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_scripttype(mut self, val: TopPythonscriptScripttype) -> Self {
        self.params.insert("scripttype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_scripttype_expr(mut self, expr: &str) -> Self {
        self.params.insert("scripttype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_batchactivation(mut self, val: TopPythonscriptBatchactivation) -> Self {
        self.params.insert("batchactivation".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_batchactivation_expr(mut self, expr: &str) -> Self {
        self.params.insert("batchactivation".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_scriptsource(mut self, val: TopPythonscriptScriptsource) -> Self {
        self.params.insert("scriptsource".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_scriptsource_expr(mut self, expr: &str) -> Self {
        self.params.insert("scriptsource".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_expectedoutputsfrom(mut self, val: TopPythonscriptExpectedoutputsfrom) -> Self {
        self.params.insert("expectedoutputsfrom".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_expectedoutputsfrom_expr(mut self, expr: &str) -> Self {
        self.params.insert("expectedoutputsfrom".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_addjobparms(mut self, val: i32) -> Self {
        self.params.insert("addjobparms".to_string(), crate::core::types::ParamValue::Menu(val));
    ...
    pub fn with_pythonvenv(mut self, val: &str) -> Self {
        self.params.insert("pythonvenv".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pythonvenv_expr(mut self, expr: &str) -> Self {
        self.params.insert("pythonvenv".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pythonargs(mut self, val: &str) -> Self {
        self.params.insert("pythonargs".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pythonargs_expr(mut self, expr: &str) -> Self {
        self.params.insert("pythonargs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_custompath_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("custompath{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_custompath_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("custompath{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_venvpath_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("venvpath{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_venvpath_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("venvpath{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_prescript(mut self, val: &str) -> Self {
        self.params.insert("prescript".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_prescript_expr(mut self, expr: &str) -> Self {
        self.params.insert("prescript".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_script(mut self, val: &str) -> Self {
        self.params.insert("script".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_script_expr(mut self, expr: &str) -> Self {
        self.params.insert("script".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_scriptfile(mut self, val: &str) -> Self {
        self.params.insert("scriptfile".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_scriptfile_expr(mut self, expr: &str) -> Self {
        self.params.insert("scriptfile".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_expectedoutputtag(mut self, val: &str) -> Self {
        self.params.insert("expectedoutputtag".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_expectedoutputtag_expr(mut self, expr: &str) -> Self {
        self.params.insert("expectedoutputtag".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_expectedoutputtag_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("expectedoutputtag{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_expectedoutputtag_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("expectedoutputtag{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_expectedscript(mut self, val: &str) -> Self {
        self.params.insert("expectedscript".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_expectedscript_expr(mut self, expr: &str) -> Self {
        self.params.insert("expectedscript".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_topscheduler(mut self, val: &str) -> Self {
        self.params.insert("topscheduler".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_resetpython(mut self, val: bool) -> Self {
        self.params.insert("resetpython".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_resetpython_expr(mut self, expr: &str) -> Self {
        self.params.insert("resetpython".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_nativeworkitem(mut self, val: bool) -> Self {
        self.params.insert("nativeworkitem".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_nativeworkitem_expr(mut self, expr: &str) -> Self {
        self.params.insert("nativeworkitem".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_usebatchframes(mut self, val: bool) -> Self {
        self.params.insert("usebatchframes".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usebatchframes_expr(mut self, expr: &str) -> Self {
        self.params.insert("usebatchframes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_expandscript(mut self, val: bool) -> Self {
        self.params.insert("expandscript".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_expandscript_expr(mut self, expr: &str) -> Self {
        self.params.insert("expandscript".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_expandstrings(mut self, val: bool) -> Self {
        self.params.insert("expandstrings".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_expandstrings_expr(mut self, expr: &str) -> Self {
        self.params.insert("expandstrings".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_useexpectedoutputtag(mut self, val: bool) -> Self {
        self.params.insert("useexpectedoutputtag".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useexpectedoutputtag_expr(mut self, expr: &str) -> Self {
        self.params.insert("useexpectedoutputtag".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_useexpectedoutputtag_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("useexpectedoutputtag{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useexpectedoutputtag_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("useexpectedoutputtag{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_useschedulewhen(mut self, val: bool) -> Self {
        self.params.insert("pdg_useschedulewhen".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl TopPythonserver {
    ...
    pub fn with_prototype(mut self, val: TopPythonserverPrototype) -> Self {
        self.params.insert("prototype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_prototype_expr(mut self, expr: &str) -> Self {
        self.params.insert("prototype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_addjobparms(mut self, val: i32) -> Self {
        self.params.insert("addjobparms".to_string(), crate::core::types::ParamValue::Menu(val));
    ...
    pub fn with_startupcmdline(mut self, val: &str) -> Self {
        self.params.insert("startupcmdline".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_startupcmdline_expr(mut self, expr: &str) -> Self {
        self.params.insert("startupcmdline".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_servicename(mut self, val: &str) -> Self {
        self.params.insert("pdg_servicename".to_string(), crate::core::types::ParamValue::String(val.to_string()));
...
impl TopPythonvenv {
    ...
    pub fn with_requirementdict(mut self, val: &str) -> Self {
        self.params.insert("requirementdict".to_string(), crate::core::types::ParamValue::Data(val.to_string()));
        self
    }
    pub fn with_requirementdict_expr(mut self, expr: &str) -> Self {
        self.params.insert("requirementdict".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_requirements(mut self, val: TopPythonvenvRequirements) -> Self {
        self.params.insert("requirements".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_requirements_expr(mut self, expr: &str) -> Self {
        self.params.insert("requirements".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_venvpath(mut self, val: &str) -> Self {
        self.params.insert("venvpath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_venvpath_expr(mut self, expr: &str) -> Self {
        self.params.insert("venvpath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_python(mut self, val: &str) -> Self {
        self.params.insert("python".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_requirementshfs(mut self, val: &str) -> Self {
        self.params.insert("requirementshfs".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_requirementshfs_expr(mut self, expr: &str) -> Self {
        self.params.insert("requirementshfs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_filetag(mut self, val: &str) -> Self {
        self.params.insert("filetag".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_customfile(mut self, val: &str) -> Self {
        self.params.insert("customfile".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_customfile_expr(mut self, expr: &str) -> Self {
        self.params.insert("customfile".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_filestring(mut self, val: &str) -> Self {
        self.params.insert("filestring".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_filestring_expr(mut self, expr: &str) -> Self {
        self.params.insert("filestring".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_requirementlist(mut self, val: &str) -> Self {
        self.params.insert("requirementlist".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_requirementlist_expr(mut self, expr: &str) -> Self {
        self.params.insert("requirementlist".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_topscheduler(mut self, val: &str) -> Self {
        self.params.insert("topscheduler".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_venvsymlink(mut self, val: bool) -> Self {
        self.params.insert("venvsymlink".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_venvsymlink_expr(mut self, expr: &str) -> Self {
        self.params.insert("venvsymlink".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_usepipcache(mut self, val: bool) -> Self {
        self.params.insert("usepipcache".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usepipcache_expr(mut self, expr: &str) -> Self {
        self.params.insert("usepipcache".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_venvlock(mut self, val: bool) -> Self {
        self.params.insert("venvlock".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_venvlock_expr(mut self, expr: &str) -> Self {
        self.params.insert("venvlock".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_userequirementshfs(mut self, val: bool) -> Self {
        self.params.insert("userequirementshfs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_userequirementshfs_expr(mut self, expr: &str) -> Self {
        self.params.insert("userequirementshfs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_venvoutput(mut self, val: bool) -> Self {
        self.params.insert("venvoutput".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_venvoutput_expr(mut self, expr: &str) -> Self {
        self.params.insert("venvoutput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_useschedulewhen(mut self, val: bool) -> Self {
        self.params.insert("pdg_useschedulewhen".to_string(), crate::core::types::ParamValue::Toggle(val));
