...
impl TopOpenimageio {
    ...
    pub fn with_argmodifiers_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("argmodifiers{}", index1), crate::core::types::ParamValue::Data(val.to_string()));
        self
    }
    pub fn with_argmodifiers_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("argmodifiers{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float parameters ---
    pub fn with_resizewidthpercent(mut self, val: f32) -> Self {
        self.params.insert("resizewidthpercent".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_resizewidthpercent_expr(mut self, expr: &str) -> Self {
        self.params.insert("resizewidthpercent".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_resizeheightpercent(mut self, val: f32) -> Self {
        self.params.insert("resizeheightpercent".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_resizeheightpercent_expr(mut self, expr: &str) -> Self {
        self.params.insert("resizeheightpercent".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float2 parameters ---
    pub fn with_textpospercent_inst(mut self, index1: usize, val: [f32; 2]) -> Self {
        self.params.insert(format!("textpospercent{}", index1), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_textpospercent_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("textpospercent{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_box1pospercent_inst(mut self, index1: usize, val: [f32; 2]) -> Self {
        self.params.insert(format!("box1pospercent{}", index1), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_box1pospercent_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("box1pospercent{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_box2pospercent_inst(mut self, index1: usize, val: [f32; 2]) -> Self {
        self.params.insert(format!("box2pospercent{}", index1), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_box2pospercent_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("box2pospercent{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_linepospercent_inst(mut self, index1: usize, index2: usize, val: [f32; 2]) -> Self {
        self.params.insert(format!("linepospercent{}_{}", index1, index2), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_linepospercent_inst_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("linepospercent{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pointpospercent_inst(mut self, index1: usize, index2: usize, val: [f32; 2]) -> Self {
        self.params.insert(format!("pointpospercent{}_{}", index1, index2), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_pointpospercent_inst_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("pointpospercent{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float4 parameters ---
    pub fn with_textcolor_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("textcolor{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_textcolor_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("textcolor{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_boxcolor_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("boxcolor{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_boxcolor_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("boxcolor{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_linecolor_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("linecolor{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_linecolor_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("linecolor{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pointcolor_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("pointcolor{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_pointcolor_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("pointcolor{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_resizewidthpixels(mut self, val: i32) -> Self {
        self.params.insert("resizewidthpixels".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_resizewidthpixels_expr(mut self, expr: &str) -> Self {
        self.params.insert("resizewidthpixels".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_resizeheightpixels(mut self, val: i32) -> Self {
        self.params.insert("resizeheightpixels".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_resizeheightpixels_expr(mut self, expr: &str) -> Self {
        self.params.insert("resizeheightpixels".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mosaicpadding(mut self, val: i32) -> Self {
        self.params.insert("mosaicpadding".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_mosaicpadding_expr(mut self, expr: &str) -> Self {
        self.params.insert("mosaicpadding".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_textsize_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("textsize{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_textsize_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("textsize{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_textshadowsize_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("textshadowsize{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_textshadowsize_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("textshadowsize{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_subimageindex_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("subimageindex{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_subimageindex_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("subimageindex{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_mosaicnumtiles(mut self, val: [i32; 2]) -> Self {
        self.params.insert("mosaicnumtiles".to_string(), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_mosaicnumtiles_expr(mut self, expr: &str) -> Self {
        self.params.insert("mosaicnumtiles".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mosaictilesize(mut self, val: [i32; 2]) -> Self {
        self.params.insert("mosaictilesize".to_string(), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_mosaictilesize_expr(mut self, expr: &str) -> Self {
        self.params.insert("mosaictilesize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_textpos_inst(mut self, index1: usize, val: [i32; 2]) -> Self {
        self.params.insert(format!("textpos{}", index1), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_textpos_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("textpos{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_box1pos_inst(mut self, index1: usize, val: [i32; 2]) -> Self {
        self.params.insert(format!("box1pos{}", index1), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_box1pos_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("box1pos{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_box2pos_inst(mut self, index1: usize, val: [i32; 2]) -> Self {
        self.params.insert(format!("box2pos{}", index1), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_box2pos_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("box2pos{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_linepos_inst(mut self, index1: usize, index2: usize, val: [i32; 2]) -> Self {
        self.params.insert(format!("linepos{}_{}", index1, index2), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_linepos_inst_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("linepos{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pointpos_inst(mut self, index1: usize, index2: usize, val: [i32; 2]) -> Self {
        self.params.insert(format!("pointpos{}_{}", index1, index2), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_pointpos_inst_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("pointpos{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_inputsort(mut self, val: TopOpenimageioInputsort) -> Self {
        self.params.insert("inputsort".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_inputsort_expr(mut self, expr: &str) -> Self {
        self.params.insert("inputsort".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_colorconfigfiletype(mut self, val: TopOpenimageioColorconfigfiletype) -> Self {
        self.params.insert("colorconfigfiletype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_colorconfigfiletype_expr(mut self, expr: &str) -> Self {
        self.params.insert("colorconfigfiletype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_resizetype(mut self, val: TopOpenimageioResizetype) -> Self {
        self.params.insert("resizetype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_resizetype_expr(mut self, expr: &str) -> Self {
        self.params.insert("resizetype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_suboperation_inst(mut self, index1: usize, val: TopOpenimageioSuboperation) -> Self {
        self.params.insert(format!("suboperation{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_suboperation_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("suboperation{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_textpostype_inst(mut self, index1: usize, val: TopOpenimageioTextpostype) -> Self {
        self.params.insert(format!("textpostype{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_textpostype_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("textpostype{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_textxalign_inst(mut self, index1: usize, val: TopOpenimageioTextxalign) -> Self {
        self.params.insert(format!("textxalign{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_textxalign_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("textxalign{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_textyalign_inst(mut self, index1: usize, val: TopOpenimageioTextyalign) -> Self {
        self.params.insert(format!("textyalign{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_textyalign_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("textyalign{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_boxpostype_inst(mut self, index1: usize, val: TopOpenimageioBoxpostype) -> Self {
        self.params.insert(format!("boxpostype{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_boxpostype_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("boxpostype{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_linepostype_inst(mut self, index1: usize, val: TopOpenimageioLinepostype) -> Self {
        self.params.insert(format!("linepostype{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_linepostype_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("linepostype{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pointpostype_inst(mut self, index1: usize, val: TopOpenimageioPointpostype) -> Self {
        self.params.insert(format!("pointpostype{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pointpostype_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("pointpostype{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_subimages(mut self, val: TopOpenimageioSubimages) -> Self {
        self.params.insert("subimages".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_subimages_expr(mut self, expr: &str) -> Self {
        self.params.insert("subimages".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_subimagereftype_inst(mut self, index1: usize, val: TopOpenimageioSubimagereftype) -> Self {
        self.params.insert(format!("subimagereftype{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_subimagereftype_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("subimagereftype{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_openimageiobinarytype(mut self, val: TopOpenimageioOpenimageiobinarytype) -> Self {
        self.params.insert("openimageiobinarytype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_openimageiobinarytype_expr(mut self, expr: &str) -> Self {
        self.params.insert("openimageiobinarytype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_inputcolorspace(mut self, val: &str) -> Self {
        self.params.insert("inputcolorspace".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_inputcolorspace_expr(mut self, expr: &str) -> Self {
        self.params.insert("inputcolorspace".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_outputcolorspace(mut self, val: &str) -> Self {
        self.params.insert("outputcolorspace".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_outputcolorspace_expr(mut self, expr: &str) -> Self {
        self.params.insert("outputcolorspace".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_customcolorconfig(mut self, val: &str) -> Self {
        self.params.insert("customcolorconfig".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_customcolorconfig_expr(mut self, expr: &str) -> Self {
        self.params.insert("customcolorconfig".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_colormapname(mut self, val: &str) -> Self {
        self.params.insert("colormapname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_colormapname_expr(mut self, expr: &str) -> Self {
        self.params.insert("colormapname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_textfontfile_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("textfontfile{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_textfontfile_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("textfontfile{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_text_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("text{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_text_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("text{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_lookname(mut self, val: &str) -> Self {
        self.params.insert("lookname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_lookname_expr(mut self, expr: &str) -> Self {
        self.params.insert("lookname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_viewname(mut self, val: &str) -> Self {
        self.params.insert("viewname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_viewname_expr(mut self, expr: &str) -> Self {
        self.params.insert("viewname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_customoperation(mut self, val: &str) -> Self {
        self.params.insert("customoperation".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_customoperation_expr(mut self, expr: &str) -> Self {
        self.params.insert("customoperation".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_subimagename_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("subimagename{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_subimagename_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("subimagename{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_argumentname_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("argumentname{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_argumentname_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("argumentname{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_customvalue_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("customvalue{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_customvalue_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("customvalue{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_customargs(mut self, val: &str) -> Self {
        self.params.insert("customargs".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_customargs_expr(mut self, expr: &str) -> Self {
        self.params.insert("customargs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_customopenimageiobinary(mut self, val: &str) -> Self {
        self.params.insert("customopenimageiobinary".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_customopenimageiobinary_expr(mut self, expr: &str) -> Self {
        self.params.insert("customopenimageiobinary".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_enablemosaictilesize(mut self, val: bool) -> Self {
        self.params.insert("enablemosaictilesize".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablemosaictilesize_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablemosaictilesize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enablemosaicpadding(mut self, val: bool) -> Self {
        self.params.insert("enablemosaicpadding".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablemosaicpadding_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablemosaicpadding".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enabletextfont_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("enabletextfont{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enabletextfont_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("enabletextfont{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_boxfilltoggle_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("boxfilltoggle{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_boxfilltoggle_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("boxfilltoggle{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enableociolook(mut self, val: bool) -> Self {
        self.params.insert("enableociolook".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enableociolook_expr(mut self, expr: &str) -> Self {
        self.params.insert("enableociolook".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enableociodisplay(mut self, val: bool) -> Self {
        self.params.insert("enableociodisplay".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enableociodisplay_expr(mut self, expr: &str) -> Self {
        self.params.insert("enableociodisplay".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enablemipmap(mut self, val: bool) -> Self {
        self.params.insert("enablemipmap".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablemipmap_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablemipmap".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enablecustomargs(mut self, val: bool) -> Self {
        self.params.insert("enablecustomargs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablecustomargs_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablecustomargs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl TopOpnotify {
    ...
    pub fn with_reloadtype(mut self, val: TopOpnotifyReloadtype) -> Self {
        self.params.insert("reloadtype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_reloadtype_expr(mut self, expr: &str) -> Self {
        self.params.insert("reloadtype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_buttonname(mut self, val: &str) -> Self {
        self.params.insert("buttonname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_buttonname_expr(mut self, expr: &str) -> Self {
        self.params.insert("buttonname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
