...
impl TopImagemagick {
    ...
    pub fn with_operation(mut self, val: TopImagemagickOperation) -> Self {
        self.params.insert("operation".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    ...
    pub fn with_ordermethod(mut self, val: TopImagemagickOrdermethod) -> Self {
        self.params.insert("ordermethod".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_ordermethod_expr(mut self, expr: &str) -> Self {
        self.params.insert("ordermethod".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_overlaymode(mut self, val: TopImagemagickOverlaymode) -> Self {
        self.params.insert("overlaymode".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_overlaymode_expr(mut self, expr: &str) -> Self {
        self.params.insert("overlaymode".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_montagecolumns(mut self, val: i32) -> Self {
        self.params.insert("montagecolumns".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_montagecolumns_expr(mut self, expr: &str) -> Self {
        self.params.insert("montagecolumns".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_montagerows(mut self, val: i32) -> Self {
        self.params.insert("montagerows".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_montagerows_expr(mut self, expr: &str) -> Self {
        self.params.insert("montagerows".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_imgquality(mut self, val: i32) -> Self {
        self.params.insert("imgquality".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_imgquality_expr(mut self, expr: &str) -> Self {
        self.params.insert("imgquality".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_argumentpos_inst(mut self, index1: usize, val: TopImagemagickArgumentpos) -> Self {
        self.params.insert(format!("argumentpos{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_argumentpos_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("argumentpos{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_imagemagickbinary(mut self, val: TopImagemagickImagemagickbinary) -> Self {
        self.params.insert("imagemagickbinary".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_imagemagickbinary_expr(mut self, expr: &str) -> Self {
        self.params.insert("imagemagickbinary".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_overlayexpr(mut self, val: &str) -> Self {
        self.params.insert("overlayexpr".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_overlayexpr_expr(mut self, expr: &str) -> Self {
        self.params.insert("overlayexpr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_overlayattribute(mut self, val: &str) -> Self {
        self.params.insert("overlayattribute".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_overlayattribute_expr(mut self, expr: &str) -> Self {
        self.params.insert("overlayattribute".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_convertfilename(mut self, val: &str) -> Self {
        self.params.insert("convertfilename".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_convertfilename_expr(mut self, expr: &str) -> Self {
        self.params.insert("convertfilename".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_compositeop(mut self, val: &str) -> Self {
        self.params.insert("compositeop".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_compositeop_expr(mut self, expr: &str) -> Self {
        self.params.insert("compositeop".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_background(mut self, val: &str) -> Self {
        self.params.insert("background".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_customcommand(mut self, val: &str) -> Self {
        self.params.insert("customcommand".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_customimagemagickbinary(mut self, val: &str) -> Self {
        self.params.insert("customimagemagickbinary".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_customimagemagickbinary_expr(mut self, expr: &str) -> Self {
        self.params.insert("customimagemagickbinary".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_customarguments(mut self, val: &str) -> Self {
        self.params.insert("customarguments".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_customarguments_expr(mut self, expr: &str) -> Self {
        self.params.insert("customarguments".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_imagemagickbin(mut self, val: &str) -> Self {
        self.params.insert("imagemagickbin".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_imagemagickbin_expr(mut self, expr: &str) -> Self {
        self.params.insert("imagemagickbin".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_imagetag(mut self, val: &str) -> Self {
        self.params.insert("imagetag".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_imagetag_expr(mut self, expr: &str) -> Self {
        self.params.insert("imagetag".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_enablemode(mut self, val: bool) -> Self {
        self.params.insert("enablemode".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablemode_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablemode".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_montagecolumnsswitch(mut self, val: bool) -> Self {
        self.params.insert("montagecolumnsswitch".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_montagecolumnsswitch_expr(mut self, expr: &str) -> Self {
        self.params.insert("montagecolumnsswitch".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_montagerowsswitch(mut self, val: bool) -> Self {
        self.params.insert("montagerowsswitch".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_montagerowsswitch_expr(mut self, expr: &str) -> Self {
        self.params.insert("montagerowsswitch".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_splitresults(mut self, val: bool) -> Self {
        self.params.insert("splitresults".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_splitresults_expr(mut self, expr: &str) -> Self {
        self.params.insert("splitresults".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enablebackground(mut self, val: bool) -> Self {
        self.params.insert("enablebackground".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablebackground_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablebackground".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_updateresolution(mut self, val: bool) -> Self {
        self.params.insert("updateresolution".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_updateresolution_expr(mut self, expr: &str) -> Self {
        self.params.insert("updateresolution".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_preservear(mut self, val: bool) -> Self {
        self.params.insert("preservear".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_preservear_expr(mut self, expr: &str) -> Self {
        self.params.insert("preservear".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enableimgquality(mut self, val: bool) -> Self {
        self.params.insert("enableimgquality".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enableimgquality_expr(mut self, expr: &str) -> Self {
        self.params.insert("enableimgquality".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_usecustomcommand(mut self, val: bool) -> Self {
        self.params.insert("usecustomcommand".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usecustomcommand_expr(mut self, expr: &str) -> Self {
        self.params.insert("usecustomcommand".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl TopInprocessscheduler {
    ...
    pub fn with_customcount(mut self, val: i32) -> Self {
        self.params.insert("customcount".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_customcount_expr(mut self, expr: &str) -> Self {
        self.params.insert("customcount".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_inprocess_maximumretries(mut self, val: i32) -> Self {
        self.params.insert("inprocess_maximumretries".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_inprocess_maximumretries_expr(mut self, expr: &str) -> Self {
        self.params.insert("inprocess_maximumretries".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_maxworkitems(mut self, val: TopInprocessschedulerMaxworkitems) -> Self {
        self.params.insert("maxworkitems".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_maxworkitems_expr(mut self, expr: &str) -> Self {
        self.params.insert("maxworkitems".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_inprocess_onfailure(mut self, val: TopInprocessschedulerInprocessOnfailure) -> Self {
        self.params.insert("inprocess_onfailure".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_inprocess_onfailure_expr(mut self, expr: &str) -> Self {
        self.params.insert("inprocess_onfailure".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_inprocess_failcountattr(mut self, val: &str) -> Self {
        self.params.insert("inprocess_failcountattr".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_inprocess_failcountattr_expr(mut self, expr: &str) -> Self {
        self.params.insert("inprocess_failcountattr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_inprocess_single(mut self, val: bool) -> Self {
        self.params.insert("inprocess_single".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_inprocess_single_expr(mut self, expr: &str) -> Self {
        self.params.insert("inprocess_single".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_inprocess_mainthread(mut self, val: bool) -> Self {
        self.params.insert("inprocess_mainthread".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_inprocess_mainthread_expr(mut self, expr: &str) -> Self {
        self.params.insert("inprocess_mainthread".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_inprocess_addfailcountattr(mut self, val: bool) -> Self {
        self.params.insert("inprocess_addfailcountattr".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_inprocess_addfailcountattr_expr(mut self, expr: &str) -> Self {
        self.params.insert("inprocess_addfailcountattr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl TopInvoke {
    ...
    pub fn with_geometrysource_inst(mut self, index1: usize, val: TopInvokeGeometrysource) -> Self {
        self.params.insert(format!("geometrysource{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_geometrysource_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("geometrysource{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_writeoutput(mut self, val: TopInvokeWriteoutput) -> Self {
        self.params.insert("writeoutput".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    ...
    pub fn with_expandpartitions(mut self, val: bool) -> Self {
        self.params.insert("expandpartitions".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_expandpartitions_expr(mut self, expr: &str) -> Self {
        self.params.insert("expandpartitions".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_loadduringcook(mut self, val: bool) -> Self {
        self.params.insert("loadduringcook".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_loadduringcook_expr(mut self, expr: &str) -> Self {
        self.params.insert("loadduringcook".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_useschedulewhen(mut self, val: bool) -> Self {
        self.params.insert("pdg_useschedulewhen".to_string(), crate::core::types::ParamValue::Toggle(val));
