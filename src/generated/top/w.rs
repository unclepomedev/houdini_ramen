...
impl TopWaitforall {
    ...
    // --- Menu parameters ---
    pub fn with_pdg_partitionmergeoutputs(mut self, val: TopWaitforallPdgPartitionmergeoutputs) -> Self {
    ...
    pub fn with_pdg_partitiontargettype(mut self, val: TopWaitforallPdgPartitiontargettype) -> Self {
    ...
    pub fn with_pdg_partitionsplitmissing(mut self, val: TopWaitforallPdgPartitionsplitmissing) -> Self {
    ...
    pub fn with_pdg_partitionsortdirection(mut self, val: TopWaitforallPdgPartitionsortdirection) -> Self {
...
impl TopWedge {
    ...
    pub fn trigger_captureall(mut self) -> Self {
        self.params.insert("captureall".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_restoreall(mut self) -> Self {
        self.params.insert("restoreall".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_channeljump_inst(mut self, index1: usize) -> Self {
        self.params.insert(format!("channeljump{}", index1), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_channelpicker_inst(mut self, index1: usize) -> Self {
        self.params.insert(format!("channelpicker{}", index1), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_capturenumeric_inst(mut self, index1: usize) -> Self {
        self.params.insert(format!("capturenumeric{}", index1), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_restorenumeric_inst(mut self, index1: usize) -> Self {
        self.params.insert(format!("restorenumeric{}", index1), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_capturestring_inst(mut self, index1: usize) -> Self {
        self.params.insert(format!("capturestring{}", index1), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_restorestring_inst(mut self, index1: usize) -> Self {
        self.params.insert(format!("restorestring{}", index1), crate::core::types::ParamValue::Button);
        self
    }
    ...
    pub fn with_floatvalue_inst_1(mut self, index1: usize, index2: usize, val: f32) -> Self {
        self.params.insert(format!("floatvalue{}_{}", index1, index2), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_floatvalue_inst_1_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("floatvalue{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float2 parameters ---
    pub fn with_floatrange_inst(mut self, index1: usize, val: [f32; 2]) -> Self {
        self.params.insert(format!("floatrange{}", index1), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_floatrange_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("floatrange{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_floatbracket_inst(mut self, index1: usize, val: [f32; 2]) -> Self {
        self.params.insert(format!("floatbracket{}", index1), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_floatbracket_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("floatbracket{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float4 parameters ---
    pub fn with_capturednumeric_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("capturednumeric{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_capturednumeric_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("capturednumeric{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_floatvectorvalue_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("floatvectorvalue{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_floatvectorvalue_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("floatvectorvalue{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_colorvalue_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("colorvalue{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_colorvalue_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("colorvalue{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_floatrangestart_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("floatrangestart{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_floatrangestart_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("floatrangestart{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_floatrangeend_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("floatrangeend{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_floatrangeend_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("floatrangeend{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_colorrangestart_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("colorrangestart{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_colorrangestart_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("colorrangestart{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_colorrangeend_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("colorrangeend{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_colorrangeend_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("colorrangeend{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_floatvectorcenter_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("floatvectorcenter{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_floatvectorcenter_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("floatvectorcenter{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_floatvectoroffset_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("floatvectoroffset{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_floatvectoroffset_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("floatvectoroffset{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_colorcenter_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("colorcenter{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_colorcenter_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("colorcenter{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_coloroffset_inst(mut self, index1: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("coloroffset{}", index1), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_coloroffset_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("coloroffset{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_floatvector_inst(mut self, index1: usize, index2: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("floatvector{}_{}", index1, index2), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_floatvector_inst_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("floatvector{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_colorvalue_inst_1(mut self, index1: usize, index2: usize, val: [f32; 4]) -> Self {
        self.params.insert(format!("colorvalue{}_{}", index1, index2), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_colorvalue_inst_1_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("colorvalue{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_wedgecount(mut self, val: i32) -> Self {
        self.params.insert("wedgecount".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_wedgecount_expr(mut self, expr: &str) -> Self {
        self.params.insert("wedgecount".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_intvalue_inst_1(mut self, index1: usize, index2: usize, val: i32) -> Self {
        self.params.insert(format!("intvalue{}_{}", index1, index2), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_intvalue_inst_1_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("intvalue{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int2 parameters ---
    pub fn with_intrange_inst(mut self, index1: usize, val: [i32; 2]) -> Self {
        self.params.insert(format!("intrange{}", index1), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_intrange_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("intrange{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_intbracket_inst(mut self, index1: usize, val: [i32; 2]) -> Self {
        self.params.insert(format!("intbracket{}", index1), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_intbracket_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("intbracket{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int4 parameters ---
    pub fn with_intvectorvalue_inst(mut self, index1: usize, val: [i32; 4]) -> Self {
        self.params.insert(format!("intvectorvalue{}", index1), crate::core::types::ParamValue::Int4(val));
        self
    }
    pub fn with_intvectorvalue_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("intvectorvalue{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_intrangestart_inst(mut self, index1: usize, val: [i32; 4]) -> Self {
        self.params.insert(format!("intrangestart{}", index1), crate::core::types::ParamValue::Int4(val));
        self
    }
    pub fn with_intrangestart_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("intrangestart{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_intrangeend_inst(mut self, index1: usize, val: [i32; 4]) -> Self {
        self.params.insert(format!("intrangeend{}", index1), crate::core::types::ParamValue::Int4(val));
        self
    }
    pub fn with_intrangeend_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("intrangeend{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_intvectorcenter_inst(mut self, index1: usize, val: [i32; 4]) -> Self {
        self.params.insert(format!("intvectorcenter{}", index1), crate::core::types::ParamValue::Int4(val));
        self
    }
    pub fn with_intvectorcenter_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("intvectorcenter{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_intvectoroffset_inst(mut self, index1: usize, val: [i32; 4]) -> Self {
        self.params.insert(format!("intvectoroffset{}", index1), crate::core::types::ParamValue::Int4(val));
        self
    }
    pub fn with_intvectoroffset_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("intvectoroffset{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_intvector_inst(mut self, index1: usize, index2: usize, val: [i32; 4]) -> Self {
        self.params.insert(format!("intvector{}_{}", index1, index2), crate::core::types::ParamValue::Int4(val));
        self
    }
    pub fn with_intvector_inst_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("intvector{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_workitemorder(mut self, val: TopWedgeWorkitemorder) -> Self {
        self.params.insert("workitemorder".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_workitemorder_expr(mut self, expr: &str) -> Self {
        self.params.insert("workitemorder".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_capturetype_inst(mut self, index1: usize, val: TopWedgeCapturetype) -> Self {
        self.params.insert(format!("capturetype{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_capturetype_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("capturetype{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_wedgetype_inst(mut self, index1: usize, val: TopWedgeWedgetype) -> Self {
        self.params.insert(format!("wedgetype{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_wedgetype_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("wedgetype{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- String parameters ---
    pub fn with_channel_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("channel{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_channel_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("channel{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_capturedstring_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("capturedstring{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_capturedstring_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("capturedstring{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_strvalue_inst(mut self, index1: usize, index2: usize, val: &str) -> Self {
        self.params.insert(format!("strvalue{}_{}", index1, index2), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_strvalue_inst_expr(mut self, index1: usize, index2: usize, expr: &str) -> Self {
        self.params.insert(format!("strvalue{}_{}", index1, index2), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_wedgecountattrname(mut self, val: &str) -> Self {
        self.params.insert("wedgecountattrname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_wedgecountattrname_expr(mut self, expr: &str) -> Self {
        self.params.insert("wedgecountattrname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_wedgeindexattrname(mut self, val: &str) -> Self {
        self.params.insert("wedgeindexattrname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_wedgeindexattrname_expr(mut self, expr: &str) -> Self {
        self.params.insert("wedgeindexattrname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_wedgenumattrname(mut self, val: &str) -> Self {
        self.params.insert("wedgenumattrname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_wedgenumattrname_expr(mut self, expr: &str) -> Self {
        self.params.insert("wedgenumattrname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_wedgetotalattrname(mut self, val: &str) -> Self {
        self.params.insert("wedgetotalattrname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_wedgetotalattrname_expr(mut self, expr: &str) -> Self {
        self.params.insert("wedgetotalattrname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_preservenum(mut self, val: bool) -> Self {
        self.params.insert("preservenum".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_preservenum_expr(mut self, expr: &str) -> Self {
        self.params.insert("preservenum".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_exportenvironment(mut self, val: bool) -> Self {
        self.params.insert("exportenvironment".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_exportenvironment_expr(mut self, expr: &str) -> Self {
        self.params.insert("exportenvironment".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_previewselection(mut self, val: bool) -> Self {
        self.params.insert("previewselection".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_previewselection_expr(mut self, expr: &str) -> Self {
        self.params.insert("previewselection".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_exportchannel_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("exportchannel{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_exportchannel_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("exportchannel{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_runcallbacks_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("runcallbacks{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_runcallbacks_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("runcallbacks{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_random_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("random{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_random_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("random{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_createwedgecount(mut self, val: bool) -> Self {
        self.params.insert("createwedgecount".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_createwedgecount_expr(mut self, expr: &str) -> Self {
        self.params.insert("createwedgecount".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_createwedgeindex(mut self, val: bool) -> Self {
        self.params.insert("createwedgeindex".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_createwedgeindex_expr(mut self, expr: &str) -> Self {
        self.params.insert("createwedgeindex".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_createwedgenum(mut self, val: bool) -> Self {
        self.params.insert("createwedgenum".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_createwedgenum_expr(mut self, expr: &str) -> Self {
        self.params.insert("createwedgenum".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_createwedgetotal(mut self, val: bool) -> Self {
        self.params.insert("createwedgetotal".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_createwedgetotal_expr(mut self, expr: &str) -> Self {
        self.params.insert("createwedgetotal".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl TopWorkitemexpand {
    ...
    pub fn with_framestart(mut self, val: [f32; 2]) -> Self {
        self.params.insert("framestart".to_string(), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_framestart_expr(mut self, expr: &str) -> Self {
        self.params.insert("framestart".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_value(mut self, val: i32) -> Self {
        self.params.insert("value".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    ...
    pub fn with_expand(mut self, val: TopWorkitemexpandExpand) -> Self {
        self.params.insert("expand".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    ...
    pub fn with_expansiontype(mut self, val: TopWorkitemexpandExpansiontype) -> Self {
        self.params.insert("expansiontype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_expansiontype_expr(mut self, expr: &str) -> Self {
        self.params.insert("expansiontype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- String parameters ---
    pub fn with_expandattrib(mut self, val: &str) -> Self {
        self.params.insert("expandattrib".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_expandattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("expandattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_expandvalue(mut self, val: &str) -> Self {
        self.params.insert("expandvalue".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_expandvalue_expr(mut self, expr: &str) -> Self {
        self.params.insert("expandvalue".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_expandworkitems(mut self, val: bool) -> Self {
        self.params.insert("expandworkitems".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_expandworkitems_expr(mut self, expr: &str) -> Self {
        self.params.insert("expandworkitems".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_includeexpected(mut self, val: bool) -> Self {
        self.params.insert("includeexpected".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_includeexpected_expr(mut self, expr: &str) -> Self {
        self.params.insert("includeexpected".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_setframe(mut self, val: bool) -> Self {
        self.params.insert("setframe".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_setframe_expr(mut self, expr: &str) -> Self {
        self.params.insert("setframe".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl TopWorkitemimport {
    ...
    // --- Menu parameters ---
    pub fn with_pdg_workitemgeneration(mut self, val: TopWorkitemimportPdgWorkitemgeneration) -> Self {
    ...
    pub fn with_topdirty(mut self, val: TopWorkitemimportTopdirty) -> Self {
        self.params.insert("topdirty".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_topdirty_expr(mut self, expr: &str) -> Self {
        self.params.insert("topdirty".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_importcollision(mut self, val: TopWorkitemimportImportcollision) -> Self {
        self.params.insert("importcollision".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_importcollision_expr(mut self, expr: &str) -> Self {
        self.params.insert("importcollision".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_dictattrib(mut self, val: &str) -> Self {
        self.params.insert("dictattrib".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_dictattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("dictattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_topgenerate(mut self, val: bool) -> Self {
        self.params.insert("topgenerate".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_topgenerate_expr(mut self, expr: &str) -> Self {
        self.params.insert("topgenerate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_topattribs(mut self, val: bool) -> Self {
        self.params.insert("topattribs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_topattribs_expr(mut self, expr: &str) -> Self {
        self.params.insert("topattribs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_importdatatype(mut self, val: bool) -> Self {
        self.params.insert("importdatatype".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_importdatatype_expr(mut self, expr: &str) -> Self {
        self.params.insert("importdatatype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_importattribs(mut self, val: bool) -> Self {
        self.params.insert("importattribs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_importattribs_expr(mut self, expr: &str) -> Self {
        self.params.insert("importattribs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
