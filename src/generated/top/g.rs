...
impl TopGenericgenerator {
    ...
    pub fn with_itemcount(mut self, val: i32) -> Self {
        self.params.insert("itemcount".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_itemcount_expr(mut self, expr: &str) -> Self {
        self.params.insert("itemcount".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_usedelay(mut self, val: TopGenericgeneratorUsedelay) -> Self {
        self.params.insert("usedelay".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_usedelay_expr(mut self, expr: &str) -> Self {
        self.params.insert("usedelay".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_collapsearray_inst(mut self, index1: usize, val: TopGenericgeneratorCollapsearray) -> Self {
        self.params.insert(format!("collapsearray{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_collapsearray_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("collapsearray{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_pdg_workitempriority(mut self, val: TopGenericgeneratorPdgWorkitempriority) -> Self {
    ...
    pub fn with_linuxcommand(mut self, val: &str) -> Self {
        self.params.insert("linuxcommand".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_linuxcommand_expr(mut self, expr: &str) -> Self {
        self.params.insert("linuxcommand".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_maccommand(mut self, val: &str) -> Self {
        self.params.insert("maccommand".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_maccommand_expr(mut self, expr: &str) -> Self {
        self.params.insert("maccommand".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_windowscommand(mut self, val: &str) -> Self {
        self.params.insert("windowscommand".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_windowscommand_expr(mut self, expr: &str) -> Self {
        self.params.insert("windowscommand".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_basecommand(mut self, val: &str) -> Self {
        self.params.insert("basecommand".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_basecommand_expr(mut self, expr: &str) -> Self {
        self.params.insert("basecommand".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_inputtag_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("inputtag{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_inputtag_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("inputtag{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_argumentjoin_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("argumentjoin{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_argumentjoin_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("argumentjoin{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_platformcommand(mut self, val: bool) -> Self {
        self.params.insert("platformcommand".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_platformcommand_expr(mut self, expr: &str) -> Self {
        self.params.insert("platformcommand".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_shellcommand(mut self, val: bool) -> Self {
        self.params.insert("shellcommand".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_shellcommand_expr(mut self, expr: &str) -> Self {
        self.params.insert("shellcommand".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_argumentenable_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("argumentenable{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_argumentenable_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("argumentenable{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_writeoutput_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("writeoutput{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_writeoutput_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("writeoutput{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_ownoutput_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("ownoutput{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_ownoutput_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("ownoutput{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_useoutputtag_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("useoutputtag{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useoutputtag_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("useoutputtag{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for TopGenericgenerator {
...
impl TopGeometryimport {
    ...
    pub fn with_emptygeometry(mut self, val: TopGeometryimportEmptygeometry) -> Self {
        self.params.insert("emptygeometry".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_emptygeometry_expr(mut self, expr: &str) -> Self {
        self.params.insert("emptygeometry".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mergeinput(mut self, val: TopGeometryimportMergeinput) -> Self {
        self.params.insert("mergeinput".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_mergeinput_expr(mut self, expr: &str) -> Self {
        self.params.insert("mergeinput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mergeclass(mut self, val: TopGeometryimportMergeclass) -> Self {
        self.params.insert("mergeclass".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_mergeclass_expr(mut self, expr: &str) -> Self {
        self.params.insert("mergeclass".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mergeattribtype(mut self, val: TopGeometryimportMergeattribtype) -> Self {
        self.params.insert("mergeattribtype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_mergeattribtype_expr(mut self, expr: &str) -> Self {
        self.params.insert("mergeattribtype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_upstreamattribute(mut self, val: &str) -> Self {
        self.params.insert("upstreamattribute".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_upstreamattribute_expr(mut self, expr: &str) -> Self {
        self.params.insert("upstreamattribute".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mergeattribname(mut self, val: &str) -> Self {
        self.params.insert("mergeattribname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_mergeattribname_expr(mut self, expr: &str) -> Self {
        self.params.insert("mergeattribname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_externalpath(mut self, val: &str) -> Self {
        self.params.insert("externalpath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_externalpath_expr(mut self, expr: &str) -> Self {
        self.params.insert("externalpath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_externaltag(mut self, val: &str) -> Self {
        self.params.insert("externaltag".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_externaltag_expr(mut self, expr: &str) -> Self {
        self.params.insert("externaltag".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_attributes(mut self, val: &str) -> Self {
        self.params.insert("attributes".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_attributes_expr(mut self, expr: &str) -> Self {
        self.params.insert("attributes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_workitemattributes(mut self, val: &str) -> Self {
        self.params.insert("workitemattributes".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_workitemattributes_expr(mut self, expr: &str) -> Self {
        self.params.insert("workitemattributes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_topscheduler(mut self, val: &str) -> Self {
        self.params.insert("topscheduler".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_asyncload(mut self, val: bool) -> Self {
        self.params.insert("asyncload".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_asyncload_expr(mut self, expr: &str) -> Self {
        self.params.insert("asyncload".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mergeexpandpartition(mut self, val: bool) -> Self {
        self.params.insert("mergeexpandpartition".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_mergeexpandpartition_expr(mut self, expr: &str) -> Self {
        self.params.insert("mergeexpandpartition".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_copyattributes(mut self, val: bool) -> Self {
        self.params.insert("copyattributes".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_copyattributes_expr(mut self, expr: &str) -> Self {
        self.params.insert("copyattributes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_copybbox(mut self, val: bool) -> Self {
        self.params.insert("copybbox".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_copybbox_expr(mut self, expr: &str) -> Self {
        self.params.insert("copybbox".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_primpoints(mut self, val: bool) -> Self {
        self.params.insert("primpoints".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_primpoints_expr(mut self, expr: &str) -> Self {
        self.params.insert("primpoints".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_addworkitemattributes(mut self, val: bool) -> Self {
        self.params.insert("addworkitemattributes".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_addworkitemattributes_expr(mut self, expr: &str) -> Self {
        self.params.insert("addworkitemattributes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pdg_useschedulewhen(mut self, val: bool) -> Self {
        self.params.insert("pdg_useschedulewhen".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl crate::core::types::HoudiniNode for TopGeometryimport {
    fn get_id(&self) -> usize {
        self.id
    }
