...
impl ShopToonshading {
    ...
    pub fn with_albedo(mut self, val: [f32; 3]) -> Self {
        self.params.insert("albedo".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    ...
    pub fn with_directdiffuse(mut self, val: [f32; 3]) -> Self {
        self.params.insert("directdiffuse".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    ...
    pub fn with_indirectdiffuse(mut self, val: [f32; 3]) -> Self {
        self.params.insert("indirectdiffuse".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    ...
    pub fn with_sss(mut self, val: [f32; 3]) -> Self {
        self.params.insert("sss".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    ...
    pub fn with_reflecteddirectdiffuse(mut self, val: [f32; 3]) -> Self {
        self.params.insert("reflecteddirectdiffuse".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_reflecteddirectdiffuse_expr(mut self, expr: &str) -> Self {
        self.params.insert("reflecteddirectdiffuse".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_reflectedalbedodiffuse(mut self, val: [f32; 3]) -> Self {
        self.params.insert("reflectedalbedodiffuse".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_reflectedalbedodiffuse_expr(mut self, expr: &str) -> Self {
        self.params.insert("reflectedalbedodiffuse".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_reflectedglossy(mut self, val: [f32; 3]) -> Self {
        self.params.insert("reflectedglossy".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_reflectedglossy_expr(mut self, expr: &str) -> Self {
        self.params.insert("reflectedglossy".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_reflectedcoat(mut self, val: [f32; 3]) -> Self {
        self.params.insert("reflectedcoat".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_reflectedcoat_expr(mut self, expr: &str) -> Self {
        self.params.insert("reflectedcoat".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_transmittedglossydiffuse(mut self, val: [f32; 3]) -> Self {
        self.params.insert("transmittedglossydiffuse".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_transmittedglossydiffuse_expr(mut self, expr: &str) -> Self {
        self.params.insert("transmittedglossydiffuse".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_toon_diffuse(mut self, val: [f32; 3]) -> Self {
        self.params.insert("toon_diffuse".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_toon_diffuse_expr(mut self, expr: &str) -> Self {
        self.params.insert("toon_diffuse".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_toon_glossy(mut self, val: [f32; 3]) -> Self {
        self.params.insert("toon_glossy".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_toon_glossy_expr(mut self, expr: &str) -> Self {
        self.params.insert("toon_glossy".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_toon_coat(mut self, val: [f32; 3]) -> Self {
        self.params.insert("toon_coat".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_toon_coat_expr(mut self, expr: &str) -> Self {
        self.params.insert("toon_coat".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float4 parameters ---
    pub fn with_outline(mut self, val: [f32; 4]) -> Self {
        self.params.insert("outline".to_string(), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_outline_expr(mut self, expr: &str) -> Self {
        self.params.insert("outline".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_c(mut self, val: [f32; 4]) -> Self {
        self.params.insert("C".to_string(), crate::core::types::ParamValue::Float4(val));
        self
    }
    ...
    pub fn with_toon_outline(mut self, val: [f32; 4]) -> Self {
        self.params.insert("toon_outline".to_string(), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_toon_outline_expr(mut self, expr: &str) -> Self {
        self.params.insert("toon_outline".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_outline_glossy(mut self, val: i32) -> Self {
        self.params.insert("outline_glossy".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    ...
    pub fn with_apply_albedo(mut self, val: i32) -> Self {
        self.params.insert("apply_albedo".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
