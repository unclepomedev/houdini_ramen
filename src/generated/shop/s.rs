...
impl ShopScalarvolumenoise {
    ...
    pub fn with_turbulence_freq(mut self, val: f32) -> Self {
        self.params.insert("turbulence_freq".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_turbulence_freq_expr(mut self, expr: &str) -> Self {
        self.params.insert("turbulence_freq".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_cell_sharpness(mut self, val: f32) -> Self {
        self.params.insert("cell_sharpness".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cell_sharpness_expr(mut self, expr: &str) -> Self {
        self.params.insert("cell_sharpness".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cell_influence(mut self, val: f32) -> Self {
        self.params.insert("cell_influence".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cell_influence_expr(mut self, expr: &str) -> Self {
        self.params.insert("cell_influence".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_voronoi_noise_seed(mut self, val: f32) -> Self {
        self.params.insert("voronoi_noise_seed".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_voronoi_noise_seed_expr(mut self, expr: &str) -> Self {
        self.params.insert("voronoi_noise_seed".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cell_frequency(mut self, val: f32) -> Self {
        self.params.insert("cell_frequency".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cell_frequency_expr(mut self, expr: &str) -> Self {
        self.params.insert("cell_frequency".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cell_distance(mut self, val: f32) -> Self {
        self.params.insert("cell_distance".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cell_distance_expr(mut self, expr: &str) -> Self {
        self.params.insert("cell_distance".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Float3 parameters ---
    pub fn with_turbulence_scale(mut self, val: [f32; 3]) -> Self {
        self.params.insert("turbulence_scale".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_turbulence_scale_expr(mut self, expr: &str) -> Self {
        self.params.insert("turbulence_scale".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_use_rest(mut self, val: bool) -> Self {
        self.params.insert("use_rest".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_use_rest_expr(mut self, expr: &str) -> Self {
        self.params.insert("use_rest".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_additive(mut self, val: bool) -> Self {
        self.params.insert("additive".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_additive_expr(mut self, expr: &str) -> Self {
        self.params.insert("additive".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enable_cells(mut self, val: bool) -> Self {
        self.params.insert("enable_cells".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enable_cells_expr(mut self, expr: &str) -> Self {
        self.params.insert("enable_cells".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_change_on_noise(mut self, val: bool) -> Self {
        self.params.insert("change_on_noise".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_change_on_noise_expr(mut self, expr: &str) -> Self {
        self.params.insert("change_on_noise".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_additive_cells(mut self, val: bool) -> Self {
        self.params.insert("additive_cells".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_additive_cells_expr(mut self, expr: &str) -> Self {
        self.params.insert("additive_cells".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_clampoutput(mut self, val: bool) -> Self {
        self.params.insert("clampoutput".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_clampoutput_expr(mut self, expr: &str) -> Self {
        self.params.insert("clampoutput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl ShopSelect {
    ...
    pub fn with_activate1(mut self, val: i32) -> Self {
        self.params.insert("activate1".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_activate1_expr(mut self, expr: &str) -> Self {
        self.params.insert("activate1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_activate2(mut self, val: i32) -> Self {
        self.params.insert("activate2".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_activate2_expr(mut self, expr: &str) -> Self {
        self.params.insert("activate2".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_activate3(mut self, val: i32) -> Self {
        self.params.insert("activate3".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_activate3_expr(mut self, expr: &str) -> Self {
        self.params.insert("activate3".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_activate4(mut self, val: i32) -> Self {
        self.params.insert("activate4".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_activate4_expr(mut self, expr: &str) -> Self {
        self.params.insert("activate4".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
