...
impl ShopDiffuseEval {
    ...
    pub fn with_translucent(mut self, val: i32) -> Self {
        self.params.insert("translucent".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_translucent_expr(mut self, expr: &str) -> Self {
        self.params.insert("translucent".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
