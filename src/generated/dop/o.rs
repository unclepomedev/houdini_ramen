...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum DopObjnetUparmtype {
    Uniform = 0,
    ArcLength = 1,
}

#[derive(Debug, Clone)]
pub struct DopObjnet {
    pub id: usize,
    pub name: String,
...
impl DopObjnet {
    ...
    // --- Menu parameters ---
    pub fn with_xord(mut self, val: DopObjnetXord) -> Self {
    ...
    pub fn with_rord(mut self, val: DopObjnetRord) -> Self {
    ...
    pub fn with_pre_xform(mut self, val: DopObjnetPreXform) -> Self {
    ...
    pub fn with_uparmtype(mut self, val: DopObjnetUparmtype) -> Self {
...
impl crate::core::types::HoudiniNode for DopObjnet {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum DopObjposDefaultparmop {
    SetInitial = 0,
    SetAlways = 1,
    SetNever = 2,
}
...
impl DopObjpos {
    ...
    // --- Int parameters ---
    pub fn with_defaultparmop(mut self, val: DopObjposDefaultparmop) -> Self {
    ...
    pub fn with_sharedata(mut self, val: DopObjposSharedata) -> Self {
    ...
    // --- Toggle parameters ---
    pub fn with_undogeoxform(mut self, val: bool) -> Self {
        self.params.insert("undogeoxform".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_undogeoxform_expr(mut self, expr: &str) -> Self {
        self.params.insert("undogeoxform".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_geopivot(mut self, val: bool) -> Self {
        self.params.insert("geopivot".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_geopivot_expr(mut self, expr: &str) -> Self {
        self.params.insert("geopivot".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for DopObjpos {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for DopOnlyonce {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for DopOutput {
    fn get_id(&self) -> usize {
        self.id
    }
