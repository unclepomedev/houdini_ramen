...
impl DopUniformforce {
    ...
    pub fn with_torque(mut self, val: [f32; 3]) -> Self {
        self.params.insert("torque".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_torque_expr(mut self, expr: &str) -> Self {
        self.params.insert("torque".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_parmop_torque(mut self, val: DopUniformforceParmopTorque) -> Self {
        self.params.insert("parmop_torque".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_torque_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_torque".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
