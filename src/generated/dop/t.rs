...
impl DopTerrainobject {
    ...
    pub fn with_displayextrusion(mut self, val: bool) -> Self {
        self.params.insert("displayextrusion".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_displayextrusion_expr(mut self, expr: &str) -> Self {
        self.params.insert("displayextrusion".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DopThinplatecollider {
    ...
    pub fn with_guidedepth(mut self, val: i32) -> Self {
        self.params.insert("guidedepth".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_guidedepth_expr(mut self, expr: &str) -> Self {
        self.params.insert("guidedepth".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_guideprim(mut self, val: i32) -> Self {
        self.params.insert("guideprim".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_guideprim_expr(mut self, expr: &str) -> Self {
        self.params.insert("guideprim".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_activation(mut self, val: i32) -> Self {
        self.params.insert("activation".to_string(), crate::core::types::ParamValue::Int(val));
...
impl DopTwostateconrel {
    ...
    pub fn set_input_data_to_attach_accepts_2_of_bullet_soft<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
    ...
    pub fn set_input_data_to_attach_accepts_2_of_bullet_soft_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn set_input_data_to_attach_accepts_2_of_bullet_soft_1<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(2, (target.get_id(), 0));
        self
    }

    /// Connects to input 2: "Data to attach Accepts 2 of: Bullet Soft Constraint Relationship Cone Twist Constraint Relationship Glue Constraint Relationship Hard Constraint Relationship No Constraint Relationship Slider Constraint Relationship SoftAttach Constraint Relationship Spring Constraint Relationship Two State Constraint Relationship" and specifies the output index of the target node.
    pub fn set_input_data_to_attach_accepts_2_of_bullet_soft_1_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_minstatetime(mut self, val: f32) -> Self {
        self.params.insert("minstatetime".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_minstatetime_expr(mut self, expr: &str) -> Self {
        self.params.insert("minstatetime".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_forcevalue1(mut self, val: f32) -> Self {
        self.params.insert("forcevalue1".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_forcevalue1_expr(mut self, expr: &str) -> Self {
        self.params.insert("forcevalue1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_distancevalue1(mut self, val: f32) -> Self {
        self.params.insert("distancevalue1".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_distancevalue1_expr(mut self, expr: &str) -> Self {
        self.params.insert("distancevalue1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_forcevalue0(mut self, val: f32) -> Self {
        self.params.insert("forcevalue0".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_forcevalue0_expr(mut self, expr: &str) -> Self {
        self.params.insert("forcevalue0".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_distancevalue0(mut self, val: f32) -> Self {
        self.params.insert("distancevalue0".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_distancevalue0_expr(mut self, expr: &str) -> Self {
        self.params.insert("distancevalue0".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_currentstate(mut self, val: i32) -> Self {
        self.params.insert("currentstate".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_currentstate_expr(mut self, expr: &str) -> Self {
        self.params.insert("currentstate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_activation(mut self, val: i32) -> Self {
        self.params.insert("activation".to_string(), crate::core::types::ParamValue::Int(val));
    ...
    pub fn with_parmop_minstatetime(mut self, val: DopTwostateconrelParmopMinstatetime) -> Self {
        self.params.insert("parmop_minstatetime".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_minstatetime_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_minstatetime".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_currentstate(mut self, val: DopTwostateconrelParmopCurrentstate) -> Self {
        self.params.insert("parmop_currentstate".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_currentstate_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_currentstate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_forcecompare1(mut self, val: DopTwostateconrelParmopForcecompare1) -> Self {
        self.params.insert("parmop_forcecompare1".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_forcecompare1_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_forcecompare1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_forcecompare1(mut self, val: DopTwostateconrelForcecompare1) -> Self {
        self.params.insert("forcecompare1".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_forcecompare1_expr(mut self, expr: &str) -> Self {
        self.params.insert("forcecompare1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_forcevalue1(mut self, val: DopTwostateconrelParmopForcevalue1) -> Self {
        self.params.insert("parmop_forcevalue1".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_forcevalue1_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_forcevalue1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_distancecompare1(mut self, val: DopTwostateconrelParmopDistancecompare1) -> Self {
        self.params.insert("parmop_distancecompare1".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_distancecompare1_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_distancecompare1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_distancecompare1(mut self, val: DopTwostateconrelDistancecompare1) -> Self {
        self.params.insert("distancecompare1".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_distancecompare1_expr(mut self, expr: &str) -> Self {
        self.params.insert("distancecompare1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_distancevalue1(mut self, val: DopTwostateconrelParmopDistancevalue1) -> Self {
        self.params.insert("parmop_distancevalue1".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_distancevalue1_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_distancevalue1".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_forcecompare0(mut self, val: DopTwostateconrelParmopForcecompare0) -> Self {
        self.params.insert("parmop_forcecompare0".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_forcecompare0_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_forcecompare0".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_forcecompare0(mut self, val: DopTwostateconrelForcecompare0) -> Self {
        self.params.insert("forcecompare0".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_forcecompare0_expr(mut self, expr: &str) -> Self {
        self.params.insert("forcecompare0".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_forcevalue0(mut self, val: DopTwostateconrelParmopForcevalue0) -> Self {
        self.params.insert("parmop_forcevalue0".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_forcevalue0_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_forcevalue0".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_distancecompare0(mut self, val: DopTwostateconrelParmopDistancecompare0) -> Self {
        self.params.insert("parmop_distancecompare0".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_distancecompare0_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_distancecompare0".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_distancecompare0(mut self, val: DopTwostateconrelDistancecompare0) -> Self {
        self.params.insert("distancecompare0".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_distancecompare0_expr(mut self, expr: &str) -> Self {
        self.params.insert("distancecompare0".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_distancevalue0(mut self, val: DopTwostateconrelParmopDistancevalue0) -> Self {
        self.params.insert("parmop_distancevalue0".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_distancevalue0_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_distancevalue0".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
