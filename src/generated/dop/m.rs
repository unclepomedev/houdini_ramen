...
impl DopMask {
    ...
    pub fn with_parmop_treatassdf(mut self, val: DopMaskParmopTreatassdf) -> Self {
        self.params.insert("parmop_treatassdf".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_treatassdf_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_treatassdf".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_parmop_scale(mut self, val: DopMaskParmopScale) -> Self {
        self.params.insert("parmop_scale".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_scale_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_scale".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_treatassdf(mut self, val: bool) -> Self {
        self.params.insert("treatassdf".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_treatassdf_expr(mut self, expr: &str) -> Self {
        self.params.insert("treatassdf".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DopMatrixfield {
    ...
    pub fn with_initialvalue(mut self, val: Vec<f32>) -> Self {
        self.params.insert("initialvalue".to_string(), crate::core::types::ParamValue::FloatArray(val));
        self
    }
    pub fn with_initialvalue_expr(mut self, expr: &str) -> Self {
        self.params.insert("initialvalue".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_parmop_initialvalue(mut self, val: DopMatrixfieldParmopInitialvalue) -> Self {
        self.params.insert("parmop_initialvalue".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_initialvalue_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_initialvalue".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DopMatrixfieldvisualization {
    ...
    pub fn with_guideiso(mut self, val: f32) -> Self {
        self.params.insert("guideiso".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_guideiso_expr(mut self, expr: &str) -> Self {
        self.params.insert("guideiso".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_guideinvert(mut self, val: bool) -> Self {
        self.params.insert("guideinvert".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_guideinvert_expr(mut self, expr: &str) -> Self {
        self.params.insert("guideinvert".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_uniquedataname(mut self, val: bool) -> Self {
        self.params.insert("uniquedataname".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl DopMerge {
    ...
    pub fn with_affectortype(mut self, val: DopMergeAffectortype) -> Self {
        self.params.insert("affectortype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_affectortype_expr(mut self, expr: &str) -> Self {
        self.params.insert("affectortype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- String parameters ---
    pub fn with_relationship(mut self, val: &str) -> Self {
        self.params.insert("relationship".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_relationship_expr(mut self, expr: &str) -> Self {
        self.params.insert("relationship".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl DopModifydata {
    ...
    pub fn set_input_objects_with_data_to_modify<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Objects with data to modify" and specifies the output index of the target node.
    pub fn set_input_objects_with_data_to_modify_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_valvaluef_inst(mut self, index1: usize, val: f32) -> Self {
        self.params.insert(format!("valvaluef{}", index1), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_valvaluef_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("valvaluef{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_valname_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("valname{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_valname_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("valname{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_valvalues_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("valvalues{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_valvalues_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("valvalues{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl DopMpmobject {
    ...
    pub fn with_showdomain(mut self, val: bool) -> Self {
        self.params.insert("showdomain".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_showdomain_expr(mut self, expr: &str) -> Self {
        self.params.insert("showdomain".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_showmassgrid(mut self, val: bool) -> Self {
        self.params.insert("showmassgrid".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_showmassgrid_expr(mut self, expr: &str) -> Self {
        self.params.insert("showmassgrid".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_showvelocitygrid(mut self, val: bool) -> Self {
        self.params.insert("showvelocitygrid".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_showvelocitygrid_expr(mut self, expr: &str) -> Self {
        self.params.insert("showvelocitygrid".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_showcollisiongrid(mut self, val: bool) -> Self {
        self.params.insert("showcollisiongrid".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_showcollisiongrid_expr(mut self, expr: &str) -> Self {
        self.params.insert("showcollisiongrid".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_showcflpoint(mut self, val: bool) -> Self {
        self.params.insert("showcflpoint".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_showcflpoint_expr(mut self, expr: &str) -> Self {
        self.params.insert("showcflpoint".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl DopMpmsolver {
    ...
    pub fn with_cflcondition(mut self, val: f32) -> Self {
        self.params.insert("cflcondition".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cflcondition_expr(mut self, expr: &str) -> Self {
        self.params.insert("cflcondition".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_materialcondition(mut self, val: f32) -> Self {
        self.params.insert("materialcondition".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_materialcondition_expr(mut self, expr: &str) -> Self {
        self.params.insert("materialcondition".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_kernelwidth(mut self, val: f32) -> Self {
        self.params.insert("kernelwidth".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_kernelwidth_expr(mut self, expr: &str) -> Self {
        self.params.insert("kernelwidth".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_groundfriction(mut self, val: f32) -> Self {
        self.params.insert("groundfriction".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_groundfriction_expr(mut self, expr: &str) -> Self {
        self.params.insert("groundfriction".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_groundsticky(mut self, val: f32) -> Self {
        self.params.insert("groundsticky".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_groundsticky_expr(mut self, expr: &str) -> Self {
        self.params.insert("groundsticky".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_minpad(mut self, val: f32) -> Self {
        self.params.insert("minpad".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    ...
    pub fn with_maxpad(mut self, val: f32) -> Self {
        self.params.insert("maxpad".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    ...
    pub fn with_projdist(mut self, val: f32) -> Self {
        self.params.insert("projdist".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_projdist_expr(mut self, expr: &str) -> Self {
        self.params.insert("projdist".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_surfoffset(mut self, val: f32) -> Self {
        self.params.insert("surfoffset".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_surfoffset_expr(mut self, expr: &str) -> Self {
        self.params.insert("surfoffset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_speedtol(mut self, val: f32) -> Self {
        self.params.insert("speedtol".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_speedtol_expr(mut self, expr: &str) -> Self {
        self.params.insert("speedtol".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_substeprange(mut self, val: [i32; 2]) -> Self {
        self.params.insert("substeprange".to_string(), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_substeprange_expr(mut self, expr: &str) -> Self {
        self.params.insert("substeprange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_stmethod(mut self, val: DopMpmsolverStmethod) -> Self {
        self.params.insert("stmethod".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_stmethod_expr(mut self, expr: &str) -> Self {
        self.params.insert("stmethod".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_groundresponse(mut self, val: DopMpmsolverGroundresponse) -> Self {
        self.params.insert("groundresponse".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_groundresponse_expr(mut self, expr: &str) -> Self {
        self.params.insert("groundresponse".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_dilationunits(mut self, val: DopMpmsolverDilationunits) -> Self {
        self.params.insert("dilationunits".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_dilationunits_expr(mut self, expr: &str) -> Self {
        self.params.insert("dilationunits".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_moveoutsidecolliders(mut self, val: DopMpmsolverMoveoutsidecolliders) -> Self {
        self.params.insert("moveoutsidecolliders".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_moveoutsidecolliders_expr(mut self, expr: &str) -> Self {
        self.params.insert("moveoutsidecolliders".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_pinanimationgeo(mut self, val: &str) -> Self {
        self.params.insert("pinanimationgeo".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pinanimationgeo_expr(mut self, expr: &str) -> Self {
        self.params.insert("pinanimationgeo".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_sourcesgeo(mut self, val: &str) -> Self {
        self.params.insert("sourcesgeo".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_sourcesgeo_expr(mut self, expr: &str) -> Self {
        self.params.insert("sourcesgeo".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_collidersgeo(mut self, val: &str) -> Self {
        self.params.insert("collidersgeo".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_collidersgeo_expr(mut self, expr: &str) -> Self {
        self.params.insert("collidersgeo".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_containergeo(mut self, val: &str) -> Self {
        self.params.insert("containergeo".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_containergeo_expr(mut self, expr: &str) -> Self {
        self.params.insert("containergeo".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_stenable(mut self, val: bool) -> Self {
        self.params.insert("stenable".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_stenable_expr(mut self, expr: &str) -> Self {
        self.params.insert("stenable".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_externalforcesonly(mut self, val: bool) -> Self {
        self.params.insert("externalforcesonly".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_externalforcesonly_expr(mut self, expr: &str) -> Self {
        self.params.insert("externalforcesonly".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_groundactive(mut self, val: bool) -> Self {
        self.params.insert("groundactive".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_groundactive_expr(mut self, expr: &str) -> Self {
        self.params.insert("groundactive".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_staticmaterials(mut self, val: bool) -> Self {
        self.params.insert("staticmaterials".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_staticmaterials_expr(mut self, expr: &str) -> Self {
        self.params.insert("staticmaterials".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cclamping(mut self, val: bool) -> Self {
        self.params.insert("cclamping".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_cclamping_expr(mut self, expr: &str) -> Self {
        self.params.insert("cclamping".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_deterministic(mut self, val: bool) -> Self {
        self.params.insert("deterministic".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    ...
    pub fn with_gpugridrebuild(mut self, val: bool) -> Self {
        self.params.insert("gpugridrebuild".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_gpugridrebuild_expr(mut self, expr: &str) -> Self {
        self.params.insert("gpugridrebuild".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_velbasedgridactivation(mut self, val: bool) -> Self {
        self.params.insert("velbasedgridactivation".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_velbasedgridactivation_expr(mut self, expr: &str) -> Self {
        self.params.insert("velbasedgridactivation".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pruneintpts(mut self, val: bool) -> Self {
        self.params.insert("pruneintpts".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_pruneintpts_expr(mut self, expr: &str) -> Self {
        self.params.insert("pruneintpts".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_particlelevelcollisions(mut self, val: bool) -> Self {
        self.params.insert("particlelevelcollisions".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_particlelevelcollisions_expr(mut self, expr: &str) -> Self {
        self.params.insert("particlelevelcollisions".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enablesleep(mut self, val: bool) -> Self {
        self.params.insert("enablesleep".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablesleep_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablesleep".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DopMultifieldvisualization {
    ...
    pub fn with_emitcdscale(mut self, val: f32) -> Self {
        self.params.insert("emitcdscale".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_emitcdscale_expr(mut self, expr: &str) -> Self {
        self.params.insert("emitcdscale".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_emitcdtemperature0(mut self, val: f32) -> Self {
        self.params.insert("emitcdtemperature0".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_emitcdtemperature0_expr(mut self, expr: &str) -> Self {
        self.params.insert("emitcdtemperature0".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_emitcdtemperature(mut self, val: f32) -> Self {
        self.params.insert("emitcdtemperature".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_emitcdtemperature_expr(mut self, expr: &str) -> Self {
        self.params.insert("emitcdtemperature".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_emitcdadaptation(mut self, val: f32) -> Self {
        self.params.insert("emitcdadaptation".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_emitcdadaptation_expr(mut self, expr: &str) -> Self {
        self.params.insert("emitcdadaptation".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_emitcdburn(mut self, val: f32) -> Self {
        self.params.insert("emitcdburn".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_emitcdburn_expr(mut self, expr: &str) -> Self {
        self.params.insert("emitcdburn".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_densitypreset(mut self, val: DopMultifieldvisualizationDensitypreset) -> Self {
        self.params.insert("densitypreset".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_densitypreset_expr(mut self, expr: &str) -> Self {
        self.params.insert("densitypreset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_emitpreset(mut self, val: DopMultifieldvisualizationEmitpreset) -> Self {
        self.params.insert("emitpreset".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_emitpreset_expr(mut self, expr: &str) -> Self {
        self.params.insert("emitpreset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_emitcdpreset(mut self, val: DopMultifieldvisualizationEmitcdpreset) -> Self {
        self.params.insert("emitcdpreset".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_emitcdpreset_expr(mut self, expr: &str) -> Self {
        self.params.insert("emitcdpreset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_densityfield(mut self, val: &str) -> Self {
        self.params.insert("densityfield".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_densityfield_expr(mut self, expr: &str) -> Self {
        self.params.insert("densityfield".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cdfield(mut self, val: &str) -> Self {
        self.params.insert("cdfield".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_cdfield_expr(mut self, expr: &str) -> Self {
        self.params.insert("cdfield".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_emitfield(mut self, val: &str) -> Self {
        self.params.insert("emitfield".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_emitfield_expr(mut self, expr: &str) -> Self {
        self.params.insert("emitfield".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_emitcdfield(mut self, val: &str) -> Self {
        self.params.insert("emitcdfield".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_emitcdfield_expr(mut self, expr: &str) -> Self {
        self.params.insert("emitcdfield".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_group(mut self, val: &str) -> Self {
        self.params.insert("group".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_usebox(mut self, val: bool) -> Self {
        self.params.insert("usebox".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usebox_expr(mut self, expr: &str) -> Self {
        self.params.insert("usebox".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_useboxhash(mut self, val: bool) -> Self {
        self.params.insert("useboxhash".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useboxhash_expr(mut self, expr: &str) -> Self {
        self.params.insert("useboxhash".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_setmaxres(mut self, val: bool) -> Self {
        self.params.insert("setmaxres".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_setmaxres_expr(mut self, expr: &str) -> Self {
        self.params.insert("setmaxres".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DopMuscleupdatevellum {
    ...
    pub fn with_vellumsolver(mut self, val: &str) -> Self {
        self.params.insert("vellumsolver".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vellumsolver_expr(mut self, expr: &str) -> Self {
        self.params.insert("vellumsolver".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
