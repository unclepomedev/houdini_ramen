...
impl DopImpactanalysis {
    ...
    pub fn with_time_threshold(mut self, val: f32) -> Self {
        self.params.insert("time_threshold".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_time_threshold_expr(mut self, expr: &str) -> Self {
        self.params.insert("time_threshold".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_impact_threshold(mut self, val: f32) -> Self {
        self.params.insert("impact_threshold".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_impact_threshold_expr(mut self, expr: &str) -> Self {
        self.params.insert("impact_threshold".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_distance_threshold(mut self, val: f32) -> Self {
        self.params.insert("distance_threshold".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_distance_threshold_expr(mut self, expr: &str) -> Self {
        self.params.insert("distance_threshold".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- String parameters ---
    pub fn with_force_object(mut self, val: &str) -> Self {
        self.params.insert("force_object".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_force_object_expr(mut self, expr: &str) -> Self {
        self.params.insert("force_object".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DopImpulseforce {
    ...
    pub fn with_impulse(mut self, val: [f32; 3]) -> Self {
        self.params.insert("impulse".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_impulse_expr(mut self, expr: &str) -> Self {
        self.params.insert("impulse".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_parmop_impulse(mut self, val: DopImpulseforceParmopImpulse) -> Self {
        self.params.insert("parmop_impulse".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_impulse_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_impulse".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DopIndexfield {
    ...
    pub fn with_initialvalue(mut self, val: i32) -> Self {
        self.params.insert("initialvalue".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
...
impl DopIndexfieldvisualization {
    ...
    pub fn with_guideindex(mut self, val: i32) -> Self {
        self.params.insert("guideindex".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_guideindex_expr(mut self, expr: &str) -> Self {
        self.params.insert("guideindex".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_activation(mut self, val: i32) -> Self {
        self.params.insert("activation".to_string(), crate::core::types::ParamValue::Int(val));
...
impl DopInstancedobject {
    ...
    pub fn with_sourcesoppath(mut self, val: &str) -> Self {
        self.params.insert("sourcesoppath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_sourcesoppath_expr(mut self, expr: &str) -> Self {
        self.params.insert("sourcesoppath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_useobjectxform(mut self, val: bool) -> Self {
        self.params.insert("useobjectxform".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useobjectxform_expr(mut self, expr: &str) -> Self {
        self.params.insert("useobjectxform".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DopIntangiblevalue {
    ...
    pub fn with_intangible(mut self, val: f32) -> Self {
        self.params.insert("intangible".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_intangible_expr(mut self, expr: &str) -> Self {
        self.params.insert("intangible".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_parmop_intangible(mut self, val: DopIntangiblevalueParmopIntangible) -> Self {
        self.params.insert("parmop_intangible".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_intangible_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_intangible".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
