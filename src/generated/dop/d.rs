...
impl DopDelete {
    ...
    pub fn with_objgroup_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("objgroup{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_objgroup_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("objgroup{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_deletedata_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("deletedata{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_deletedata_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("deletedata{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_deleteobjects_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("deleteobjects{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_deleteobjects_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("deleteobjects{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl DopDrag {
    ...
    pub fn with_parmop_ignoremass(mut self, val: DopDragParmopIgnoremass) -> Self {
        self.params.insert("parmop_ignoremass".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_ignoremass_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_ignoremass".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_ignoremass(mut self, val: bool) -> Self {
        self.params.insert("ignoremass".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_ignoremass_expr(mut self, expr: &str) -> Self {
        self.params.insert("ignoremass".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DopDragproperties {
    ...
    pub fn with_parmop_normaldrag(mut self, val: DopDragpropertiesParmopNormaldrag) -> Self {
        self.params.insert("parmop_normaldrag".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_normaldrag_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_normaldrag".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_tangentdrag(mut self, val: DopDragpropertiesParmopTangentdrag) -> Self {
        self.params.insert("parmop_tangentdrag".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_tangentdrag_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_tangentdrag".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_externalvelocityfield(mut self, val: DopDragpropertiesParmopExternalvelocityfield) -> Self {
        self.params.insert("parmop_externalvelocityfield".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_externalvelocityfield_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_externalvelocityfield".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_parmop_externalvelocityoffset(mut self, val: DopDragpropertiesParmopExternalvelocityoffset) -> Self {
        self.params.insert("parmop_externalvelocityoffset".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_parmop_externalvelocityoffset_expr(mut self, expr: &str) -> Self {
        self.params.insert("parmop_externalvelocityoffset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
