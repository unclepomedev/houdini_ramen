...
impl Cop2Zcomp {
    ...
    pub fn with_backdepth(mut self, val: f32) -> Self {
        self.params.insert("backdepth".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_backdepth_expr(mut self, expr: &str) -> Self {
        self.params.insert("backdepth".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_foredepth(mut self, val: f32) -> Self {
        self.params.insert("foredepth".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_foredepth_expr(mut self, expr: &str) -> Self {
        self.params.insert("foredepth".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_aperature(mut self, val: f32) -> Self {
        self.params.insert("aperature".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_aperature_expr(mut self, expr: &str) -> Self {
        self.params.insert("aperature".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_usebackplane(mut self, val: bool) -> Self {
        self.params.insert("usebackplane".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usebackplane_expr(mut self, expr: &str) -> Self {
        self.params.insert("usebackplane".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_useforeplane(mut self, val: bool) -> Self {
        self.params.insert("useforeplane".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useforeplane_expr(mut self, expr: &str) -> Self {
        self.params.insert("useforeplane".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
