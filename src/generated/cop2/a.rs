...
impl Cop2Aidenoise {
    ...
    pub fn set_input_image_to_denoise<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
    ) -> Self {
        self.inputs.insert(
    ...
    pub fn set_input_image_to_denoise_from<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
        output_index: usize,
    ) -> Self {
    ...
    pub fn set_input_image_to_denoise_by_name<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
        port_name: &str,
    ) -> Self {
