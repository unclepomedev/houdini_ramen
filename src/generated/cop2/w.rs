...
impl Cop2Warp {
    ...
    pub fn set_input_sequence_to_warp<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Sequence to Warp" and specifies the output index of the target node.
    pub fn set_input_sequence_to_warp_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_warp(mut self, val: Cop2WarpWarp) -> Self {
        self.params.insert("warp".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    ...
    pub fn with_round(mut self, val: Cop2WarpRound) -> Self {
        self.params.insert("round".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
...
impl crate::core::types::HoudiniNode for Cop2Warp {
...
impl Cop2Window {
    ...
    pub fn set_input_sequence_to_window<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Sequence to Window" and specifies the output index of the target node.
    pub fn set_input_sequence_to_window_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_harea(mut self, val: [f32; 2]) -> Self {
        self.params.insert("harea".to_string(), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_harea_expr(mut self, expr: &str) -> Self {
        self.params.insert("harea".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_varea(mut self, val: [f32; 2]) -> Self {
        self.params.insert("varea".to_string(), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_varea_expr(mut self, expr: &str) -> Self {
        self.params.insert("varea".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_window(mut self, val: Cop2WindowWindow) -> Self {
        self.params.insert("window".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_window_expr(mut self, expr: &str) -> Self {
        self.params.insert("window".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for Cop2Window {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl Cop2Wipe {
    ...
    pub fn with_lcol(mut self, val: [f32; 4]) -> Self {
        self.params.insert("lcol".to_string(), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_lcol_expr(mut self, expr: &str) -> Self {
        self.params.insert("lcol".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_doline(mut self, val: bool) -> Self {
        self.params.insert("doline".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_doline_expr(mut self, expr: &str) -> Self {
        self.params.insert("doline".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for Cop2Wipe {
    fn get_id(&self) -> usize {
        self.id
    }
