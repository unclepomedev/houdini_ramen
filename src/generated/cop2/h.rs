...
impl Cop2Hsv {
    ...
    pub fn set_input_image_to_convert<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to Convert" and specifies the output index of the target node.
    pub fn set_input_image_to_convert_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn trigger_showhue(mut self) -> Self {
        self.params.insert("showhue".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    ...
    pub fn with_keeplum(mut self, val: bool) -> Self {
        self.params.insert("keeplum".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_keeplum_expr(mut self, expr: &str) -> Self {
        self.params.insert("keeplum".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl Cop2Huecurve {
    ...
    pub fn set_input_image_to_adjust_hue<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to Adjust Hue" and specifies the output index of the target node.
    pub fn set_input_image_to_adjust_hue_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_huemode(mut self, val: Cop2HuecurveHuemode) -> Self {
        self.params.insert("huemode".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_huemode_expr(mut self, expr: &str) -> Self {
        self.params.insert("huemode".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
