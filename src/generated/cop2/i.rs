...
impl Cop2Illpixel {
    ...
    pub fn set_input_sequence_to_analyze<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Sequence to Analyze" and specifies the output index of the target node.
    pub fn set_input_sequence_to_analyze_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_badlimit(mut self, val: i32) -> Self {
        self.params.insert("badlimit".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_badlimit_expr(mut self, expr: &str) -> Self {
        self.params.insert("badlimit".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_notification(mut self, val: Cop2IllpixelNotification) -> Self {
        self.params.insert("notification".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_notification_expr(mut self, expr: &str) -> Self {
        self.params.insert("notification".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl Cop2Invert {
    ...
    pub fn set_input_image_to_invert<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to Invert" and specifies the output index of the target node.
    pub fn set_input_image_to_invert_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
