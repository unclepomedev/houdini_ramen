...
impl Cop2Xform {
    ...
    pub fn set_input_image_to_transform<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
    ) -> Self {
        self.inputs.insert(
    ...
    pub fn set_input_image_to_transform_from<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
        output_index: usize,
    ) -> Self {
    ...
    pub fn set_input_image_to_transform_by_name<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
        port_name: &str,
    ) -> Self {
