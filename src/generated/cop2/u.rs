...
impl Cop2Unpin {
    ...
    pub fn set_input_image_to_unpin<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to UnPin" and specifies the output index of the target node.
    pub fn set_input_image_to_unpin_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_botleft(mut self, val: [f32; 2]) -> Self {
        self.params.insert("botleft".to_string(), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_botleft_expr(mut self, expr: &str) -> Self {
        self.params.insert("botleft".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_botright(mut self, val: [f32; 2]) -> Self {
        self.params.insert("botright".to_string(), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_botright_expr(mut self, expr: &str) -> Self {
        self.params.insert("botright".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_filter(mut self, val: i32) -> Self {
        self.params.insert("filter".to_string(), crate::core::types::ParamValue::Menu(val));
        self
    }
    pub fn with_filter_expr(mut self, expr: &str) -> Self {
        self.params.insert("filter".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
...
impl Cop2Uvmap {
    ...
    pub fn with_cyclesu(mut self, val: f32) -> Self {
        self.params.insert("cyclesu".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cyclesu_expr(mut self, expr: &str) -> Self {
        self.params.insert("cyclesu".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_shiftu(mut self, val: f32) -> Self {
        self.params.insert("shiftu".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_shiftu_expr(mut self, expr: &str) -> Self {
        self.params.insert("shiftu".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cyclesv(mut self, val: f32) -> Self {
        self.params.insert("cyclesv".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cyclesv_expr(mut self, expr: &str) -> Self {
        self.params.insert("cyclesv".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_shiftv(mut self, val: f32) -> Self {
        self.params.insert("shiftv".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_shiftv_expr(mut self, expr: &str) -> Self {
        self.params.insert("shiftv".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_effectamount(mut self, val: f32) -> Self {
        self.params.insert("effectamount".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_clampu(mut self, val: Cop2UvmapClampu) -> Self {
        self.params.insert("clampu".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    ...
    pub fn with_clampv(mut self, val: Cop2UvmapClampv) -> Self {
        self.params.insert("clampv".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    ...
    pub fn with_reverseu(mut self, val: bool) -> Self {
        self.params.insert("reverseu".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_reverseu_expr(mut self, expr: &str) -> Self {
        self.params.insert("reverseu".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_reversev(mut self, val: bool) -> Self {
        self.params.insert("reversev".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_reversev_expr(mut self, expr: &str) -> Self {
        self.params.insert("reversev".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_maskresize(mut self, val: bool) -> Self {
        self.params.insert("maskresize".to_string(), crate::core::types::ParamValue::Toggle(val));
