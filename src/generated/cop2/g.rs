...
impl Cop2Gamma {
    ...
    pub fn set_input_image_to_gamma<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to Gamma" and specifies the output index of the target node.
    pub fn set_input_image_to_gamma_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_usecomp(mut self, val: bool) -> Self {
        self.params.insert("usecomp".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usecomp_expr(mut self, expr: &str) -> Self {
        self.params.insert("usecomp".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl Cop2Geokey {
    ...
    pub fn with_dropangle(mut self, val: f32) -> Self {
        self.params.insert("dropangle".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_dropangle_expr(mut self, expr: &str) -> Self {
        self.params.insert("dropangle".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_effectamount(mut self, val: f32) -> Self {
        self.params.insert("effectamount".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_clippos(mut self, val: [f32; 3]) -> Self {
        self.params.insert("clippos".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_clippos_expr(mut self, expr: &str) -> Self {
        self.params.insert("clippos".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_rolloff(mut self, val: Cop2GeokeyRolloff) -> Self {
        self.params.insert("rolloff".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    ...
    pub fn with_clipplane(mut self, val: Cop2GeokeyClipplane) -> Self {
        self.params.insert("clipplane".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_clipplane_expr(mut self, expr: &str) -> Self {
        self.params.insert("clipplane".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl Cop2Geometry {
    ...
    pub fn with_uniform(mut self, val: f32) -> Self {
        self.params.insert("uniform".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_uniform_expr(mut self, expr: &str) -> Self {
        self.params.insert("uniform".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_effectamount(mut self, val: f32) -> Self {
        self.params.insert("effectamount".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_fit(mut self, val: bool) -> Self {
        self.params.insert("fit".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    ...
    pub fn with_preserveaspect(mut self, val: bool) -> Self {
        self.params.insert("preserveaspect".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_preserveaspect_expr(mut self, expr: &str) -> Self {
        self.params.insert("preserveaspect".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_maskresize(mut self, val: bool) -> Self {
        self.params.insert("maskresize".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl Cop2Gradient {
    ...
    pub fn with_lowthreshold(mut self, val: f32) -> Self {
        self.params.insert("lowthreshold".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_lowthreshold_expr(mut self, expr: &str) -> Self {
        self.params.insert("lowthreshold".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_highthreshold(mut self, val: f32) -> Self {
        self.params.insert("highthreshold".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_highthreshold_expr(mut self, expr: &str) -> Self {
        self.params.insert("highthreshold".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_lumfunc(mut self, val: Cop2GradientLumfunc) -> Self {
        self.params.insert("lumfunc".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    ...
    pub fn with_output(mut self, val: Cop2GradientOutput) -> Self {
        self.params.insert("output".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
...
impl Cop2Grain {
    ...
    pub fn with_gsize(mut self, val: f32) -> Self {
        self.params.insert("gsize".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_gsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("gsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_gamma(mut self, val: f32) -> Self {
        self.params.insert("gamma".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_gcolor(mut self, val: [f32; 4]) -> Self {
        self.params.insert("gcolor".to_string(), crate::core::types::ParamValue::Float4(val));
        self
    }
    ...
    pub fn with_lumrel(mut self, val: bool) -> Self {
        self.params.insert("lumrel".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_lumrel_expr(mut self, expr: &str) -> Self {
        self.params.insert("lumrel".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_timevary(mut self, val: bool) -> Self {
        self.params.insert("timevary".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_timevary_expr(mut self, expr: &str) -> Self {
        self.params.insert("timevary".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_compvary(mut self, val: bool) -> Self {
        self.params.insert("compvary".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_compvary_expr(mut self, expr: &str) -> Self {
        self.params.insert("compvary".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_maskresize(mut self, val: bool) -> Self {
        self.params.insert("maskresize".to_string(), crate::core::types::ParamValue::Toggle(val));
