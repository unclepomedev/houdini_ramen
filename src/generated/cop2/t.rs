...
impl Cop2Tile {
    ...
    pub fn set_input_image_to_tile<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to Tile" and specifies the output index of the target node.
    pub fn set_input_image_to_tile_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_tiling(mut self, val: [f32; 2]) -> Self {
        self.params.insert("tiling".to_string(), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_tiling_expr(mut self, expr: &str) -> Self {
        self.params.insert("tiling".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_methodx(mut self, val: Cop2TileMethodx) -> Self {
        self.params.insert("methodx".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_methodx_expr(mut self, expr: &str) -> Self {
        self.params.insert("methodx".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_methody(mut self, val: Cop2TileMethody) -> Self {
        self.params.insert("methody".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_methody_expr(mut self, expr: &str) -> Self {
        self.params.insert("methody".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl Cop2Tima {
    ...
    pub fn with_blackframes(mut self, val: f32) -> Self {
        self.params.insert("blackframes".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_blackframes_expr(mut self, expr: &str) -> Self {
        self.params.insert("blackframes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_whiteframes(mut self, val: f32) -> Self {
        self.params.insert("whiteframes".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_whiteframes_expr(mut self, expr: &str) -> Self {
        self.params.insert("whiteframes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_startopt(mut self, val: Cop2TimaStartopt) -> Self {
        self.params.insert("startopt".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_startopt_expr(mut self, expr: &str) -> Self {
        self.params.insert("startopt".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_endopt(mut self, val: Cop2TimaEndopt) -> Self {
        self.params.insert("endopt".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_endopt_expr(mut self, expr: &str) -> Self {
        self.params.insert("endopt".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_mixframes(mut self, val: bool) -> Self {
        self.params.insert("mixframes".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_mixframes_expr(mut self, expr: &str) -> Self {
        self.params.insert("mixframes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl Cop2Timefilter {
    ...
    pub fn with_frames(mut self, val: f32) -> Self {
        self.params.insert("frames".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    ...
    pub fn with_ftype(mut self, val: Cop2TimefilterFtype) -> Self {
        self.params.insert("ftype".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    ...
    pub fn with_rangepos(mut self, val: Cop2TimefilterRangepos) -> Self {
        self.params.insert("rangepos".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_rangepos_expr(mut self, expr: &str) -> Self {
        self.params.insert("rangepos".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl Cop2Timescale {
    ...
    pub fn set_input_image_to_resample<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to Resample" and specifies the output index of the target node.
    pub fn set_input_image_to_resample_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_ldiff(mut self, val: i32) -> Self {
        self.params.insert("ldiff".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_ldiff_expr(mut self, expr: &str) -> Self {
        self.params.insert("ldiff".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_lengthop(mut self, val: Cop2TimescaleLengthop) -> Self {
        self.params.insert("lengthop".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_lengthop_expr(mut self, expr: &str) -> Self {
        self.params.insert("lengthop".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl Cop2Trim {
    ...
    pub fn set_input_sequence_to_trim<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Sequence to Trim" and specifies the output index of the target node.
    pub fn set_input_sequence_to_trim_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }

    /// Connects to input 1: "Reference Sequence"
    pub fn set_input_reference_sequence<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Reference Sequence" and specifies the output index of the target node.
    pub fn set_input_reference_sequence_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }
