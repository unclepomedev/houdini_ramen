...
impl Cop2Quantize {
    ...
    pub fn set_input_image_to_quantize<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to Quantize" and specifies the output index of the target node.
    pub fn set_input_image_to_quantize_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
