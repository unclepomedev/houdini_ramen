...
impl Cop2Pin {
    ...
    /// Connects to input 0: "Image to Corner Pin"
    pub fn set_input_image_to_corner_pin<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to Corner Pin" and specifies the output index of the target node.
    pub fn set_input_image_to_corner_pin_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
...
impl crate::core::types::HoudiniNode for Cop2Pin {
...
impl Cop2Pixel {
    ...
    /// Connects to input 1: "Second Image"
    pub fn set_input_second_image<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Second Image" and specifies the output index of the target node.
    pub fn set_input_second_image_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }

    /// Connects to input 2: "Third Image"
    pub fn set_input_third_image<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(2, (target.get_id(), 0));
        self
    }

    /// Connects to input 2: "Third Image" and specifies the output index of the target node.
    pub fn set_input_third_image_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_rexpr(mut self, val: f32) -> Self {
        self.params.insert("rexpr".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_rexpr_expr(mut self, expr: &str) -> Self {
        self.params.insert("rexpr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_gexpr(mut self, val: f32) -> Self {
        self.params.insert("gexpr".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_gexpr_expr(mut self, expr: &str) -> Self {
        self.params.insert("gexpr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bexpr(mut self, val: f32) -> Self {
        self.params.insert("bexpr".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_bexpr_expr(mut self, expr: &str) -> Self {
        self.params.insert("bexpr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_aexpr(mut self, val: f32) -> Self {
        self.params.insert("aexpr".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_aexpr_expr(mut self, expr: &str) -> Self {
        self.params.insert("aexpr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_c1expr(mut self, val: f32) -> Self {
        self.params.insert("c1expr".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_c1expr_expr(mut self, expr: &str) -> Self {
        self.params.insert("c1expr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_c2expr(mut self, val: f32) -> Self {
        self.params.insert("c2expr".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_c2expr_expr(mut self, expr: &str) -> Self {
        self.params.insert("c2expr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_c3expr(mut self, val: f32) -> Self {
        self.params.insert("c3expr".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_c3expr_expr(mut self, expr: &str) -> Self {
        self.params.insert("c3expr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_c4expr(mut self, val: f32) -> Self {
        self.params.insert("c4expr".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_c4expr_expr(mut self, expr: &str) -> Self {
        self.params.insert("c4expr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_serial(mut self, val: i32) -> Self {
        self.params.insert("serial".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_serial_expr(mut self, expr: &str) -> Self {
        self.params.insert("serial".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_scopergba(mut self, val: i32) -> Self {
        self.params.insert("scopergba".to_string(), crate::core::types::ParamValue::Int(val));
    ...
    pub fn with_expr(mut self, val: bool) -> Self {
        self.params.insert("expr".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
...
impl crate::core::types::HoudiniNode for Cop2Pixel {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl Cop2Premultiply {
    ...
    /// Connects to input 0: "Image to Premultiply"
    pub fn set_input_image_to_premultiply<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Image to Premultiply" and specifies the output index of the target node.
    pub fn set_input_image_to_premultiply_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
...
impl crate::core::types::HoudiniNode for Cop2Premultiply {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl Cop2Pulldown {
    ...
    pub fn with_filmrate(mut self, val: f32) -> Self {
        self.params.insert("filmrate".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_filmrate_expr(mut self, expr: &str) -> Self {
        self.params.insert("filmrate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_videorate(mut self, val: f32) -> Self {
        self.params.insert("videorate".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_videorate_expr(mut self, expr: &str) -> Self {
        self.params.insert("videorate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_fieldoffset(mut self, val: i32) -> Self {
        self.params.insert("fieldoffset".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_fieldoffset_expr(mut self, expr: &str) -> Self {
        self.params.insert("fieldoffset".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for Cop2Pulldown {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for Cop2Pushup {
    fn get_id(&self) -> usize {
        self.id
    }
