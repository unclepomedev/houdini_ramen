...
impl DriverMdd {
    ...
    pub fn with_restframe(mut self, val: f32) -> Self {
        self.params.insert("restframe".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    ...
    pub fn with_coordsys(mut self, val: DriverMddCoordsys) -> Self {
        self.params.insert("coordsys".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    ...
    pub fn with_reltime(mut self, val: bool) -> Self {
        self.params.insert("reltime".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_reltime_expr(mut self, expr: &str) -> Self {
        self.params.insert("reltime".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DriverMlExampleraw {
    ...
    pub fn with_targettype_inst(mut self, index1: usize, val: DriverMlExamplerawTargettype) -> Self {
        self.params.insert(format!("targettype{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_targettype_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("targettype{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_inputpointattribute_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("inputpointattribute{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_inputpointattribute_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("inputpointattribute{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_inputvolumename_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("inputvolumename{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_inputvolumename_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("inputvolumename{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_targetpointattribute_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("targetpointattribute{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_targetpointattribute_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("targetpointattribute{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_targetvolumename_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("targetvolumename{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_targetvolumename_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("targetvolumename{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_prerender(mut self, val: &str) -> Self {
        self.params.insert("prerender".to_string(), crate::core::types::ParamValue::String(val.to_string()));
