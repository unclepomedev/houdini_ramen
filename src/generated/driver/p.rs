...
impl DriverPrepost {
    ...
    pub fn set_input_pre_render_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn set_input_main_job_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn set_input_post_render_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_prerange(mut self, val: DriverPrepostPrerange) -> Self {
        self.params.insert("prerange".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_prerange_expr(mut self, expr: &str) -> Self {
        self.params.insert("prerange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_postrange(mut self, val: DriverPrepostPostrange) -> Self {
        self.params.insert("postrange".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_postrange_expr(mut self, expr: &str) -> Self {
        self.params.insert("postrange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_enablepre(mut self, val: bool) -> Self {
        self.params.insert("enablepre".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablepre_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablepre".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enablepost(mut self, val: bool) -> Self {
        self.params.insert("enablepost".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablepost_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablepost".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
