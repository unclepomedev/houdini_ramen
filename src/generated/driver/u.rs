...
impl DriverUsdstitch {
    ...
    pub fn with_infile_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("infile{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_infile_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("infile{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_outfile_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("outfile{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_outfile_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("outfile{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DriverUsdstitchclips {
    ...
    pub fn with_tcps(mut self, val: f32) -> Self {
        self.params.insert("tcps".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_tcps_expr(mut self, expr: &str) -> Self {
        self.params.insert("tcps".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_settcps(mut self, val: &str) -> Self {
        self.params.insert("settcps".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_settcps_expr(mut self, expr: &str) -> Self {
        self.params.insert("settcps".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_infile_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("infile{}", index1), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_outtemplatefile_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("outtemplatefile{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_outtemplatefile_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("outtemplatefile{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_clippath_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("clippath{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_clippath_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("clippath{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_clipset_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("clipset{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_clipset_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("clipset{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl DriverUsdzip {
    ...
    pub fn with_arkitasset_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("arkitasset{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_arkitasset_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("arkitasset{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
