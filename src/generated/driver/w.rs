...
impl DriverWedge {
    ...
    pub fn set_input_rop_to_wedge<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "ROP to Wedge" and specifies the output index of the target node.
    pub fn set_input_rop_to_wedge_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_range_inst(mut self, index1: usize, val: [f32; 2]) -> Self {
        self.params.insert(format!("range{}", index1), crate::core::types::ParamValue::Float2(val));
        self
    }
    pub fn with_range_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("range{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int parameters ---
    pub fn with_wedgenum(mut self, val: i32) -> Self {
        self.params.insert("wedgenum".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_wedgenum_expr(mut self, expr: &str) -> Self {
        self.params.insert("wedgenum".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_numrandom(mut self, val: i32) -> Self {
        self.params.insert("numrandom".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_numrandom_expr(mut self, expr: &str) -> Self {
        self.params.insert("numrandom".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_steps_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("steps{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_steps_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("steps{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_wrange(mut self, val: DriverWedgeWrange) -> Self {
        self.params.insert("wrange".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_wrange_expr(mut self, expr: &str) -> Self {
        self.params.insert("wrange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_wedgemethod(mut self, val: DriverWedgeWedgemethod) -> Self {
        self.params.insert("wedgemethod".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_wedgemethod_expr(mut self, expr: &str) -> Self {
        self.params.insert("wedgemethod".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_roottake(mut self, val: &str) -> Self {
        self.params.insert("roottake".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_roottake_expr(mut self, expr: &str) -> Self {
        self.params.insert("roottake".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_chan_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("chan{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_chan_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("chan{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_blockbackground(mut self, val: bool) -> Self {
        self.params.insert("blockbackground".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_blockbackground_expr(mut self, expr: &str) -> Self {
        self.params.insert("blockbackground".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_random(mut self, val: bool) -> Self {
        self.params.insert("random".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_random_expr(mut self, expr: &str) -> Self {
        self.params.insert("random".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
