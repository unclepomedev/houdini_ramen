...
impl DriverGeo2i3d {
    ...
    pub fn with_trange(mut self, val: DriverGeo2i3dTrange) -> Self {
        self.params.insert("trange".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
...
impl crate::core::types::HoudiniNode for DriverGeo2i3d {
...
impl crate::core::types::HoudiniNode for DriverGeometry {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl DriverGeometryraw {
    ...
    pub fn with_fval_inst(mut self, index1: usize, val: f32) -> Self {
        self.params.insert(format!("fval{}", index1), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_fval_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("fval{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_tuplesize_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("tuplesize{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_tuplesize_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("tuplesize{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_ival_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("ival{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_ival_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("ival{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_saveretry(mut self, val: i32) -> Self {
        self.params.insert("saveretry".to_string(), crate::core::types::ParamValue::Int(val));
    ...
    pub fn with_endian(mut self, val: DriverGeometryrawEndian) -> Self {
        self.params.insert("endian".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_endian_expr(mut self, expr: &str) -> Self {
        self.params.insert("endian".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_target_inst(mut self, index1: usize, val: DriverGeometryrawTarget) -> Self {
        self.params.insert(format!("target{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    ...
    pub fn with_volorder_inst(mut self, index1: usize, val: DriverGeometryrawVolorder) -> Self {
        self.params.insert(format!("volorder{}", index1), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_volorder_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("volorder{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_bfloat_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("bfloat{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_bfloat_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("bfloat{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_collate_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("collate{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_collate_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("collate{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mkpath(mut self, val: bool) -> Self {
        self.params.insert("mkpath".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl crate::core::types::HoudiniNode for DriverGeometryraw {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for DriverGltf {
    fn get_id(&self) -> usize {
        self.id
    }
