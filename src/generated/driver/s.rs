...
impl DriverShell {
    ...
    pub fn with_shellexec(mut self, val: bool) -> Self {
        self.params.insert("shellexec".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_shellexec_expr(mut self, expr: &str) -> Self {
        self.params.insert("shellexec".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for DriverShell {
...
impl crate::core::types::HoudiniNode for DriverShopnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for DriverSopnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for DriverSubnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for DriverSwitch {
    fn get_id(&self) -> usize {
        self.id
    }
