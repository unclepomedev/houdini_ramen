...
impl LopInlineusd {
    ...
    pub fn with_usdsource(mut self, val: &str) -> Self {
        self.params.insert("usdsource".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_usdsource_expr(mut self, expr: &str) -> Self {
        self.params.insert("usdsource".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_allowediting(mut self, val: bool) -> Self {
        self.params.insert("allowediting".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_allowediting_expr(mut self, expr: &str) -> Self {
        self.params.insert("allowediting".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl LopInsertionpoint {
    ...
    pub fn with_descriptor(mut self, val: &str) -> Self {
        self.params.insert("descriptor".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_descriptor_expr(mut self, expr: &str) -> Self {
        self.params.insert("descriptor".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl LopInstancer {
    ...
    pub fn set_input_possible_prototype_source<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Possible Prototype Source" and specifies the output index of the target node.
    pub fn set_input_possible_prototype_source_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_pruneamount(mut self, val: f32) -> Self {
        self.params.insert("pruneamount".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_pruneamount_expr(mut self, expr: &str) -> Self {
        self.params.insert("pruneamount".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_locationpattern(mut self, val: &str) -> Self {
        self.params.insert("locationpattern".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_locationpattern_expr(mut self, expr: &str) -> Self {
        self.params.insert("locationpattern".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_prunemode(mut self, val: &str) -> Self {
        self.params.insert("prunemode".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_prunemode_expr(mut self, expr: &str) -> Self {
        self.params.insert("prunemode".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_instancename(mut self, val: &str) -> Self {
        self.params.insert("instancename".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_instancename_expr(mut self, expr: &str) -> Self {
        self.params.insert("instancename".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_protosourcemode(mut self, val: &str) -> Self {
        self.params.insert("protosourcemode".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_protosourcemode_expr(mut self, expr: &str) -> Self {
        self.params.insert("protosourcemode".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_protoreftype(mut self, val: &str) -> Self {
        self.params.insert("protoreftype".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_protoreftype_expr(mut self, expr: &str) -> Self {
        self.params.insert("protoreftype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_handlemissingprototypes(mut self, val: &str) -> Self {
        self.params.insert("handlemissingprototypes".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_handlemissingprototypes_expr(mut self, expr: &str) -> Self {
        self.params.insert("handlemissingprototypes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_protorootkind(mut self, val: &str) -> Self {
        self.params.insert("protorootkind".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_protorootkind_expr(mut self, expr: &str) -> Self {
        self.params.insert("protorootkind".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_protoindexsrc(mut self, val: &str) -> Self {
        self.params.insert("protoindexsrc".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_protoindexsrc_expr(mut self, expr: &str) -> Self {
        self.params.insert("protoindexsrc".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_indexattr(mut self, val: &str) -> Self {
        self.params.insert("indexattr".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_indexattr_expr(mut self, expr: &str) -> Self {
        self.params.insert("indexattr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_nameattr(mut self, val: &str) -> Self {
        self.params.insert("nameattr".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_nameattr_expr(mut self, expr: &str) -> Self {
        self.params.insert("nameattr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_setorient(mut self, val: bool) -> Self {
        self.params.insert("setorient".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_setorient_expr(mut self, expr: &str) -> Self {
        self.params.insert("setorient".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_setscale(mut self, val: bool) -> Self {
        self.params.insert("setscale".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_setscale_expr(mut self, expr: &str) -> Self {
        self.params.insert("setscale".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_hidesourceprims(mut self, val: bool) -> Self {
        self.params.insert("hidesourceprims".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_hidesourceprims_expr(mut self, expr: &str) -> Self {
        self.params.insert("hidesourceprims".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_createprotoarea(mut self, val: bool) -> Self {
        self.params.insert("createprotoarea".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_createprotoarea_expr(mut self, expr: &str) -> Self {
        self.params.insert("createprotoarea".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_hideprotosourceprims(mut self, val: bool) -> Self {
        self.params.insert("hideprotosourceprims".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_hideprotosourceprims_expr(mut self, expr: &str) -> Self {
        self.params.insert("hideprotosourceprims".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_protouseroot(mut self, val: bool) -> Self {
        self.params.insert("protouseroot".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_protouseroot_expr(mut self, expr: &str) -> Self {
        self.params.insert("protouseroot".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_onlycopyprotoprims(mut self, val: bool) -> Self {
        self.params.insert("onlycopyprotoprims".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_onlycopyprotoprims_expr(mut self, expr: &str) -> Self {
        self.params.insert("onlycopyprotoprims".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_allowmissingprototypes(mut self, val: bool) -> Self {
        self.params.insert("allowmissingprototypes".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_allowmissingprototypes_expr(mut self, expr: &str) -> Self {
        self.params.insert("allowmissingprototypes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_warnonskipped(mut self, val: bool) -> Self {
        self.params.insert("warnonskipped".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_warnonskipped_expr(mut self, expr: &str) -> Self {
        self.params.insert("warnonskipped".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl LopIsolatescene {
    ...
    pub fn with_cameratime(mut self, val: f32) -> Self {
        self.params.insert("cameratime".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_cameratime_expr(mut self, expr: &str) -> Self {
        self.params.insert("cameratime".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_camerapad(mut self, val: f32) -> Self {
        self.params.insert("camerapad".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_camerapad_expr(mut self, expr: &str) -> Self {
        self.params.insert("camerapad".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_excludepattern(mut self, val: &str) -> Self {
        self.params.insert("excludepattern".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_excludepattern_expr(mut self, expr: &str) -> Self {
        self.params.insert("excludepattern".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_maskedpayloads(mut self, val: bool) -> Self {
        self.params.insert("maskedpayloads".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_maskedpayloads_expr(mut self, expr: &str) -> Self {
        self.params.insert("maskedpayloads".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_docambounds(mut self, val: bool) -> Self {
        self.params.insert("docambounds".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_docambounds_expr(mut self, expr: &str) -> Self {
        self.params.insert("docambounds".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_newlayerforedits(mut self, val: bool) -> Self {
        self.params.insert("newlayerforedits".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_newlayerforedits_expr(mut self, expr: &str) -> Self {
        self.params.insert("newlayerforedits".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl<'a> LopIsolatesceneInnerExt for crate::core::graph::InnerGraph<'a> {
    fn output0(&mut self) -> crate::core::graph::ExistingNodeRef {
        self.get_existing_node("edits/output0")
    }
}
