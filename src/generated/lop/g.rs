...
impl LopGraftbranches {
    ...
    pub fn set_input_source_for_grafting<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
    ) -> Self {
        self.inputs.insert(
    ...
    pub fn set_input_source_for_grafting_from<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
        output_index: usize,
    ) -> Self {
    ...
    pub fn set_input_source_for_grafting_by_name<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
        port_name: &str,
    ) -> Self {
