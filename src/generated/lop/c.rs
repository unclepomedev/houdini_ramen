...
impl LopComponentmaterial {
    ...
    pub fn set_input_materials(mut self, target: &dyn crate::core::types::HoudiniNode) -> Self {
        self.base.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Materials" and specifies the output index of the target node.
    pub fn set_input_materials_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl LopComponentoutput {
    ...
    pub fn set_input_thumbnail_scene(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(1, (target.get_id(), 0));
    ...
    pub fn set_input_thumbnail_scene_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
