...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum LopObjnetUparmtype {
    Uniform = 0,
    ArcLength = 1,
}

#[derive(Debug, Clone)]
pub struct LopObjnet {
    pub id: usize,
    pub name: String,
...
impl LopObjnet {
    ...
    // --- Menu parameters ---
    pub fn with_xord(mut self, val: LopObjnetXord) -> Self {
    ...
    pub fn with_rord(mut self, val: LopObjnetRord) -> Self {
    ...
    pub fn with_pre_xform(mut self, val: LopObjnetPreXform) -> Self {
    ...
    pub fn with_uparmtype(mut self, val: LopObjnetUparmtype) -> Self {
...
impl crate::core::types::HoudiniNode for LopObjnet {
...
impl LopOutput {
    ...
    // --- String parameters ---
    pub fn with_modifiedprims(mut self, val: &str) -> Self {
        self.params.insert("modifiedprims".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_modifiedprims_expr(mut self, expr: &str) -> Self {
        self.params.insert("modifiedprims".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}

impl crate::core::types::HoudiniNode for LopOutput {
    fn get_id(&self) -> usize {
        self.id
    }
