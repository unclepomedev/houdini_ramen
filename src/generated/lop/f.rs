...
impl crate::core::types::HoudiniNode for LopFetch {
...
impl LopFilecache {
    ...
    pub fn with_specificrange(mut self, val: &str) -> Self {
        self.params.insert("specificrange".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_specificrange_expr(mut self, expr: &str) -> Self {
        self.params.insert("specificrange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_enableoutputprocessor_savepathsrelativetooutput(mut self, val: bool) -> Self {
        self.params.insert("enableoutputprocessor_savepathsrelativetooutput".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enableoutputprocessor_savepathsrelativetooutput_expr(mut self, expr: &str) -> Self {
        self.params.insert("enableoutputprocessor_savepathsrelativetooutput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enableoutputprocessor_usesearchpaths(mut self, val: bool) -> Self {
        self.params.insert("enableoutputprocessor_usesearchpaths".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enableoutputprocessor_usesearchpaths_expr(mut self, expr: &str) -> Self {
        self.params.insert("enableoutputprocessor_usesearchpaths".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enableoutputprocessor_matchoutputextension(mut self, val: bool) -> Self {
        self.params.insert("enableoutputprocessor_matchoutputextension".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enableoutputprocessor_matchoutputextension_expr(mut self, expr: &str) -> Self {
        self.params.insert("enableoutputprocessor_matchoutputextension".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_savebackuphip(mut self, val: bool) -> Self {
        self.params.insert("savebackuphip".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_savebackuphip_expr(mut self, expr: &str) -> Self {
        self.params.insert("savebackuphip".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_savethumbnails(mut self, val: bool) -> Self {
        self.params.insert("savethumbnails".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_savethumbnails_expr(mut self, expr: &str) -> Self {
        self.params.insert("savethumbnails".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for LopFilecache {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl LopFollowpathconstraint {
    ...
    pub fn with_doposition(mut self, val: bool) -> Self {
        self.params.insert("doposition".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_doposition_expr(mut self, expr: &str) -> Self {
        self.params.insert("doposition".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_dorotation(mut self, val: bool) -> Self {
        self.params.insert("dorotation".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_dorotation_expr(mut self, expr: &str) -> Self {
        self.params.insert("dorotation".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_doshear(mut self, val: bool) -> Self {
        self.params.insert("doshear".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_doshear_expr(mut self, expr: &str) -> Self {
        self.params.insert("doshear".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for LopFollowpathconstraint {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl LopForeach {
    ...
    pub fn set_input_possible_iteration_data<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Possible Iteration Data" and specifies the output index of the target node.
    pub fn set_input_possible_iteration_data_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }

    /// Connects to input 2: "Iterate On This Input"
    pub fn set_input_iterate_on_this_input<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
    ...
    pub fn set_input_iterate_on_this_input_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_firstiteration(mut self, val: i32) -> Self {
        self.params.insert("firstiteration".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_firstiteration_expr(mut self, expr: &str) -> Self {
        self.params.insert("firstiteration".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_lastiteration(mut self, val: i32) -> Self {
        self.params.insert("lastiteration".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_lastiteration_expr(mut self, expr: &str) -> Self {
        self.params.insert("lastiteration".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- String parameters ---
    pub fn with_itermethod(mut self, val: &str) -> Self {
        self.params.insert("itermethod".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_strings(mut self, val: &str) -> Self {
        self.params.insert("strings".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_strings_expr(mut self, expr: &str) -> Self {
        self.params.insert("strings".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_combineiterations(mut self, val: &str) -> Self {
        self.params.insert("combineiterations".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_combineiterations_expr(mut self, expr: &str) -> Self {
        self.params.insert("combineiterations".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_iterationname(mut self, val: &str) -> Self {
        self.params.insert("iterationname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_iterationname_expr(mut self, expr: &str) -> Self {
        self.params.insert("iterationname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_iterationcountname(mut self, val: &str) -> Self {
        self.params.insert("iterationcountname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_iterationcountname_expr(mut self, expr: &str) -> Self {
        self.params.insert("iterationcountname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_valuename(mut self, val: &str) -> Self {
        self.params.insert("valuename".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_valuename_expr(mut self, expr: &str) -> Self {
        self.params.insert("valuename".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_iterrange(mut self, val: &str) -> Self {
        self.params.insert("iterrange".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_iterrange_expr(mut self, expr: &str) -> Self {
        self.params.insert("iterrange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_allowinstanceproxies(mut self, val: bool) -> Self {
        self.params.insert("allowinstanceproxies".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_allowinstanceproxies_expr(mut self, expr: &str) -> Self {
        self.params.insert("allowinstanceproxies".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_striplayerbreaks(mut self, val: bool) -> Self {
        self.params.insert("striplayerbreaks".to_string(), crate::core::types::ParamValue::Toggle(val));
    ...
    pub fn with_lastmodifiedfromiteration(mut self, val: bool) -> Self {
        self.params.insert("lastmodifiedfromiteration".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_lastmodifiedfromiteration_expr(mut self, expr: &str) -> Self {
        self.params.insert("lastmodifiedfromiteration".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_mergeloadmasks(mut self, val: bool) -> Self {
        self.params.insert("mergeloadmasks".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_mergeloadmasks_expr(mut self, expr: &str) -> Self {
        self.params.insert("mergeloadmasks".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}

impl crate::core::types::HoudiniNode for LopForeach {
    fn get_id(&self) -> usize {
        self.id
    }
