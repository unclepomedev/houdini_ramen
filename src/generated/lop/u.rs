#[derive(Debug, Clone)]
pub struct LopUnassignmaterial {
    pub id: usize,
    pub name: String,
...
impl LopUnassignmaterial {
    ...
    // --- Int parameters ---
    pub fn with_nummat_inst(mut self, index1: usize, val: i32) -> Self {
        self.params.insert(format!("nummat{}", index1), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_nummat_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("nummat{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_action_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("action{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_action_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("action{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_bindpurpose_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("bindpurpose{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_bindpurpose_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("bindpurpose{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for LopUnassignmaterial {
...
impl LopUsdRop {
    ...
    // --- Menu parameters ---
    pub fn with_trange(mut self, val: LopUsdRopTrange) -> Self {
...
impl crate::core::types::HoudiniNode for LopUsdRop {
    fn get_id(&self) -> usize {
        self.id
    }
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum LopUsdrenderRopTrange {
    RenderCurrentFrame = 0,
    RenderSpecificFrameRange = 1,
    /// Render Specific Frame Range Only (Strict)
    RenderSpecificFrameRangeOnlyStrict = 2,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum LopUsdrenderRopResScaleMenu {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum LopUsdrenderRopHuskMplayzoommenu {
    /// 1/10 (One Tenth Resolution)
    N110OneTenthResolution = 0,
    /// 1/5 (One Fifth Resolution)
    N15OneFifthResolution = 1,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum LopUsdrenderRopVerboseMenu {
    None = 0,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum LopUsdrenderRopVexprofile {
    NoVexProfiling = 0,
...
impl LopUsdrenderRop {
    ...
    pub fn with_vexprofile(mut self, val: LopUsdrenderRopVexprofile) -> Self {
    ...
    // --- Menu parameters ---
    pub fn with_trange(mut self, val: LopUsdrenderRopTrange) -> Self {
        self.params.insert("trange".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_trange_expr(mut self, expr: &str) -> Self {
    ...
    pub fn with_res_scale_menu(mut self, val: LopUsdrenderRopResScaleMenu) -> Self {
    ...
    pub fn with_husk_mplayzoommenu(mut self, val: LopUsdrenderRopHuskMplayzoommenu) -> Self {
    ...
    pub fn with_verbose_menu(mut self, val: LopUsdrenderRopVerboseMenu) -> Self {
    ...
    pub fn with_renderexisting(mut self, val: &str) -> Self {
        self.params.insert("renderexisting".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_renderexisting_expr(mut self, expr: &str) -> Self {
        self.params.insert("renderexisting".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_dorenderexisting(mut self, val: bool) -> Self {
        self.params.insert("dorenderexisting".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_dorenderexisting_expr(mut self, expr: &str) -> Self {
        self.params.insert("dorenderexisting".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_renderexistingandsaveusd(mut self, val: bool) -> Self {
        self.params.insert("renderexistingandsaveusd".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_renderexistingandsaveusd_expr(mut self, expr: &str) -> Self {
        self.params.insert("renderexistingandsaveusd".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for LopUsdrenderRop {
    fn get_id(&self) -> usize {
        self.id
    }
