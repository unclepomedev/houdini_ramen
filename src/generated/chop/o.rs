...
impl ChopObject {
    ...
    /// Connects to input 0: "XYZ Target"
    pub fn set_input_xyz_target<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "XYZ Target" and specifies the output index of the target node.
    pub fn set_input_xyz_target_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }

    /// Connects to input 1: "XYZ Reference"
    pub fn set_input_xyz_reference<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "XYZ Reference" and specifies the output index of the target node.
    pub fn set_input_xyz_reference_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_bearing(mut self, val: [f32; 3]) -> Self {
        self.params.insert("bearing".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_bearing_expr(mut self, expr: &str) -> Self {
        self.params.insert("bearing".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_compute(mut self, val: ChopObjectCompute) -> Self {
        self.params.insert("compute".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    ...
    pub fn with_bearingref(mut self, val: ChopObjectBearingref) -> Self {
        self.params.insert("bearingref".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_bearingref_expr(mut self, expr: &str) -> Self {
        self.params.insert("bearingref".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_usereflength(mut self, val: bool) -> Self {
        self.params.insert("usereflength".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usereflength_expr(mut self, expr: &str) -> Self {
        self.params.insert("usereflength".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for ChopObject {
...
impl ChopObjectchain {
    ...
    pub fn with_startpath(mut self, val: &str) -> Self {
        self.params.insert("startpath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_startpath_expr(mut self, expr: &str) -> Self {
        self.params.insert("startpath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_endpath(mut self, val: &str) -> Self {
        self.params.insert("endpath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_endpath_expr(mut self, expr: &str) -> Self {
        self.params.insert("endpath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_useendobject(mut self, val: bool) -> Self {
        self.params.insert("useendobject".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useendobject_expr(mut self, expr: &str) -> Self {
        self.params.insert("useendobject".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_includerootsubnet(mut self, val: bool) -> Self {
        self.params.insert("includerootsubnet".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_includerootsubnet_expr(mut self, expr: &str) -> Self {
        self.params.insert("includerootsubnet".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_fetchpretransform(mut self, val: bool) -> Self {
        self.params.insert("fetchpretransform".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_fetchpretransform_expr(mut self, expr: &str) -> Self {
        self.params.insert("fetchpretransform".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_fetchbonerest(mut self, val: bool) -> Self {
        self.params.insert("fetchbonerest".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_fetchbonerest_expr(mut self, expr: &str) -> Self {
        self.params.insert("fetchbonerest".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_fetchboneconstraint(mut self, val: bool) -> Self {
        self.params.insert("fetchboneconstraint".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_fetchboneconstraint_expr(mut self, expr: &str) -> Self {
        self.params.insert("fetchboneconstraint".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_fetchlocal(mut self, val: bool) -> Self {
        self.params.insert("fetchlocal".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_fetchlocal_expr(mut self, expr: &str) -> Self {
        self.params.insert("fetchlocal".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_timeslice(mut self, val: bool) -> Self {
        self.params.insert("timeslice".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl crate::core::types::HoudiniNode for ChopObjectchain {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for ChopObjnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl ChopOscillator {
    ...
    /// Connects to input 0: "Pitch Control"
    pub fn set_input_pitch_control<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Pitch Control" and specifies the output index of the target node.
    pub fn set_input_pitch_control_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    /// Connects to input 2: "Playback Source"
    pub fn set_input_playback_source<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(2, (target.get_id(), 0));
        self
    }

    /// Connects to input 2: "Playback Source" and specifies the output index of the target node.
    pub fn set_input_playback_source_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_octave(mut self, val: f32) -> Self {
        self.params.insert("octave".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_octave_expr(mut self, expr: &str) -> Self {
        self.params.insert("octave".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for ChopOscillator {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for ChopOutput {
    fn get_id(&self) -> usize {
        self.id
    }
