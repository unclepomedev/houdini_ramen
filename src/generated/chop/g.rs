...
impl ChopGamepad {
    ...
    pub fn with_deadzone(mut self, val: f32) -> Self {
        self.params.insert("deadzone".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_deadzone_expr(mut self, expr: &str) -> Self {
        self.params.insert("deadzone".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_buttons(mut self, val: &str) -> Self {
        self.params.insert("buttons".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_buttons_expr(mut self, expr: &str) -> Self {
        self.params.insert("buttons".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_trackballs(mut self, val: &str) -> Self {
        self.params.insert("trackballs".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_trackballs_expr(mut self, expr: &str) -> Self {
        self.params.insert("trackballs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_povhats(mut self, val: &str) -> Self {
        self.params.insert("povhats".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_povhats_expr(mut self, expr: &str) -> Self {
        self.params.insert("povhats".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_lsx(mut self, val: &str) -> Self {
        self.params.insert("lsx".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_lsx_expr(mut self, expr: &str) -> Self {
        self.params.insert("lsx".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_lsy(mut self, val: &str) -> Self {
        self.params.insert("lsy".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_lsy_expr(mut self, expr: &str) -> Self {
        self.params.insert("lsy".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rsx(mut self, val: &str) -> Self {
        self.params.insert("rsx".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_rsx_expr(mut self, expr: &str) -> Self {
        self.params.insert("rsx".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rsy(mut self, val: &str) -> Self {
        self.params.insert("rsy".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_rsy_expr(mut self, expr: &str) -> Self {
        self.params.insert("rsy".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_lt(mut self, val: &str) -> Self {
        self.params.insert("lt".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_lt_expr(mut self, expr: &str) -> Self {
        self.params.insert("lt".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rt(mut self, val: &str) -> Self {
        self.params.insert("rt".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_lb(mut self, val: &str) -> Self {
        self.params.insert("lb".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_lb_expr(mut self, expr: &str) -> Self {
        self.params.insert("lb".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rb(mut self, val: &str) -> Self {
        self.params.insert("rb".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_rb_expr(mut self, expr: &str) -> Self {
        self.params.insert("rb".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_lsd(mut self, val: &str) -> Self {
        self.params.insert("lsd".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_lsd_expr(mut self, expr: &str) -> Self {
        self.params.insert("lsd".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rsd(mut self, val: &str) -> Self {
        self.params.insert("rsd".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_rsd_expr(mut self, expr: &str) -> Self {
        self.params.insert("rsd".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_dpad(mut self, val: &str) -> Self {
        self.params.insert("dpad".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_dpad_expr(mut self, expr: &str) -> Self {
        self.params.insert("dpad".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_actionbtns(mut self, val: &str) -> Self {
        self.params.insert("actionbtns".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_actionbtns_expr(mut self, expr: &str) -> Self {
        self.params.insert("actionbtns".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_back(mut self, val: &str) -> Self {
        self.params.insert("back".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_guide(mut self, val: &str) -> Self {
        self.params.insert("guide".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_startbtn(mut self, val: &str) -> Self {
        self.params.insert("startbtn".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_startbtn_expr(mut self, expr: &str) -> Self {
        self.params.insert("startbtn".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl ChopGeometry {
    ...
    pub fn with_ovalue(mut self, val: f32) -> Self {
        self.params.insert("ovalue".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_ovalue_expr(mut self, expr: &str) -> Self {
        self.params.insert("ovalue".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_start(mut self, val: f32) -> Self {
        self.params.insert("start".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_omethod(mut self, val: ChopGeometryOmethod) -> Self {
        self.params.insert("omethod".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_omethod_expr(mut self, expr: &str) -> Self {
        self.params.insert("omethod".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_attribscope(mut self, val: &str) -> Self {
        self.params.insert("attribscope".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_attribscope_expr(mut self, expr: &str) -> Self {
        self.params.insert("attribscope".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_matrixattributes(mut self, val: &str) -> Self {
        self.params.insert("matrixattributes".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_matrixattributes_expr(mut self, expr: &str) -> Self {
        self.params.insert("matrixattributes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_renamescope(mut self, val: &str) -> Self {
        self.params.insert("renamescope".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_renamescope_expr(mut self, expr: &str) -> Self {
        self.params.insert("renamescope".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_transpath(mut self, val: &str) -> Self {
        self.params.insert("transpath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_transpath_expr(mut self, expr: &str) -> Self {
        self.params.insert("transpath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_organize(mut self, val: &str) -> Self {
        self.params.insert("organize".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_organize_expr(mut self, expr: &str) -> Self {
        self.params.insert("organize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pointnames(mut self, val: &str) -> Self {
        self.params.insert("pointnames".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_pointnames_expr(mut self, expr: &str) -> Self {
        self.params.insert("pointnames".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_scope(mut self, val: &str) -> Self {
        self.params.insert("scope".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_outputshearchannels(mut self, val: bool) -> Self {
        self.params.insert("outputshearchannels".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_outputshearchannels_expr(mut self, expr: &str) -> Self {
        self.params.insert("outputshearchannels".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_timeslice(mut self, val: bool) -> Self {
        self.params.insert("timeslice".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl ChopGesture {
    ...
    pub fn set_input_gesture_source<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Gesture Source" and specifies the output index of the target node.
    pub fn set_input_gesture_source_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn set_input_listen_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_lblend(mut self, val: f32) -> Self {
        self.params.insert("lblend".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_lblend_expr(mut self, expr: &str) -> Self {
        self.params.insert("lblend".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_gcolorstep(mut self, val: f32) -> Self {
        self.params.insert("gcolorstep".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_numbeats(mut self, val: i32) -> Self {
        self.params.insert("numbeats".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_numbeats_expr(mut self, expr: &str) -> Self {
        self.params.insert("numbeats".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_fitmethod(mut self, val: ChopGestureFitmethod) -> Self {
        self.params.insert("fitmethod".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_fitmethod_expr(mut self, expr: &str) -> Self {
        self.params.insert("fitmethod".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_fitbeat(mut self, val: ChopGestureFitbeat) -> Self {
        self.params.insert("fitbeat".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_fitbeat_expr(mut self, expr: &str) -> Self {
        self.params.insert("fitbeat".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_usegain(mut self, val: bool) -> Self {
        self.params.insert("usegain".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usegain_expr(mut self, expr: &str) -> Self {
        self.params.insert("usegain".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_timeslice(mut self, val: bool) -> Self {
        self.params.insert("timeslice".to_string(), crate::core::types::ParamValue::Toggle(val));
