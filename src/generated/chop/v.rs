...
impl ChopVector {
    ...
    pub fn set_input_a_vectors_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn set_input_b_vectors_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }

    /// Connects to input 2: "C vectors (compare)"
    pub fn set_input_c_vectors_compare<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
    ...
    pub fn set_input_c_vectors_compare_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_passfraction(mut self, val: f32) -> Self {
        self.params.insert("passfraction".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_passfraction_expr(mut self, expr: &str) -> Self {
        self.params.insert("passfraction".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vectorconstant(mut self, val: [f32; 4]) -> Self {
        self.params.insert("vectorconstant".to_string(), crate::core::types::ParamValue::Float4(val));
        self
    }
    pub fn with_vectorconstant_expr(mut self, expr: &str) -> Self {
        self.params.insert("vectorconstant".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vectorcompare(mut self, val: ChopVectorVectorcompare) -> Self {
        self.params.insert("vectorcompare".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_vectorcompare_expr(mut self, expr: &str) -> Self {
        self.params.insert("vectorcompare".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vectortarget(mut self, val: ChopVectorVectortarget) -> Self {
        self.params.insert("vectortarget".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_vectortarget_expr(mut self, expr: &str) -> Self {
        self.params.insert("vectortarget".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vectorresult(mut self, val: ChopVectorVectorresult) -> Self {
        self.params.insert("vectorresult".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_vectorresult_expr(mut self, expr: &str) -> Self {
        self.params.insert("vectorresult".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_pass(mut self, val: ChopVectorPass) -> Self {
        self.params.insert("pass".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_pass_expr(mut self, expr: &str) -> Self {
        self.params.insert("pass".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vectormask(mut self, val: &str) -> Self {
        self.params.insert("vectormask".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vectormask_expr(mut self, expr: &str) -> Self {
        self.params.insert("vectormask".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vectormaskb(mut self, val: &str) -> Self {
        self.params.insert("vectormaskb".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vectormaskb_expr(mut self, expr: &str) -> Self {
        self.params.insert("vectormaskb".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vectormaskc(mut self, val: &str) -> Self {
        self.params.insert("vectormaskc".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vectormaskc_expr(mut self, expr: &str) -> Self {
        self.params.insert("vectormaskc".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_usebmask(mut self, val: bool) -> Self {
        self.params.insert("usebmask".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usebmask_expr(mut self, expr: &str) -> Self {
        self.params.insert("usebmask".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_usecmask(mut self, val: bool) -> Self {
        self.params.insert("usecmask".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_usecmask_expr(mut self, expr: &str) -> Self {
        self.params.insert("usecmask".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vectortest(mut self, val: bool) -> Self {
        self.params.insert("vectortest".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_vectortest_expr(mut self, expr: &str) -> Self {
        self.params.insert("vectortest".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl ChopVoicesplit {
    ...
    pub fn set_input_audio_source<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Audio Source" and specifies the output index of the target node.
    pub fn set_input_audio_source_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_sillevel(mut self, val: f32) -> Self {
        self.params.insert("sillevel".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_sillevel_expr(mut self, expr: &str) -> Self {
        self.params.insert("sillevel".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_minpause(mut self, val: f32) -> Self {
        self.params.insert("minpause".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_minpause_expr(mut self, expr: &str) -> Self {
        self.params.insert("minpause".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_minword(mut self, val: f32) -> Self {
        self.params.insert("minword".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_minword_expr(mut self, expr: &str) -> Self {
        self.params.insert("minword".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_gcolorstep(mut self, val: f32) -> Self {
        self.params.insert("gcolorstep".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_names(mut self, val: &str) -> Self {
        self.params.insert("names".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_names_expr(mut self, expr: &str) -> Self {
        self.params.insert("names".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_scope(mut self, val: &str) -> Self {
        self.params.insert("scope".to_string(), crate::core::types::ParamValue::String(val.to_string()));
...
impl ChopVoicesync {
    ...
    pub fn set_input_voiced_phonemes<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Voiced Phonemes" and specifies the output index of the target node.
    pub fn set_input_voiced_phonemes_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }

    /// Connects to input 2: "Non-Voiced Phonemes"
    pub fn set_input_non_voiced_phonemes<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(2, (target.get_id(), 0));
        self
    }

    /// Connects to input 2: "Non-Voiced Phonemes" and specifies the output index of the target node.
    pub fn set_input_non_voiced_phonemes_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(2, (target.get_id(), output_index));
        self
    }
    ...
    pub fn trigger_setup(mut self) -> Self {
        self.params.insert("setup".to_string(), crate::core::types::ParamValue::Button);
        self
    }

    // --- Float parameters ---
    pub fn with_silencelevel(mut self, val: f32) -> Self {
        self.params.insert("silencelevel".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_silencelevel_expr(mut self, expr: &str) -> Self {
        self.params.insert("silencelevel".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_maxshift(mut self, val: f32) -> Self {
        self.params.insert("maxshift".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_maxshift_expr(mut self, expr: &str) -> Self {
        self.params.insert("maxshift".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_minscore(mut self, val: f32) -> Self {
        self.params.insert("minscore".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_minscore_expr(mut self, expr: &str) -> Self {
        self.params.insert("minscore".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_supersamp(mut self, val: f32) -> Self {
        self.params.insert("supersamp".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_supersamp_expr(mut self, expr: &str) -> Self {
        self.params.insert("supersamp".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_spot(mut self, val: f32) -> Self {
        self.params.insert("spot".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_spot_expr(mut self, expr: &str) -> Self {
        self.params.insert("spot".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_gcolorstep(mut self, val: f32) -> Self {
        self.params.insert("gcolorstep".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_noisefilter(mut self, val: i32) -> Self {
        self.params.insert("noisefilter".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_noisefilter_expr(mut self, expr: &str) -> Self {
        self.params.insert("noisefilter".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Int2 parameters ---
    pub fn with_vocalrange(mut self, val: [i32; 2]) -> Self {
        self.params.insert("vocalrange".to_string(), crate::core::types::ParamValue::Int2(val));
        self
    }
    pub fn with_vocalrange_expr(mut self, expr: &str) -> Self {
        self.params.insert("vocalrange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_quality(mut self, val: ChopVoicesyncQuality) -> Self {
        self.params.insert("quality".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    ...
    pub fn with_silencename(mut self, val: &str) -> Self {
        self.params.insert("silencename".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_silencename_expr(mut self, expr: &str) -> Self {
        self.params.insert("silencename".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_scope(mut self, val: &str) -> Self {
        self.params.insert("scope".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_convert(mut self, val: bool) -> Self {
        self.params.insert("convert".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    ...
    pub fn with_testpeaks(mut self, val: bool) -> Self {
        self.params.insert("testpeaks".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_testpeaks_expr(mut self, expr: &str) -> Self {
        self.params.insert("testpeaks".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_timeslice(mut self, val: bool) -> Self {
        self.params.insert("timeslice".to_string(), crate::core::types::ParamValue::Toggle(val));
...
impl ChopVopchop {
    ...
    pub fn with_vex_iterate_step(mut self, val: i32) -> Self {
        self.params.insert("vex_iterate_step".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_vex_iterate_step_expr(mut self, expr: &str) -> Self {
        self.params.insert("vex_iterate_step".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Menu parameters ---
    pub fn with_vex_iterate(mut self, val: ChopVopchopVexIterate) -> Self {
        self.params.insert("vex_iterate".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_vex_iterate_expr(mut self, expr: &str) -> Self {
        self.params.insert("vex_iterate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vex_iterate_names(mut self, val: &str) -> Self {
        self.params.insert("vex_iterate_names".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vex_iterate_names_expr(mut self, expr: &str) -> Self {
        self.params.insert("vex_iterate_names".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
