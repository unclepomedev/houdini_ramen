...
impl ChopVector {
    ...
    pub fn set_input_a_vectors(mut self, target: &dyn crate::core::types::HoudiniNode) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "A vectors" and specifies the output index of the target node.
    pub fn set_input_a_vectors_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
    ...
    pub fn set_input_c_vectors_compare(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
    ...
    pub fn set_input_c_vectors_compare_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl ChopVoicesplit {
    ...
    pub fn set_input_audio_source(mut self, target: &dyn crate::core::types::HoudiniNode) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Audio Source" and specifies the output index of the target node.
    pub fn set_input_audio_source_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl ChopVoicesync {
    ...
    pub fn set_input_voiced_phonemes(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(1, (target.get_id(), 0));
    ...
    pub fn set_input_voiced_phonemes_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
    ...
    pub fn set_input_non_voiced_phonemes(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(2, (target.get_id(), 0));
    ...
    pub fn set_input_non_voiced_phonemes_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
