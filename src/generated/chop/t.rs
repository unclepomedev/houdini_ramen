...
impl ChopTimerange {
    ...
    pub fn with_cachetimerange(mut self, val: bool) -> Self {
        self.params.insert("cachetimerange".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_cachetimerange_expr(mut self, expr: &str) -> Self {
        self.params.insert("cachetimerange".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl ChopTimeshift {
    ...
    pub fn with_timeshift(mut self, val: f32) -> Self {
        self.params.insert("timeshift".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_timeshift_expr(mut self, expr: &str) -> Self {
        self.params.insert("timeshift".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_gcolorstep(mut self, val: f32) -> Self {
        self.params.insert("gcolorstep".to_string(), crate::core::types::ParamValue::Float(val));
    ...
    pub fn with_recomputeinput(mut self, val: bool) -> Self {
        self.params.insert("recomputeinput".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_recomputeinput_expr(mut self, expr: &str) -> Self {
        self.params.insert("recomputeinput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_timeslice(mut self, val: bool) -> Self {
        self.params.insert("timeslice".to_string(), crate::core::types::ParamValue::Toggle(val));
...
#[allow(clippy::wrong_self_convention)]
impl<'a> ChopTopnetInnerExt for crate::core::graph::InnerGraph<'a> {
    fn localscheduler(&mut self) -> crate::core::graph::ExistingNodeRef {
...
impl ChopTransform {
    ...
    pub fn set_input_optional_transform_channels<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Optional Transform Channels" and specifies the output index of the target node.
    pub fn set_input_optional_transform_channels_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_out(mut self, val: ChopTransformOut) -> Self {
        self.params.insert("out".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_out_expr(mut self, expr: &str) -> Self {
        self.params.insert("out".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_matop(mut self, val: ChopTransformMatop) -> Self {
        self.params.insert("matop".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_matop_expr(mut self, expr: &str) -> Self {
        self.params.insert("matop".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_inxord(mut self, val: ChopTransformInxord) -> Self {
        self.params.insert("inxOrd".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_inxord_expr(mut self, expr: &str) -> Self {
        self.params.insert("inxOrd".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_inrord(mut self, val: ChopTransformInrord) -> Self {
        self.params.insert("inrOrd".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_inrord_expr(mut self, expr: &str) -> Self {
        self.params.insert("inrOrd".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl ChopTransformchain {
    ...
    pub fn with_outp(mut self, val: [f32; 3]) -> Self {
        self.params.insert("outp".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_outp_expr(mut self, expr: &str) -> Self {
        self.params.insert("outp".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_hint(mut self, val: [f32; 3]) -> Self {
        self.params.insert("hint".to_string(), crate::core::types::ParamValue::Float3(val));
    ...
    pub fn with_outxord(mut self, val: ChopTransformchainOutxord) -> Self {
        self.params.insert("outxOrd".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_outxord_expr(mut self, expr: &str) -> Self {
        self.params.insert("outxOrd".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_outrord(mut self, val: ChopTransformchainOutrord) -> Self {
        self.params.insert("outrOrd".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_outrord_expr(mut self, expr: &str) -> Self {
        self.params.insert("outrOrd".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_outchannels(mut self, val: ChopTransformchainOutchannels) -> Self {
        self.params.insert("outchannels".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_outchannels_expr(mut self, expr: &str) -> Self {
        self.params.insert("outchannels".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl ChopTransformvopcvex {
    ...
    pub fn trigger_compileobjects(mut self) -> Self {
        self.params.insert("compileobjects".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    ...
    pub fn with_precacheframes(mut self, val: i32) -> Self {
        self.params.insert("precacheframes".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_precacheframes_expr(mut self, expr: &str) -> Self {
        self.params.insert("precacheframes".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_outputs(mut self, val: &str) -> Self {
        self.params.insert("outputs".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_references(mut self, val: &str) -> Self {
        self.params.insert("references".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_references_expr(mut self, expr: &str) -> Self {
        self.params.insert("references".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl ChopTrigger {
    ...
    pub fn with_mintrigger(mut self, val: f32) -> Self {
        self.params.insert("mintrigger".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_mintrigger_expr(mut self, expr: &str) -> Self {
        self.params.insert("mintrigger".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_attack(mut self, val: f32) -> Self {
        self.params.insert("attack".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_attack_expr(mut self, expr: &str) -> Self {
        self.params.insert("attack".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_peaklen(mut self, val: f32) -> Self {
        self.params.insert("peaklen".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_peaklen_expr(mut self, expr: &str) -> Self {
        self.params.insert("peaklen".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_sustain(mut self, val: f32) -> Self {
        self.params.insert("sustain".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_sustain_expr(mut self, expr: &str) -> Self {
        self.params.insert("sustain".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_ashape(mut self, val: ChopTriggerAshape) -> Self {
        self.params.insert("ashape".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_ashape_expr(mut self, expr: &str) -> Self {
        self.params.insert("ashape".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_dshape(mut self, val: ChopTriggerDshape) -> Self {
        self.params.insert("dshape".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_dshape_expr(mut self, expr: &str) -> Self {
        self.params.insert("dshape".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_rshape(mut self, val: ChopTriggerRshape) -> Self {
        self.params.insert("rshape".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_rshape_expr(mut self, expr: &str) -> Self {
        self.params.insert("rshape".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_complete(mut self, val: bool) -> Self {
        self.params.insert("complete".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_complete_expr(mut self, expr: &str) -> Self {
        self.params.insert("complete".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_timeslice(mut self, val: bool) -> Self {
        self.params.insert("timeslice".to_string(), crate::core::types::ParamValue::Toggle(val));
