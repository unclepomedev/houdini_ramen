...
impl ChopWarp {
    ...
    pub fn set_input_pre_warp_channels<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Pre-Warp Channels" and specifies the output index of the target node.
    pub fn set_input_pre_warp_channels_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn set_input_warp_curve_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_scaleindex(mut self, val: bool) -> Self {
        self.params.insert("scaleindex".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_scaleindex_expr(mut self, expr: &str) -> Self {
        self.params.insert("scaleindex".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl ChopWave {
    ...
    pub fn with_exprs(mut self, val: f32) -> Self {
        self.params.insert("exprs".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_exprs_expr(mut self, expr: &str) -> Self {
        self.params.insert("exprs".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl ChopWaveform {
    ...
    pub fn with_wave(mut self, val: &str) -> Self {
        self.params.insert("wave".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_wave_expr(mut self, expr: &str) -> Self {
        self.params.insert("wave".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
