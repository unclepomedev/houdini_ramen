...
impl VopChr {
    ...
    pub fn with_char(mut self, val: i32) -> Self {
        self.base
            .params
            .insert("char".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
...
impl VopClassicshadercore {
    ...
    pub fn set_input_input_105(mut self, target: &dyn crate::core::types::HoudiniNode) -> Self {
        self.base.inputs.insert(105, (target.get_id(), 0));
        self
    }

    /// Connects to input 105: "" and specifies the output index of the target node.
    pub fn set_input_input_105_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
        self.base
            .inputs
            .insert(105, (target.get_id(), output_index));
        self
    }

    /// Connects to input 106: ""
    pub fn set_input_input_106(mut self, target: &dyn crate::core::types::HoudiniNode) -> Self {
        self.base.inputs.insert(106, (target.get_id(), 0));
        self
    }

    /// Connects to input 106: "" and specifies the output index of the target node.
    pub fn set_input_input_106_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
        self.base
            .inputs
            .insert(106, (target.get_id(), output_index));
        self
    }
...
impl VopComposite {
    ...
    pub fn with_ba(mut self, val: f32) -> Self {
        self.base
            .params
            .insert("Ba".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    ...
    pub fn with_a(mut self, val: [f32; 3]) -> Self {
        self.base
            .params
            .insert("A".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    ...
    pub fn with_b(mut self, val: [f32; 3]) -> Self {
        self.base
            .params
            .insert("B".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
