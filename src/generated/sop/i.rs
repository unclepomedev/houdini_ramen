...
impl SopInflate {
    ...
    pub fn set_input_inflation_tool<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Inflation Tool" and specifies the output index of the target node.
    pub fn set_input_inflation_tool_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }

    /// Connects to input 2: "Rest Tool"
    pub fn set_input_rest_tool<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(2, (target.get_id(), 0));
        self
    }

    /// Connects to input 2: "Rest Tool" and specifies the output index of the target node.
    pub fn set_input_rest_tool_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_centeroverlap(mut self, val: f32) -> Self {
        self.params.insert("centeroverlap".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_centeroverlap_expr(mut self, expr: &str) -> Self {
        self.params.insert("centeroverlap".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_blendexponent(mut self, val: f32) -> Self {
        self.params.insert("blendexponent".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_blendexponent_expr(mut self, expr: &str) -> Self {
        self.params.insert("blendexponent".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_minsurfdist(mut self, val: f32) -> Self {
        self.params.insert("minsurfdist".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_minsurfdist_expr(mut self, expr: &str) -> Self {
        self.params.insert("minsurfdist".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_toolgroup(mut self, val: &str) -> Self {
        self.params.insert("toolgroup".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_toolgroup_expr(mut self, expr: &str) -> Self {
        self.params.insert("toolgroup".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_centergroup(mut self, val: &str) -> Self {
        self.params.insert("centergroup".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_centergroup_expr(mut self, expr: &str) -> Self {
        self.params.insert("centergroup".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_centerprimgroup(mut self, val: &str) -> Self {
        self.params.insert("centerprimgroup".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_centerprimgroup_expr(mut self, expr: &str) -> Self {
        self.params.insert("centerprimgroup".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_toolidname(mut self, val: &str) -> Self {
        self.params.insert("toolidname".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_toolidname_expr(mut self, expr: &str) -> Self {
        self.params.insert("toolidname".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_clampsurfdist(mut self, val: bool) -> Self {
        self.params.insert("clampsurfdist".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_clampsurfdist_expr(mut self, expr: &str) -> Self {
        self.params.insert("clampsurfdist".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_inflatetofarthest(mut self, val: bool) -> Self {
        self.params.insert("inflatetofarthest".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_inflatetofarthest_expr(mut self, expr: &str) -> Self {
        self.params.insert("inflatetofarthest".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_maxinflateenable(mut self, val: bool) -> Self {
        self.params.insert("maxinflateenable".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_maxinflateenable_expr(mut self, expr: &str) -> Self {
        self.params.insert("maxinflateenable".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}

impl crate::core::types::HoudiniNode for SopInflate {
...
impl SopInstance {
    ...
    pub fn set_input_particles_to_instantiate_instances_on<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Particles to Instantiate Instances on" and specifies the output index of the target node.
    pub fn set_input_particles_to_instantiate_instances_on_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_instanceattrib(mut self, val: &str) -> Self {
        self.params.insert("instanceattrib".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_instanceattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("instanceattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for SopInstance {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl SopIntersectionanalysis {
    ...
    pub fn set_input_a_input_triangles_and_polygon_curves<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "A: Input Triangles and Polygon Curves" and specifies the output index of the target node.
    pub fn set_input_a_input_triangles_and_polygon_curves_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }

    /// Connects to input 1: "B: Input Triangles and Polygon Curves"
    pub fn set_input_b_input_triangles_and_polygon_curves<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "B: Input Triangles and Polygon Curves" and specifies the output index of the target node.
    pub fn set_input_b_input_triangles_and_polygon_curves_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_proxtol(mut self, val: f32) -> Self {
        self.params.insert("proxtol".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_proxtol_expr(mut self, expr: &str) -> Self {
        self.params.insert("proxtol".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_inputnumattrib(mut self, val: &str) -> Self {
        self.params.insert("inputnumattrib".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_inputnumattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("inputnumattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_ptnumattrib(mut self, val: &str) -> Self {
        self.params.insert("ptnumattrib".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_ptnumattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("ptnumattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_useproxtol(mut self, val: bool) -> Self {
        self.params.insert("useproxtol".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useproxtol_expr(mut self, expr: &str) -> Self {
        self.params.insert("useproxtol".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_detectverts(mut self, val: bool) -> Self {
        self.params.insert("detectverts".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_detectverts_expr(mut self, expr: &str) -> Self {
        self.params.insert("detectverts".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_outputsegs(mut self, val: bool) -> Self {
        self.params.insert("outputsegs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    ...
    pub fn with_useinputnumattrib(mut self, val: bool) -> Self {
        self.params.insert("useinputnumattrib".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useinputnumattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("useinputnumattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_useptnumattrib(mut self, val: bool) -> Self {
        self.params.insert("useptnumattrib".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useptnumattrib_expr(mut self, expr: &str) -> Self {
        self.params.insert("useptnumattrib".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}

impl crate::core::types::HoudiniNode for SopIntersectionanalysis {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl SopIntersectionstitch {
    ...
    pub fn set_input_input_triangle_and_curve_mesh_a<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Input Triangle and Curve Mesh A" and specifies the output index of the target node.
    pub fn set_input_input_triangle_and_curve_mesh_a_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }

    /// Connects to input 1: "Input Triangle and Curve Mesh B"
    pub fn set_input_input_triangle_and_curve_mesh_b<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Input Triangle and Curve Mesh B" and specifies the output index of the target node.
    pub fn set_input_input_triangle_and_curve_mesh_b_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }

    /// Connects to input 2: "Optional Subdivision Points"
    pub fn set_input_optional_subdivision_points<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(2, (target.get_id(), 0));
        self
    }

    /// Connects to input 2: "Optional Subdivision Points" and specifies the output index of the target node.
    pub fn set_input_optional_subdivision_points_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(2, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_splitcurves(mut self, val: bool) -> Self {
        self.params.insert("splitcurves".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_splitcurves_expr(mut self, expr: &str) -> Self {
        self.params.insert("splitcurves".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_keeppointattribs(mut self, val: bool) -> Self {
        self.params.insert("keeppointattribs".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
...
impl crate::core::types::HoudiniNode for SopIntersectionstitch {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl SopInvoke {
    ...
    pub fn set_input_first_input_to_compiled_block<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "First Input to Compiled Block" and specifies the output index of the target node.
    pub fn set_input_first_input_to_compiled_block_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }

    /// Connects to input 1: "Second Input to Compiled Block"
    pub fn set_input_second_input_to_compiled_block<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Second Input to Compiled Block" and specifies the output index of the target node.
    pub fn set_input_second_input_to_compiled_block_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }

    /// Connects to input 2: "Third Input to Compiled Block"
    pub fn set_input_third_input_to_compiled_block<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(2, (target.get_id(), 0));
        self
    }

    /// Connects to input 2: "Third Input to Compiled Block" and specifies the output index of the target node.
    pub fn set_input_third_input_to_compiled_block_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(2, (target.get_id(), output_index));
        self
    }

    /// Connects to input 3: "Fourth Input to Compiled Block"
    pub fn set_input_fourth_input_to_compiled_block<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
    ...
    pub fn set_input_fourth_input_to_compiled_block_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
    ...
    pub fn with_inputpath_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("inputpath{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_inputpath_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("inputpath{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}

impl crate::core::types::HoudiniNode for SopInvoke {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl crate::core::types::HoudiniNode for SopInvokegraph {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl SopIso {
    ...
    pub fn with_func(mut self, val: f32) -> Self {
        self.params.insert("func".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    ...
    pub fn with_fwidth(mut self, val: f32) -> Self {
        self.params.insert("fwidth".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_fwidth_expr(mut self, expr: &str) -> Self {
        self.params.insert("fwidth".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_useresolution(mut self, val: bool) -> Self {
        self.params.insert("useresolution".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_useresolution_expr(mut self, expr: &str) -> Self {
        self.params.insert("useresolution".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_buildvolume(mut self, val: bool) -> Self {
        self.params.insert("buildvolume".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_buildvolume_expr(mut self, expr: &str) -> Self {
        self.params.insert("buildvolume".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for SopIso {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl SopIsooffset {
    ...
    pub fn set_input_reference_bounds<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Reference Bounds" and specifies the output index of the target node.
    pub fn set_input_reference_bounds_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(1, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_numneighbour(mut self, val: i32) -> Self {
        self.params.insert("numneighbour".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_numneighbour_expr(mut self, expr: &str) -> Self {
        self.params.insert("numneighbour".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_isodiv(mut self, val: [i32; 3]) -> Self {
        self.params.insert("isodiv".to_string(), crate::core::types::ParamValue::Int3(val));
        self
    }
    pub fn with_isodiv_expr(mut self, expr: &str) -> Self {
        self.params.insert("isodiv".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_tetratype(mut self, val: SopIsooffsetTetratype) -> Self {
        self.params.insert("tetratype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_tetratype_expr(mut self, expr: &str) -> Self {
        self.params.insert("tetratype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_overrideoutput(mut self, val: bool) -> Self {
        self.params.insert("overrideoutput".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_overrideoutput_expr(mut self, expr: &str) -> Self {
        self.params.insert("overrideoutput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_overridebounds(mut self, val: bool) -> Self {
        self.params.insert("overridebounds".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_overridebounds_expr(mut self, expr: &str) -> Self {
        self.params.insert("overridebounds".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_padbounds(mut self, val: bool) -> Self {
        self.params.insert("padbounds".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_padbounds_expr(mut self, expr: &str) -> Self {
        self.params.insert("padbounds".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl crate::core::types::HoudiniNode for SopIsooffset {
    fn get_id(&self) -> usize {
        self.id
    }
