...
impl SopNeuralpointsurface {
    ...
    pub fn set_input_points_to_surface(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
    ...
    pub fn set_input_points_to_surface_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl SopNormal {
    ...
    pub fn set_input_geometry_to_add_normals_to(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
    ...
    pub fn set_input_geometry_to_add_normals_to_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
