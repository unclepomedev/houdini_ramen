...
impl SopNeuralpointsurface {
    ...
    pub fn set_input_points_to_surface_by_name<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
        port_name: &str,
    ) -> Self {
...
impl SopNormal {
    ...
    pub fn set_input_geometry_to_add_normals_to_by_name<N: crate::core::types::HoudiniNode>(
        mut self,
        target: &N,
        port_name: &str,
    ) -> Self {
