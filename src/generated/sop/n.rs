...
impl SopName {
    ...
    pub fn with_namefromgroupmask(mut self, val: &str) -> Self {
        self.params.insert("namefromgroupmask".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_namefromgroupmask_expr(mut self, expr: &str) -> Self {
        self.params.insert("namefromgroupmask".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_donamefromgroup(mut self, val: bool) -> Self {
        self.params.insert("donamefromgroup".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_donamefromgroup_expr(mut self, expr: &str) -> Self {
        self.params.insert("donamefromgroup".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl SopNeighborsearchcl {
    ...
    pub fn with_srcphase(mut self, val: i32) -> Self {
        self.params.insert("srcphase".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_srcphase_expr(mut self, expr: &str) -> Self {
        self.params.insert("srcphase".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_dstphase(mut self, val: i32) -> Self {
        self.params.insert("dstphase".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_dstphase_expr(mut self, expr: &str) -> Self {
        self.params.insert("dstphase".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_leaveongpu(mut self, val: bool) -> Self {
        self.params.insert("leaveongpu".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_leaveongpu_expr(mut self, expr: &str) -> Self {
        self.params.insert("leaveongpu".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl SopNeuralpointsurface {
    ...
    pub fn set_input_points_to_surface<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Points To Surface" and specifies the output index of the target node.
    pub fn set_input_points_to_surface_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_maxpartptcount(mut self, val: i32) -> Self {
        self.params.insert("maxpartptcount".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_maxpartptcount_expr(mut self, expr: &str) -> Self {
        self.params.insert("maxpartptcount".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_onnxmodelpath(mut self, val: &str) -> Self {
        self.params.insert("onnxmodelpath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_onnxmodelpath_expr(mut self, expr: &str) -> Self {
        self.params.insert("onnxmodelpath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }

    // --- Toggle parameters ---
    pub fn with_overwritevoxelsize(mut self, val: bool) -> Self {
        self.params.insert("overwritevoxelsize".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_overwritevoxelsize_expr(mut self, expr: &str) -> Self {
        self.params.insert("overwritevoxelsize".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_closesdf(mut self, val: bool) -> Self {
        self.params.insert("closesdf".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_closesdf_expr(mut self, expr: &str) -> Self {
        self.params.insert("closesdf".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_enablepartitioning(mut self, val: bool) -> Self {
        self.params.insert("enablepartitioning".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_enablepartitioning_expr(mut self, expr: &str) -> Self {
        self.params.insert("enablepartitioning".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_showpartitioning(mut self, val: bool) -> Self {
        self.params.insert("showpartitioning".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_showpartitioning_expr(mut self, expr: &str) -> Self {
        self.params.insert("showpartitioning".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
...
impl SopNormal {
    ...
    pub fn set_input_geometry_to_add_normals_to<N: crate::core::types::HoudiniNode>(mut self, target: &N) -> Self {
        self.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Geometry to add normals to" and specifies the output index of the target node.
    pub fn set_input_geometry_to_add_normals_to_from<N: crate::core::types::HoudiniNode>(mut self, target: &N, output_index: usize) -> Self {
        self.inputs.insert(0, (target.get_id(), output_index));
        self
    }
    ...
    pub fn with_docompute(mut self, val: bool) -> Self {
        self.params.insert("docompute".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_docompute_expr(mut self, expr: &str) -> Self {
        self.params.insert("docompute".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_origifzero(mut self, val: bool) -> Self {
        self.params.insert("origifzero".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_origifzero_expr(mut self, expr: &str) -> Self {
        self.params.insert("origifzero".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl SopNpspreprocessingcl {
    ...
    pub fn with_dx(mut self, val: f32) -> Self {
        self.params.insert("dx".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_dx_expr(mut self, expr: &str) -> Self {
        self.params.insert("dx".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_radiusscale(mut self, val: f32) -> Self {
        self.params.insert("radiusscale".to_string(), crate::core::types::ParamValue::Float(val));
...
impl SopNull {
    ...
    pub fn with_copyinput(mut self, val: bool) -> Self {
        self.params.insert("copyinput".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_copyinput_expr(mut self, expr: &str) -> Self {
        self.params.insert("copyinput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_cacheinput(mut self, val: bool) -> Self {
        self.params.insert("cacheinput".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_cacheinput_expr(mut self, expr: &str) -> Self {
        self.params.insert("cacheinput".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}
