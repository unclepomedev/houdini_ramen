...
impl SopWeightarraybiharmonic {
    ...
    pub fn set_input_guide_interpolation_geometry(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
...
impl SopWhitewaterpostprocess {
    ...
    pub fn set_input_whitewater_simulation(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
    ...
    pub fn set_input_whitewater_simulation_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl SopWhitewatersolver {
    ...
    pub fn set_input_emission_and_fluid_fields(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
    ...
    pub fn set_input_emission_and_fluid_fields_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl SopWhitewatersource {
    ...
    pub fn set_input_liquid_simulation(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
    ...
    pub fn set_input_liquid_simulation_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl SopWindingnumber {
    ...
    pub fn set_input_query_points(mut self, target: &dyn crate::core::types::HoudiniNode) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Query Points" and specifies the output index of the target node.
    pub fn set_input_query_points_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
    ...
    pub fn set_input_occlusion_mesh(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(1, (target.get_id(), 0));
    ...
    pub fn set_input_occlusion_mesh_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl SopWirecapture {
    ...
    pub fn set_input_geometry_to_capture(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
    ...
    pub fn set_input_geometry_to_capture_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
    ...
    pub fn set_input_wires_to_capture_with(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(1, (target.get_id(), 0));
    ...
    pub fn set_input_wires_to_capture_with_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl SopWiredeform {
    ...
    pub fn set_input_rest_wires(mut self, target: &dyn crate::core::types::HoudiniNode) -> Self {
        self.base.inputs.insert(1, (target.get_id(), 0));
        self
    }

    /// Connects to input 1: "Rest wires" and specifies the output index of the target node.
    pub fn set_input_rest_wires_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
    ...
    pub fn set_input_deforming_wires(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(2, (target.get_id(), 0));
    ...
    pub fn set_input_deforming_wires_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl SopWiretransfershape {
    ...
    pub fn set_input_curves_to_transfer_to(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
    ...
    pub fn set_input_curves_to_transfer_to_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
    ...
    pub fn set_input_curves_to_transfer_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
    ) -> Self {
        self.base.inputs.insert(1, (target.get_id(), 0));
    ...
    pub fn set_input_curves_to_transfer_from_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
