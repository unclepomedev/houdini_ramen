...
impl ObjectMcacclaim {
    ...
    pub fn trigger_load(mut self) -> Self {
        self.base
            .params
            .insert("load".to_string(), crate::core::types::ParamValue::Button);
        self
    }
...
impl ObjectMuscle {
    ...
    pub fn with_last(mut self, val: i32) -> Self {
        self.base
            .params
            .insert("last".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
...
impl ObjectMusclepin {
    ...
    pub fn set_input_origin_anchor(mut self, target: &dyn crate::core::types::HoudiniNode) -> Self {
        self.base.inputs.insert(0, (target.get_id(), 0));
        self
    }

    /// Connects to input 0: "Origin Anchor" and specifies the output index of the target node.
    pub fn set_input_origin_anchor_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
...
impl ObjectMusclerig {
    ...
    pub fn set_input_end_anchor(mut self, target: &dyn crate::core::types::HoudiniNode) -> Self {
    ...
    pub fn set_input_end_anchor_from(
        mut self,
        target: &dyn crate::core::types::HoudiniNode,
        output_index: usize,
    ) -> Self {
