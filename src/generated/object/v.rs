...
impl ObjectViewportisolator {
    ...
    pub fn trigger_isolate(mut self) -> Self {
        self.params.insert("isolate".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_append(mut self) -> Self {
        self.params.insert("append".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_exclude(mut self) -> Self {
        self.params.insert("exclude".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    ...
    pub fn trigger_recompute(mut self) -> Self {
        self.params.insert("recompute".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_save(mut self) -> Self {
        self.params.insert("save".to_string(), crate::core::types::ParamValue::Button);
        self
    }
    pub fn trigger_recall_inst(mut self, index1: usize) -> Self {
        self.params.insert(format!("recall{}", index1), crate::core::types::ParamValue::Button);
        self
    }
    ...
    pub fn with_mode_inst(mut self, index1: usize, val: ObjectViewportisolatorMode) -> Self {
        self.params.insert(format!("mode{}", index1), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    ...
    pub fn with_load(mut self, val: i32) -> Self {
        self.params.insert("load".to_string(), crate::core::types::ParamValue::Menu(val));
        self
    }
    pub fn with_load_expr(mut self, expr: &str) -> Self {
        self.params.insert("load".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_isolatestring(mut self, val: &str) -> Self {
        self.params.insert("isolatestring".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_isolatestring_expr(mut self, expr: &str) -> Self {
        self.params.insert("isolatestring".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_viewports(mut self, val: &str) -> Self {
        self.params.insert("viewports".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_viewports_expr(mut self, expr: &str) -> Self {
        self.params.insert("viewports".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_label(mut self, val: &str) -> Self {
        self.params.insert("label".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_label_expr(mut self, expr: &str) -> Self {
        self.params.insert("label".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_history_inst(mut self, index1: usize, val: &str) -> Self {
        self.params.insert(format!("history{}", index1), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_history_inst_expr(mut self, index1: usize, expr: &str) -> Self {
        self.params.insert(format!("history{}", index1), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_more(mut self, val: bool) -> Self {
        self.params.insert("more".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_more_expr(mut self, expr: &str) -> Self {
        self.params.insert("more".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_filter_inst(mut self, index1: usize, val: bool) -> Self {
        self.params.insert(format!("filter{}", index1), crate::core::types::ParamValue::Toggle(val));
        self
    }
...
impl crate::core::types::HoudiniNode for ObjectViewportisolator {
...
impl crate::core::types::HoudiniNode for ObjectVopnet {
    fn get_id(&self) -> usize {
        self.id
    }
...
impl ObjectVrcam {
    ...
    pub fn with_vm_bokehrotation(mut self, val: f32) -> Self {
        self.params.insert("vm_bokehrotation".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vm_bokehrotation_expr(mut self, expr: &str) -> Self {
        self.params.insert("vm_bokehrotation".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrmergeangle(mut self, val: f32) -> Self {
        self.params.insert("vrmergeangle".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vrmergeangle_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrmergeangle".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrhorizontalfov(mut self, val: f32) -> Self {
        self.params.insert("vrhorizontalfov".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vrhorizontalfov_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrhorizontalfov".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrverticalfov(mut self, val: f32) -> Self {
        self.params.insert("vrverticalfov".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vrverticalfov_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrverticalfov".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrperspectivefov(mut self, val: f32) -> Self {
        self.params.insert("vrperspectivefov".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vrperspectivefov_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrperspectivefov".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrperspectiveclipnear(mut self, val: f32) -> Self {
        self.params.insert("vrperspectiveclipnear".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vrperspectiveclipnear_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrperspectiveclipnear".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrperspectiveclipfar(mut self, val: f32) -> Self {
        self.params.insert("vrperspectiveclipfar".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vrperspectiveclipfar_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrperspectiveclipfar".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrperspectivedistort(mut self, val: f32) -> Self {
        self.params.insert("vrperspectivedistort".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vrperspectivedistort_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrperspectivedistort".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrperspectivedistortcubic(mut self, val: f32) -> Self {
        self.params.insert("vrperspectivedistortcubic".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vrperspectivedistortcubic_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrperspectivedistortcubic".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vreyeseparation(mut self, val: f32) -> Self {
        self.params.insert("vreyeseparation".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vreyeseparation_expr(mut self, expr: &str) -> Self {
        self.params.insert("vreyeseparation".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vreyetoneckdistance(mut self, val: f32) -> Self {
        self.params.insert("vreyetoneckdistance".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_vreyetoneckdistance_expr(mut self, expr: &str) -> Self {
        self.params.insert("vreyetoneckdistance".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vrlayout(mut self, val: ObjectVrcamVrlayout) -> Self {
        self.params.insert("vrlayout".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_vrlayout_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrlayout".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrprojection(mut self, val: ObjectVrcamVrprojection) -> Self {
        self.params.insert("vrprojection".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_vrprojection_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrprojection".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrmergemode(mut self, val: ObjectVrcamVrmergemode) -> Self {
        self.params.insert("vrmergemode".to_string(), crate::core::types::ParamValue::Int(val as i32));
        self
    }
    pub fn with_vrmergemode_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrmergemode".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vm_lensshader(mut self, val: &str) -> Self {
        self.params.insert("vm_lensshader".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vm_lensshader_expr(mut self, expr: &str) -> Self {
        self.params.insert("vm_lensshader".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vm_background(mut self, val: &str) -> Self {
        self.params.insert("vm_background".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vm_background_expr(mut self, expr: &str) -> Self {
        self.params.insert("vm_background".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_cropmask(mut self, val: &str) -> Self {
        self.params.insert("cropmask".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_cropmask_expr(mut self, expr: &str) -> Self {
        self.params.insert("cropmask".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vm_bokehfile(mut self, val: &str) -> Self {
        self.params.insert("vm_bokehfile".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_vm_bokehfile_expr(mut self, expr: &str) -> Self {
        self.params.insert("vm_bokehfile".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_vm_bgenable(mut self, val: bool) -> Self {
        self.params.insert("vm_bgenable".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_vm_bgenable_expr(mut self, expr: &str) -> Self {
        self.params.insert("vm_bgenable".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrswapleftright(mut self, val: bool) -> Self {
        self.params.insert("vrswapleftright".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_vrswapleftright_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrswapleftright".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrpreserveaspectratio(mut self, val: bool) -> Self {
        self.params.insert("vrpreserveaspectratio".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_vrpreserveaspectratio_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrpreserveaspectratio".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_vrusestereoeye(mut self, val: bool) -> Self {
        self.params.insert("vrusestereoeye".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_vrusestereoeye_expr(mut self, expr: &str) -> Self {
        self.params.insert("vrusestereoeye".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
}

impl crate::core::types::HoudiniNode for ObjectVrcam {
    fn get_id(&self) -> usize {
        self.id
    }
