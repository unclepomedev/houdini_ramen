...
impl ObjectNullspike {
    ...
    pub fn with_dispheadscale(mut self, val: f32) -> Self {
        self.params.insert("dispheadscale".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_dispheadscale_expr(mut self, expr: &str) -> Self {
        self.params.insert("dispheadscale".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_headtype(mut self, val: ObjectNullspikeHeadtype) -> Self {
        self.params.insert("headtype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_headtype_expr(mut self, expr: &str) -> Self {
        self.params.insert("headtype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
