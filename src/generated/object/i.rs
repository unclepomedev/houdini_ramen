...
impl ObjectIndirectlight {
    ...
    pub fn with_photon_preratio(mut self, val: f32) -> Self {
        self.params.insert("photon_preratio".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_photon_preratio_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_preratio".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_photon_misbias(mut self, val: f32) -> Self {
        self.params.insert("photon_misbias".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_photon_misbias_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_misbias".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_render_maxdist(mut self, val: f32) -> Self {
        self.params.insert("render_maxdist".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_render_maxdist_expr(mut self, expr: &str) -> Self {
        self.params.insert("render_maxdist".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_render_angle(mut self, val: f32) -> Self {
        self.params.insert("render_angle".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_render_angle_expr(mut self, expr: &str) -> Self {
        self.params.insert("render_angle".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_render_threshold(mut self, val: f32) -> Self {
        self.params.insert("render_threshold".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_render_threshold_expr(mut self, expr: &str) -> Self {
        self.params.insert("render_threshold".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_photon_generate(mut self, val: i32) -> Self {
        self.params.insert("photon_generate".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_photon_generate_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_generate".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_photon_count(mut self, val: i32) -> Self {
        self.params.insert("photon_count".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_photon_count_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_count".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_photon_precount(mut self, val: i32) -> Self {
        self.params.insert("photon_precount".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_photon_precount_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_precount".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_photon_pcsamples(mut self, val: i32) -> Self {
        self.params.insert("photon_pcsamples".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_photon_pcsamples_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_pcsamples".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_photon_filter(mut self, val: ObjectIndirectlightPhotonFilter) -> Self {
        self.params.insert("photon_filter".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_photon_filter_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_filter".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_light_type(mut self, val: &str) -> Self {
        self.params.insert("light_type".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    ...
    pub fn with_photon_target(mut self, val: &str) -> Self {
        self.params.insert("photon_target".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_photon_target_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_target".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_photon_map(mut self, val: &str) -> Self {
        self.params.insert("photon_map".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_photon_map_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_map".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_photon_prefiltermap(mut self, val: &str) -> Self {
        self.params.insert("photon_prefiltermap".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_photon_prefiltermap_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_prefiltermap".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_render_photonmap(mut self, val: bool) -> Self {
        self.params.insert("render_photonmap".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_render_photonmap_expr(mut self, expr: &str) -> Self {
        self.params.insert("render_photonmap".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_photon_direct(mut self, val: bool) -> Self {
        self.params.insert("photon_direct".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_photon_direct_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_direct".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_photon_prefilter(mut self, val: bool) -> Self {
        self.params.insert("photon_prefilter".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_photon_prefilter_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_prefilter".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_photon_pcenable(mut self, val: bool) -> Self {
        self.params.insert("photon_pcenable".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_photon_pcenable_expr(mut self, expr: &str) -> Self {
        self.params.insert("photon_pcenable".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_render_domaxdist(mut self, val: bool) -> Self {
        self.params.insert("render_domaxdist".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_render_domaxdist_expr(mut self, expr: &str) -> Self {
        self.params.insert("render_domaxdist".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_render_doadaptive(mut self, val: bool) -> Self {
        self.params.insert("render_doadaptive".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_render_doadaptive_expr(mut self, expr: &str) -> Self {
        self.params.insert("render_doadaptive".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
...
impl ObjectInstance {
    ...
    pub fn with_i_scale(mut self, val: f32) -> Self {
        self.params.insert("i_scale".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_i_scale_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_scale".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_roll(mut self, val: f32) -> Self {
        self.params.insert("i_roll".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_i_roll_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_roll".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_pos(mut self, val: f32) -> Self {
        self.params.insert("i_pos".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_i_pos_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_pos".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_bank(mut self, val: f32) -> Self {
        self.params.insert("i_bank".to_string(), crate::core::types::ParamValue::Float(val));
        self
    }
    pub fn with_i_bank_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_bank".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_i_t(mut self, val: [f32; 3]) -> Self {
        self.params.insert("i_t".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_i_t_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_t".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_r(mut self, val: [f32; 3]) -> Self {
        self.params.insert("i_r".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_i_r_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_r".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_s(mut self, val: [f32; 3]) -> Self {
        self.params.insert("i_s".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_i_s_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_s".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_p(mut self, val: [f32; 3]) -> Self {
        self.params.insert("i_p".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_i_p_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_p".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_pr(mut self, val: [f32; 3]) -> Self {
        self.params.insert("i_pr".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_i_pr_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_pr".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_up(mut self, val: [f32; 3]) -> Self {
        self.params.insert("i_up".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_i_up_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_up".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_dcolor(mut self, val: [f32; 3]) -> Self {
        self.params.insert("i_dcolor".to_string(), crate::core::types::ParamValue::Float3(val));
        self
    }
    pub fn with_i_dcolor_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_dcolor".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_i_pathorient(mut self, val: i32) -> Self {
        self.params.insert("i_pathorient".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_i_pathorient_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_pathorient".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_display(mut self, val: i32) -> Self {
        self.params.insert("i_display".to_string(), crate::core::types::ParamValue::Int(val));
        self
    }
    pub fn with_i_display_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_display".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_display(mut self, val: i32) -> Self {
        self.params.insert("display".to_string(), crate::core::types::ParamValue::Int(val));
    ...
    pub fn with_i_xord(mut self, val: ObjectInstanceIXord) -> Self {
        self.params.insert("i_xOrd".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_i_xord_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_xOrd".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_rord(mut self, val: ObjectInstanceIRord) -> Self {
        self.params.insert("i_rOrd".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_i_rord_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_rOrd".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_pre_xform(mut self, val: ObjectInstanceIPreXform) -> Self {
        self.params.insert("i_pre_xform".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_i_pre_xform_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_pre_xform".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_uparmtype(mut self, val: ObjectInstanceIUparmtype) -> Self {
        self.params.insert("i_uparmtype".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_i_uparmtype_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_uparmtype".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_ptinstance(mut self, val: ObjectInstancePtinstance) -> Self {
        self.params.insert("ptinstance".to_string(), crate::core::types::ParamValue::Menu(val as i32));
        self
    }
    pub fn with_ptinstance_expr(mut self, expr: &str) -> Self {
        self.params.insert("ptinstance".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_i_lookatpath(mut self, val: &str) -> Self {
        self.params.insert("i_lookatpath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_i_lookatpath_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_lookatpath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_lookup(mut self, val: &str) -> Self {
        self.params.insert("i_lookup".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_i_lookup_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_lookup".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_pathobjpath(mut self, val: &str) -> Self {
        self.params.insert("i_pathobjpath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_i_pathobjpath_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_pathobjpath".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_subnet_filter(mut self, val: &str) -> Self {
        self.params.insert("subnet_filter".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_subnet_filter_expr(mut self, expr: &str) -> Self {
        self.params.insert("subnet_filter".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_subnet_pattern(mut self, val: &str) -> Self {
        self.params.insert("subnet_pattern".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_subnet_pattern_expr(mut self, expr: &str) -> Self {
        self.params.insert("subnet_pattern".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    ...
    pub fn with_i_pickscript(mut self, val: &str) -> Self {
        self.params.insert("i_pickscript".to_string(), crate::core::types::ParamValue::String(val.to_string()));
        self
    }
    pub fn with_i_pickscript_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_pickscript".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_lookupobjpath(mut self, val: &str) -> Self {
        self.params.insert("lookupobjpath".to_string(), crate::core::types::ParamValue::String(val.to_string()));
    ...
    pub fn with_i_keeppos(mut self, val: bool) -> Self {
        self.params.insert("i_keeppos".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_i_keeppos_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_keeppos".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_childcomp(mut self, val: bool) -> Self {
        self.params.insert("childcomp".to_string(), crate::core::types::ParamValue::Toggle(val));
    ...
    pub fn with_i_tdisplay(mut self, val: bool) -> Self {
        self.params.insert("i_tdisplay".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_i_tdisplay_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_tdisplay".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_use_dcolor(mut self, val: bool) -> Self {
        self.params.insert("i_use_dcolor".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_i_use_dcolor_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_use_dcolor".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_picking(mut self, val: bool) -> Self {
        self.params.insert("i_picking".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_i_picking_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_picking".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_caching(mut self, val: bool) -> Self {
        self.params.insert("i_caching".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_i_caching_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_caching".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_i_vport_shadeopen(mut self, val: bool) -> Self {
        self.params.insert("i_vport_shadeopen".to_string(), crate::core::types::ParamValue::Toggle(val));
        self
    }
    pub fn with_i_vport_shadeopen_expr(mut self, expr: &str) -> Self {
        self.params.insert("i_vport_shadeopen".to_string(), crate::core::types::ParamValue::Expression(expr.to_string()));
        self
    }
    pub fn with_tdisplay(mut self, val: bool) -> Self {
        self.params.insert("tdisplay".to_string(), crate::core::types::ParamValue::Toggle(val));
