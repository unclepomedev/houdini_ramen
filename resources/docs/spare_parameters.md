...
You can add custom spare parameters to any Houdini node using the `.add_spare()` method combined with parameter builder structs from `types`. This is highly readable and scalable.
