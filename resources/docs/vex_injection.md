...
- `vex/snippets/*.vfl`: Wrangle core logic. Loaded by Rust via `include_str!`.
- `vex/include/*.h`: Header files with pure functions. Included inside `.vfl` files using `#include "name.h"`.
